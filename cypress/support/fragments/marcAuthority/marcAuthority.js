...
const defaultAuthority = {
  ...
  tag008AuthorityBytesProperties: {
    ...
    kindRec: {
      interactor: TextField('Kind rec'),
      defaultValue: 'a',
      newValue: 'v',
    },
    catRules: {
      interactor: TextField('CatRules'),
      defaultValue: 'c',
      newValue: 'v',
    },
    sHSys: {
      interactor: TextField('SH Sys'),
      defaultValue: 'a',
      newValue: 'v',
    },
    series: {
      interactor: TextField('Series'),
      defaultValue: 'n',
      newValue: 'v',
    },
    numbSeries: {
      interactor: TextField('Numb Series'),
      defaultValue: 'n',
      newValue: 'v',
    },
    mainUse: {
      interactor: TextField('Main use'),
      defaultValue: 'a',
      newValue: 'v',
    },
    subjUse: {
      interactor: TextField('Subj use'),
      defaultValue: 'a',
      newValue: 'v',
    },
    seriesUse: {
      interactor: TextField('Series use'),
      defaultValue: 'b',
      newValue: 'v',
    },
    subdType: {
      interactor: TextField('Subd type'),
      defaultValue: 'n',
      newValue: 'v',
    },
    govtAg: {
      interactor: TextField('Govt Ag'),
      defaultValue: '|',
      newValue: 'v',
    },
    refEval: {
      interactor: TextField('RefEval'),
      defaultValue: 'a',
      newValue: 'v',
    },
    recUpd: {
      interactor: TextField('RecUpd'),
      defaultValue: 'a',
      newValue: 'v',
    },
    persName: {
      interactor: TextField('Pers Name'),
      defaultValue: 'a',
      newValue: 'v',
    },
    levelEst: {
      interactor: TextField('Level Est'),
      defaultValue: 'a',
      newValue: 'v',
    },
    modRecEst: {
      interactor: TextField('Mod Rec Est'),
      defaultValue: '\\',
      newValue: 'v',
    },
    source: {
      interactor: TextField('Source'),
      defaultValue: '\\',
      newValue: 'v',
    },
    getAllProperties: () => {
      ...
      ).filter((objectProperty) => typeof objectProperty !== 'function');
    },
...
export default {
  ...
  checkNotDeletableTags: (tag) => {
    cy.expect(
      QuickMarcEditorRow({ tagValue: tag }).find(deleteFieldButton).absent()
    );
  },
  ...
  checkAddNew1XXTag: (rowIndex, tag, content) => {
    ...
    cy.expect(
      Callout('Record cannot be saved. Cannot have multiple 1XXs').exists()
    );
  },
  ...
  checkLinkingAuthority: () => {
    ...
    cy.expect(
      Callout('Field 655 has been linked to a MARC authority record.').exists()
    );
  },
};
