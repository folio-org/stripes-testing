export default {
  ...
  uiAgreementsAgreementsView: { internal: 'ui-agreements.agreements.view', gui: 'Agreements: View agreements' },
  // QuickMarc
  ...
  inventoryAll: { internal: 'ui-inventory.all-permissions.TEMPORARY', gui: 'Inventory: All permissions' },
