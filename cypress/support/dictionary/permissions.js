export default {
  ...
  inventoryAll: {
    internal: ['inventory.all', 'ui-inventory.all-permissions.TEMPORARY'],
  ...
  moduleDataImportEnabled: {
    internal: 'module.data-import.enabled',
  ...
  remoteStorageCRUD: {
    internal: '',
    gui: 'Settings (Remote storage): Can create, edit, delete remote storage settings'
  },
  // Requests
