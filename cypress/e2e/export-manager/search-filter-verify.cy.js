...
describe(
  ...
  () => {
    beforeEach('create instance, user and two jobs', () => {
      itemData = {
    ...
    afterEach('check in item, delete instance, user and files', () => {
      cy.getAdminToken();
    ...
    it(
      ...
      () => {
        ...
        ExportManagerSearchPane.verifyBulkEditCheckboxAbsent();
