...
describe('Export Manager', () => {
  describe('Export Orders in EDIFACT format: Orders Export to a Vendor', () => {
    ...
    before(() => {
      ...
      Organizations.createOrganizationViaApi(organization)
        ...
        .then((response) => {
          ...
          // Create 3 POLs: POL#1 with Account 1, POL#2 with Account 2, POL#3 with Account 2
          ...
          const polPromises = accountMapping.map((account) => OrderLines.createOrderLineViaApi(
    ...
    it(
      'C350434 Check if a User is alerted trying to open an Order with 3 POL, having 2 unique accounts (thunderjet) (TaaS)',
      { tags: ['extendedPath', 'thunderjet', 'C350434'] },
      () => {
