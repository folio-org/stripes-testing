...
describe('Receiving', () => {
  ...
  it(
    'C430266 Change piece status from "Unreceivable" to "Expected" for one-time order with one piece (thunderjet)',
    { tags: ['extendedPath', 'thunderjet', 'C430266'] },
    () => {
      ...
      // Step 4-5: Move piece to expected
