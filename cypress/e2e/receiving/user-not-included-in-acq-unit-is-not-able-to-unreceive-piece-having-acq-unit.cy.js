...
describe('Receiving', () => {
  describe('Acquisition units', () => {
    ...
    const instanceTitle = `C436815_Title_${randomPostfix}`;
    const quantity = 1;
    let order;
    let orderLine;
    let user;
    ...
    it(
      'C436815 User NOT included in Acq unit is not able to unreceive a piece having Acq unit (thunderjet)',
      { tags: ['extendedPath', 'thunderjet', 'C436815'] },
      () => {
        ...
        EditPieceModal.verifyUnreceiveOptionState({ disabled: true });
      },
    );
  });
});
