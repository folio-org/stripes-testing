...
describe('Notes', () => {
  ...
  it('C527 Notes: Can create notes (spitfire)', { tags: ['criticalPath', 'spitfire', 'eurekaPhase1'] }, () => {
  ...
  it('C1245 Notes: Can view notes (spitfire)', { tags: ['criticalPath', 'spitfire', 'eurekaPhase1'] }, () => {
    NotesEholdings.createNote(note.title, note.details);
    NotesEholdings.verifyNoteCreation(note.title, note.details);
  ...
  it('C526 Notes: Can edit a note (spitfire)', { tags: ['criticalPath', 'spitfire', 'eurekaPhase1'] }, () => {
    const newNote = {
  ...
  it('C528 Notes: Can delete notes (spitfire)', { tags: ['criticalPath', 'spitfire', 'eurekaPhase1'] }, () => {
    NotesEholdings.createNote(note.title, note.details);
    NotesEholdings.verifyNoteCreation(note.title, note.details);
    NotesEholdings.openNoteView(note.title, note.details);
    NotesEholdings.deleteNote();
