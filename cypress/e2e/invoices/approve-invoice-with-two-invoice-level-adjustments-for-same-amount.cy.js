      ...
      InvoiceView.checkInvoiceDetails({
        ...
        invoiceInformation: [
          { key: INVOICE_VIEW_FIELDS.INVOICE_STATUS, value: INVOICE_STATUSES.OPEN },
          {
            ...
            value: `$${adjustmentAmount + adjustmentAmount}.00`,
          },
          {
            key: INVOICE_VIEW_FIELDS.CALCULATED_TOTAL_AMOUNT,
            value: `$${invoiceLineAmount + adjustmentAmount + adjustmentAmount}.00`,
          },
        ],
        invoiceFundDistributions: [
          {
            ...
            amount: `$${adjustmentAmount}.00`,
          },
        ],
        invoiceLevelAdjustments: [
          {
            description: testData.adjustments.adjustment1,
            value: `$${adjustmentAmount}.00`,
            prorate: ADJUSTMENT_PRORATE.NOT_PRORATED,
            relationToTotal: ADJUSTMENT_RELATION_TO_TOTAL.IN_ADDITION_TO,
          },
          {
