...
describe('Invoices', () => {
  describe('Cancellation', () => {
    ...
    const createAndPayInvoice = ({ invoiceKey, subTotal, releaseEncumbrance }) => {
    ...
    it(
      'C1028981 Encumbrance is calculated correctly after canceling a paid invoice (release encumbrance = false) when another paid invoice (release encumbrance = true) exists (thunderjet)',
      { tags: ['criticalPath', 'thunderjet', 'C1028981'] },
      () => {
        ...
        TransactionDetails.checkTransactionDetails({
          information: [
            ...
            { key: TRANSACTION_DETAIL_FIELDS.EXPENDED, value: '$150.00' },
            { key: TRANSACTION_DETAIL_FIELDS.STATUS, value: ENCUMBRANCE_STATUSES.RELEASED },
          ],
        });

        // Step 3: Unrelease encumbrance
