...
describe('Invoices', () => {
  ...
  it(
    ...
    { tags: ['extendedlPath', 'thunderjet', 'C389493'] },
    () => {
      ...
      Invoices.canNotApproveInvoice(
        `One or more Fund distributions on this invoice can not be paid, because there is not enough money in [${testData.fund.code}].`,
      );
      InvoiceView.checkInvoiceDetails({
        invoiceInformation: [
