...
describe('Invoices', () => {
  describe('Cancellation', () => {
    ...
    const createAndPayInvoice = ({ invoiceKey, subTotal }) => {
    ...
    const createAndPayInvoices = () => {
      return createAndPayInvoice({ invoiceKey: 'first', subTotal: -20 })
        .then(() => createAndPayInvoice({ invoiceKey: 'second', subTotal: 110 }))
        .then(() => createAndPayInvoice({ invoiceKey: 'third', subTotal: 10 }));
    };
    ...
    it(
      'C1028985 Encumbrance is calculated correctly after canceling a paid invoice when other paid invoices exist (release encumbrance = false) (thunderjet)',
      { tags: ['criticalPath', 'thunderjet', 'C1028985'] },
      () => {
        ...
        TransactionDetails.checkTransactionDetails({
          information: [
            ...
            { key: TRANSACTION_DETAIL_FIELDS.EXPENDED, value: '$110.00' },
