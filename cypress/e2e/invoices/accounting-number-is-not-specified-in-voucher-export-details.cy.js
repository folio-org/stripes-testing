...
import { BatchGroupConfigurations, BatchGroups } from '../../support/fragments/settings/invoices';
...
describe('Invoices', () => {
  ...
  it(
    ...
    () => {
      ...
      VoucherExportForm.checkTableContent({
        records: [
          { status: 'Uploaded', message: 'Uploaded successfully to FTP location', download: true },
        ],
      });
