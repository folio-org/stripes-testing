...
describe('Invoices', () => {
        ...
        return Invoices.changeInvoiceStatusViaApi({
          ...
          return Budgets.getBudgetByIdViaApi(testData.budget.id).then((budgetResponse) => {
            return Budgets.updateBudgetViaApi({
              ...budgetResponse,
              budgetStatus: BUDGET_STATUSES.FROZEN,
            });
          });
        });
      });
  ...
  it(
    'C422008 User is not able to cancel Invoice created in the past when associated budget has Frozen status (thunderjet)',
    { tags: ['extendedPath', 'thunderjet', 'C422008'] },
    () => {
