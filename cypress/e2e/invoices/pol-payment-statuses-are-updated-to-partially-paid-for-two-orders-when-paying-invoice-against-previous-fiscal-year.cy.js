...
describe('Invoices', () => {
      ...
      .then((order) => {
        ...
        return OrderLines.createOrderLineViaApi(
          BasicOrderLine.getDefaultOrderLine({
            ...
            title: `AT_C700858_${orderLineKey}_${getRandomPostfix()}`,
  ...
  it(
    'C700858 POL payment statuses is updated to "Partially paid" for two orders when paying an invoice against a previous fiscal year (thunderjet)',
    { tags: ['extendedPath', 'thunderjet', 'C700858', 'nonParallel'] },
    () => {
      ...
      // Step 4: Pay invoice and verify Update order status modal
      InvoiceView.clickPayInActionsMenu();
      UpdatePOLinePaymentStatusModal.verifyModalView();

      // Step 5: Select Partially paid option
      ...
      // Step 6: Click invoice line #1 related to the Order #1
      ...
      // Step 9: Click invoice line #2 related to the Order #2
      OrderLines.viewPO();
      OrderDetails.waitLoading();
      OrderDetails.openInvoice(testData.invoice.id);
      InvoiceView.waitLoading();
      ...
      // Step 10: Check encumbrance for the previous FY
      InvoiceLineDetails.openEncumbrancePane(testData.fund.name);
      TransactionDetails.checkTransactionDetails({
        information: [
          { key: TRANSACTION_DETAIL_FIELDS.FISCAL_YEAR, value: testData.fiscalYears.first.code },
      ...
      // Step 11: Click POL number hyperlink, check payment status and current encumbrance
