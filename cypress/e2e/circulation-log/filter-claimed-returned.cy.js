...
describe('Circulation log', () => {
  ...
  it(
    'C16997 Filter circulation log by Claimed returned (vega)',
    { tags: ['criticalPath', 'vega', 'C16997'] },
    () => {
  ...
  it(
    'C16998 Check the Actions button from filtering Circulation log by claimed returned (vega)',
    { tags: ['criticalPath', 'vega', 'C16998'] },
    () => {
