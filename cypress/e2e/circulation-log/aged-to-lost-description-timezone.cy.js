...
describe('Circulation log', () => {
  ...
  it(
    'C770456 "Description" field displays time according to current time zone in Circulation log for Aged to lost item (vega)',
    { tags: ['extendedPath', 'vega', 'C770456', 'LongTest'] },
    () => {
