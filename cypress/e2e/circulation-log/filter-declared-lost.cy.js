...
describe('Circulation log', () => {
  ...
  it(
    'C17135 Filter circulation log by declared lost (vega)',
    { tags: ['criticalPath', 'vega', 'C17135'] },
    () => {
  ...
  it(
    'C45934 Check the Actions button from filtering Circulation log by declared lost (vega)',
    { tags: ['criticalPath', 'vega', 'C45934'] },
    () => {
      SearchPane.setFilterOptionFromAccordion('loan', 'Declared lost');
