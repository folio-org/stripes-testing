...
describe('Organizations', () => {
  before('Create users and organizations', () => {
    cy.getAdminToken()
      ...
      .then(() => {
        ...
        Organizations.searchByParameters('Name', testData.organizations.org2.name);
  ...
  it(
    ...
    () => {
      ...
      Organizations.filterByUpdatedBy(testData.users[0].username);
      ...
      Organizations.resetFilters();
      Organizations.filterByUpdatedBy(testData.users[1].username);
