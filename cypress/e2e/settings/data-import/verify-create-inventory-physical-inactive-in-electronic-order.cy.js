...
describe('Data Import', () => {
  describe('Settings', () => {
    ...
    it(
      'C380506 Order field mapping profile: "Create Inventory" physical resource fields are inactivated when Electronic order format is selected on Create screen (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C380506'] },
      () => {
    ...
    it(
      'C380508 Order field mapping profile: "Create Inventory" physical resource fields are inactivated when Electronic order format is selected on Edit screen (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C380508'] },
      () => {
        // #1 Select "Field mapping profiles" -> Click "Actions" button -> Select "New field mapping profile" option
        FieldMappingProfiles.openNewMappingProfileForm();
