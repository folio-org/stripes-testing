...
describe('Data Import', () => {
  describe('Settings', () => {
    ...
    it(
      'C380444 Order field mapping profile: "Create Inventory" fields are inactivated when Order status is Open (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C380444'] },
      () => {
    ...
    it(
      'C380445 Order field mapping profile: "Create Inventory" fields are inactivated when Order status is Open in editing page (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C380445'] },
      () => {
        // #1 Select "Field mapping profiles" -> Click "Actions" button -> Select "New field mapping profile" option
        FieldMappingProfiles.openNewMappingProfileForm();
