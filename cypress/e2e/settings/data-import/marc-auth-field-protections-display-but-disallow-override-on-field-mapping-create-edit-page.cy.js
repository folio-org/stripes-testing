...
describe('Data Import', () => {
  describe('Settings', () => {
    describe('MARC Authority field mapping profiles', () => {
      const testData = {
        protectedFieldData: {
          field: '*',
          indicator1: '*',
        ...
        mappingProfile: {
          ...
          // incomingRecordType: NewFieldMappingProfile.incomingRecordType.marcAuth,
          // existingRecordType: NewFieldMappingProfile.incomingRecordType.marcAuth,
        },
        userProperties: {},
      };
      ...
      before('Create test data', () => {
        ...
        // });
        // MarcFieldProtection.createViaApi(testData.secondProtectedFieldData).then(
        //   (response) => {
        //     protectedFieldIds.push(response.id);
        //   },
        // );
