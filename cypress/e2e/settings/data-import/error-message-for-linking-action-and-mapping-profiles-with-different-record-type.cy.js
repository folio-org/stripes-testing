...
describe('Data Import', () => {
  describe('Settings', () => {
    ...
    it(
      'C404371 Verify the error message after attempting to link action and field mapping profiles with different record type (promin)',
      { tags: ['extendedPath', 'promin', 'C404371'] },
      () => {
