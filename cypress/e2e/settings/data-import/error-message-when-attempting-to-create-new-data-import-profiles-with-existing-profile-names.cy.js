...
describe('Data Import', () => {
  describe('Settings', () => {
    ...
    it(
      'C404370 Verify the error message when attempting to create new Data Import profiles with existing profile names (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C404370'] },
      () => {
