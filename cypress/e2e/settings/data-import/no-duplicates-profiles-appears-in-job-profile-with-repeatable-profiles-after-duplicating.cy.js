...
describe('Data Import', () => {
  describe(
    ...
    () => {
      ...
      it(
        'C385654 Verify that no duplicates of match and actions profiles appear after duplicating job profile with repeatable profiles (promin)',
        { tags: ['criticalPath', 'promin', 'C385654'] },
        () => {
