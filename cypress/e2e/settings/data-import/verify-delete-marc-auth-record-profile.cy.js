...
describe('Data Import', () => {
  describe('Settings', () => {
    ...
    it(
      'C350645 Suppress the data import profiles, being used for deleting MARC Authority record, from the Data Import settings UI (promin)',
      { tags: ['criticalPath', 'promin', 'C350645'] },
      () => {
