...
describe('Data Import', () => {
  describe('Settings', () => {
    ...
    const mappingProfile = {
      name: `C380418 Info icon ${getRandomStringCode(50)}`,
    ...
    it(
      'C380418 Order field mapping profile: review adjusted info icon text for Physical resource "Create inventory" field (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C380418'] },
      () => {
        const message =
        ...
        NewFieldMappingProfile.verifyPhysicalResourceCreateInventoryInfoMessage(message);
