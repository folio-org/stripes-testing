...
describe('Data Import', () => {
  describe('Settings', () => {
    ...
    it(
      'C380524 Order field mapping profile: Verify that electronic resource details are not active when Order format is Other in the create screen (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C380524'] },
      () => {
