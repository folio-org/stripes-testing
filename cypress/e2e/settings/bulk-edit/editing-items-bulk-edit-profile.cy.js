...
const createProfileBody = () => {
  return createBulkEditProfileBody({
    ...
    entityType: 'ITEM',
    ruleDetails: [
      createAdminNoteRule(ActionCreators.addToExisting('Original administrative note')),
...
describe('Bulk-edit', () => {
  describe('Profiles', () => {
    ...
    it(
      'C1375786 Editing Items bulk edit profile (athena)',
      { tags: ['smoke', 'athena', 'C1375786'] },
      () => {
