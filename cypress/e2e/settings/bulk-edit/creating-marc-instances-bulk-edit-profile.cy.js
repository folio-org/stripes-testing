...
describe('Bulk-edit', () => {
  describe('Profiles', () => {
    ...
    it.skip('C805764 Creating MARC instances bulk edit profile (firebird)', { tags: [] }, () => {
      ...
      InstancesBulkEditProfileForm.fillInDataTextAreaForMarcInstance(testData.electronicAccessUrl);
      InstancesBulkEditProfileForm.verifySaveButtonDisabled(false);
      ...
      InstancesBulkEditProfileView.verifyDataTextAreaForMarcInstance(testData.electronicAccessUrl);
