...
describe('MARC', () => {
  describe('MARC Authority', () => {
    describe('Settings', () => {
      ...
      it(
        'C436840 Edit "HRID starts with" field of Local "Authority file" which does not have assigned "MARC authority" records (promin)',
        { tags: ['criticalPath', 'promin', 'C436840'] },
        () => {
