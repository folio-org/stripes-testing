  ...
  describe('MARC Authority', () => {
    describe(
      ...
      () => {
        ...
        it(
          'C436844 Edit all editable fields of Local "Authority file" which does not have assigned "MARC authority" records (promin)',
          { tags: ['criticalPath', 'promin', 'shiftLeft', 'C436844'] },
          () => {
