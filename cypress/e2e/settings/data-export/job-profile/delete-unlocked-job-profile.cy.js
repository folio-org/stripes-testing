...
const notReferencedJobProfile = {
  mappingProfileName: getTestEntityValue('C1045407_NotRefMappingProfile'),
  jobProfileName: getTestEntityValue('C1045407_NotRefJobProfile'),
  mappingProfileId: null,
  jobProfileId: null,
};

const referencedJobProfile = {
  mappingProfileName: getTestEntityValue('C1045407_RefMappingProfile'),
  jobProfileName: getTestEntityValue('C1045407_RefJobProfile'),
  mappingProfileId: null,
  jobProfileId: null,
};

const folioInstanceTitle = getTestEntityValue('C1045407_FolioInstance');
const csvFileName = `AT_C1045407_instance_${getRandomPostfix()}.csv`;
