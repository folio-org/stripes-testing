...
describe('Data Export', () => {
  describe('Job profile - setup', () => {
    ...
    it(
      'C1030053 User with "Settings - UI-Data-Export Settings - Edit" capability set is able to delete unlocked job profile (athena)',
      { tags: ['criticalPath', 'athena', 'C1030053'] },
      () => {
