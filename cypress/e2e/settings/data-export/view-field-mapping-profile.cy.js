...
describe('setting: data-export', () => {
  ...
  after('delete test data', () => {
    ExportFieldMappingProfiles.getFieldMappingProfile({ query: `"name"=="${profileDetails.name}"` })
      .then(response => {
  ...
  it('C10985 View existing mapping profile (firebird)', { tags: [testTypes.criticalPath, devTeams.firebird] }, () => {
