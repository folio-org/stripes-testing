...
describe('Bulk Edit-- Users - in app approach', () => {
  ...
  it('C399098 Verify Previews for the number of Users records if the record has field with line break (firebird)', { tags: [testTypes.criticalPath, devTeams.firebird] }, () => {
    ...
    BulkEditSearchPane.verifyChangesUnderColumns('Custom fields', `${customFieldName}:${customFieldText}`);
