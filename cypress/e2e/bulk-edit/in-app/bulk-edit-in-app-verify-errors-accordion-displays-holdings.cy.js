...
describe('Bulk-edit', () => {
  describe('In-app approach', () => {
    ...
    it(
      'C369051 Verify that Errors accordion displays correct identifier on the confirmation screen (Holdings UUIDs) (athena) (TaaS)',
      { tags: ['extendedPath', 'athena', 'C369051'] },
      () => {
