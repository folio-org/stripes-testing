...
describe('Bulk-edit', () => {
  describe('In-app approach', () => {
    ...
    it(
      'C422044 Verify Bulk Edit actions for Holdings notes - remove all (athena)',
      { tags: ['criticalPath', 'athena', 'C422044'] },
      () => {
        ...
        BulkEditActions.selectAction(actionsToSelect.removeAll);
        cy.wait(500);
        BulkEditActions.verifyActionSelected(actionsToSelect.removeAll);
