...
describe('Bulk-edit', () => {
  describe('In-app approach', () => {
    ...
    it(
      'C422221 Verify separating notes in different columns - edit notes (athena)',
      { tags: ['criticalPath', 'athena', 'C422221'] },
      () => {
        ...
        BulkEditActions.selectAction(actionsToSelect.changeNoteType, 1);
        BulkEditActions.verifyActionSelected(actionsToSelect.changeNoteType, 1);
        ...
        BulkEditActions.selectAction(actionsToSelect.find, 3);
