  ...
  describe('In-app approach', () => {
    ...
    it(
      ...
      () => {
        ...
        BulkEditActions.fillInFirstTextArea(additionalActionNoteText);
        BulkEditActions.verifyValueInFirstTextArea(additionalActionNoteText);
        ...
        BulkEditActions.fillInFirstTextArea(customNoteText, 1);
        BulkEditActions.verifyValueInFirstTextArea(customNoteText, 1);
        BulkEditActions.verifyConfirmButtonDisabled(false);
