  ...
  describe(
    ...
    () => {
      beforeEach('create test data', () => {
        // Generate fresh values for each retry
        noteType = `Dew;ey Dec|im:al class & ${getRandomPostfix()}`;
        holdingsNote = `Note with;special&characters) ${getRandomPostfix()}`;
        holdingsHRIDFileName = `validHoldingHRIDs_${getRandomPostfix()}.csv`;
        holdingsNormalNote = `holdingsNormalNote-${getRandomPostfix()}`;
        item = {
