  ...
  () => {
    describe('Instances with source MARC', () => {
      beforeEach('create test data (fresh per retry)', () => {
        ...
        marcInstanceWith526And926Fields = {
          title: `AT_C543770_MarcInstanceWithFields_${getRandomPostfix()}`,
        };
        marcInstanceWithout526And926Fields = {
        ...
        marcInstanceWithFieldsData = [
          ...
          { tag: '526', content: `$a ${studyProgramNote1}`, indicators: ['0', '\\'] },
          {
            tag: '526',
          ...
          { tag: '926', content: `$a ${localStudyProgramNote1}`, indicators: ['0', '\\'] },
          {
            tag: '926',
      ...
      it(
        'C543770 Remove MARC field (526, 926) - extended scenarios (MARC) (athena)',
        { tags: ['extendedPath', 'athena', 'C543770'] },
        () => {
