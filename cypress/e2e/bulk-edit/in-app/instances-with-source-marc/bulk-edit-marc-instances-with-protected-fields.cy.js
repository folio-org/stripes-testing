...
// Define protected field IDs storage
...
// Create MARC instance with all required fields
        ...
        const previewAssertions = [
          {
            ...
            assertions: [
              ...
              (record) => {
                expect(record.fields[6]).to.deep.eq(['520', '0 ', 'a', fieldData.existing_520_0_a]);
              },
        ...
        const changedAssertions = [
          {
            ...
            assertions: [
              ...
              (record) => {
                const field520Blank = record.fields.filter((f) => f[0] === '520' && f[1] === '  ');
              ...
              (record) => {
                const field505Ind00 = record.fields.filter((f) => f[0] === '505' && f[1] === '00');
              ...
              (record) => {
                ...
                expect(field520Ind0[1]).to.deep.eq(['520', '0 ', 'a', fieldData.existing_520_0_a]);
              },
