...
describe('Bulk-edit', () => {
  describe('In-app approach', () => {
    ...
    it(
      'C1375797 Verify narrow down options dropdown choices on Items in-app bulk edit form (firebird)',
      { tags: ['extendedPath', 'firebird', 'C1375797'] },
      () => {
        const allOptions = [
          'Administrative note',
          'Check in note',
        ...
        function selectOptionAndVerifyState(option, action, rowIndex, specialHandler = null) {
          ...
          if (specialHandler) {
            ...
            BulkEditActions.selectAction(action, rowIndex);
          }
        ...
        BulkEditActions.selectAction(BULK_EDIT_ACTIONS.REMOVE_ALL);
        BulkEditActions.verifyConfirmButtonDisabled(false);
