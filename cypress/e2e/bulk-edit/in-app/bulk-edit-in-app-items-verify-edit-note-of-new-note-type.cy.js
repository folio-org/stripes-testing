...
let materialTypeId;
let sourceId;
const newItemNoteType = `AT_C402356_New_item_note_type_${randomFourDigitNumber()}`;
const note31999Chars = 'Lorem ipsum dolor sit amet. '.repeat(1142) + 'Lorem ipsum dolor siEND';
const instance = {
