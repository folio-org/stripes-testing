...
describe('bulk-edit', () => {
  describe('in-app approach', () => {
    before('create test data', () => {
      cy.createTempUser([
        ...
        .then(userProperties => {
          ...
          cy.getItems({ limit: 1, expandAll: true, query: `"barcode"=="${item.itemBarcode}"` })
            .then((res) => {
              item.id = res.id;
              const itemData = { ...res };
    ...
    it('C380583 Verify bulk edit of Item record that contains NULL values in reference data (firebird)', { tags: [testTypes.criticalPath, devTeams.firebird] }, () => {
