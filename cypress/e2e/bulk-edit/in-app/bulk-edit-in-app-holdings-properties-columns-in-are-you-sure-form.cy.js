...
describe('Bulk-edit', () => {
  describe('In-app approach', () => {
    ...
    it(
      'C432296 Verify updated properties columns appear on "Are you sure?" form and on Confirmation screen - holdings (athena)',
      { tags: ['criticalPath', 'athena', 'C432296'] },
      () => {
        ...
        BulkEditActions.selectAction(actionsToSelect.clearField, 3);
        BulkEditActions.verifyActionSelected(actionsToSelect.clearField, 3);
        BulkEditActions.verifyConfirmButtonDisabled(false);
        BulkEditActions.addNewBulkEditFilterString();
        ...
        BulkEditActions.selectAction(actionsToSelect.setTrue, 5);
        BulkEditActions.verifyActionSelected(actionsToSelect.setTrue, 5);
        BulkEditActions.verifyConfirmButtonDisabled(false);
