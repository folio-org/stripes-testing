...
describe('Bulk-edit', () => {
  describe('In-app approach', () => {
    ...
    it(
      'C431145 Verify only changed properties columns appear on "Are you sure?" form and on Confirmation screen - Instances (athena)',
      { tags: ['criticalPath', 'athena', 'C431145'] },
      () => {
