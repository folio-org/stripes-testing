...
describe('bulk-edit', () => {
  describe('in-app approach', () => {
    ...
    it(
      'C656302 Verify only changed properties columns appear on "Are you sure?" form and on Confirmation screen - Instances (firebird)',
      { tags: ['criticalPath', 'firebird', 'C656302'] },
      () => {
