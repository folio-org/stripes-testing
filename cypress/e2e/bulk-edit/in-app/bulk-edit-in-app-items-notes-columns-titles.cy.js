...
const fileNames = BulkEditFiles.getAllDownloadedFileNames(itemHRIDsFileName);
const notes = {
...
function addNoteInBulkEdit(rowNumber, itemNoteType, noteText) {
  ...
  BulkEditActions.selectSecondAction(BULK_EDIT_ACTIONS.ADD_NOTE, rowNumber);
  BulkEditActions.verifySecondActionSelected(BULK_EDIT_ACTIONS.ADD_NOTE, rowNumber);
  ...
  describe('In-app approach', () => {
    ...
    it(
      ...
      () => {
        ...
        BulkEditActions.fillInSecondTextArea(notes.binding, 1);
        BulkEditActions.verifyValueInSecondTextArea(notes.binding, 1);
        BulkEditActions.verifyConfirmButtonDisabled(false);
