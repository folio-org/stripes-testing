  ...
  describe('In-app approach', () => {
    ...
    it(
      ...
      () => {
        ...
        BulkEditActions.fillInFirstTextArea(notes.checkIn, 1);
        BulkEditActions.addNewBulkEditFilterString();
        ...
        BulkEditActions.fillInFirstTextArea(notes.checkOut, 3);
        ...
        BulkEditActions.fillInFirstTextArea(notes.action, 4);
        BulkEditActions.addNewBulkEditFilterString();
        ...
        BulkEditActions.fillInFirstTextArea(notes.binding, 5);
