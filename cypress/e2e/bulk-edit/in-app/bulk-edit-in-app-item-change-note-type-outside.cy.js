...
describe('Bulk-edit', () => {
  describe('In-app approach', () => {
    ...
    it(
      'C405542 Verify Bulk Edit actions for Items notes - preserve the "Staff only" flag when change note type to other group (athena)',
      { tags: ['criticalPath', 'athena', 'C405542'] },
      () => {
