...
describe('Bulk-edit', () => {
  describe('Query', () => {
    describe('Repeatable fields', () => {
      ...
      // Trillium
      it.skip('C808477 Search instances by Subjects fields (firebird)', { tags: [] }, () => {
        ...
        QueryModal.clickTestQuery();
        QueryModal.verifyQueryAreaContent('(instance.title starts with AT_C808477_FolioInstance)');
