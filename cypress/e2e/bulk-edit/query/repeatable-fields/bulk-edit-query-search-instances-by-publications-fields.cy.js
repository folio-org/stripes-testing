...
describe('Bulk-edit', () => {
  describe('Query', () => {
    describe('Repeatable fields', () => {
      ...
      // Trillium
      it.skip('C808476 Search instances by Publications fields (firebird)', { tags: [] }, () => {
        ...
        QueryModal.clickTestQuery();
        QueryModal.verifyQueryAreaContent('(instance.title starts with AT_C808476_FolioInstance)');
