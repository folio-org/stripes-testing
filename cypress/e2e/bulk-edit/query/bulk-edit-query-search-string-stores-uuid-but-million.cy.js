...
describe('Bulk-edit', () => {
  describe('Query', () => {
    ...
    it(
      'C436764 Query builder - Search items records associated with a given instance ("String - stores UUID but match could return millions of records" property type) (athena)',
      { tags: ['smoke', 'athena', 'C436764'] },
      () => {
