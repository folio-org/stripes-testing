...
describe('bulk-edit', () => {
  describe('csv approach', () => {
      ...
      cy.createTempUser([
        ...
        .then(userProperties => {
          ...
          cy.getUsers({ limit: 1, query: `username=${user.username}` }).then((users) => {
            cy.updateUser({ ...users[0], departments: null, proxyFor: null, personal: { ...users[0].personal, addresses: null }, tags: { ...users[0].tags, tagList: null } });
          });
        });
    });
    ...
    it('C380590 Verify bulk edit of User record that contains NULL values in reference data - CSV (firebird)', { tags: [testTypes.criticalPath, devTeams.firebird] }, () => {
