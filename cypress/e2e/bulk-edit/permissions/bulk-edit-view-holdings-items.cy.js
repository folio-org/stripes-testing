...
let itemUUIDsMatchedRecordsFileName;
let holdingUUIDsFileName;
let holdingsUUIDsMatchedRecordsFileName;
  ...
  () => {
    describe('Permissions', () => {
      beforeEach('create test data', () => {
        ...
        itemUUIDsFileName = `itemUUIDs_${getRandomPostfix()}.csv`;
        itemUUIDsMatchedRecordsFileName = `*Matched-Records-${itemUUIDsFileName}`;
        holdingUUIDsFileName = `validHoldingUUIDs_${getRandomPostfix()}.csv`;
        holdingsUUIDsMatchedRecordsFileName = `*Matched-Records-${holdingUUIDsFileName}`;
      ...
      it(
        'C423649 User with "Bulk Edit: In app - View inventory records" and "Inventory: View, create, edit instances" permissions is able to view Holdings, Items in "Bulk edit" (athena)',
        { tags: ['criticalPath', 'athena', 'C423649'] },
        () => {
