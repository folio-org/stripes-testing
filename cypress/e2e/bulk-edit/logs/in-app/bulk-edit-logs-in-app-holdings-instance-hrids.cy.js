...
describe('Bulk Edit - Logs', () => {
  ...
  it('C375298 Verify generated Logs files for Holdings In app -- valid and invalid records (firebird)', { tags: [testTypes.smoke, devTeams.firebird] }, () => {
    ...
    BulkEditFiles.verifyMatchedResultFileContent(updatesPreviewFileName, ['', ''], 'temporaryLocation', true);
    BulkEditFiles.verifyMatchedResultFileContent(updatesPreviewFileName, [instance.defaultLocation.name, instance.defaultLocation.name], 'permanentLocation', true);
