...
describe('Bulk Edit - Logs', () => {
  ...
  it(
    ...
    () => {
      ...
      BulkEditSearchPane.verifyNonMatchedResults(folioItem.instanceId, marcInstances[0].instanceId);
      ...
      BulkEditSearchPane.checkInstancesCheckbox();
      BulkEditSearchPane.clickActionsRunBy(user.username);
      BulkEditSearchPane.verifyLogsRowActionWithoutMatchingErrorWithCommittingErrors();
