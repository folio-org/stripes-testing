    ...
    describe('Logs', () => {
      describe('In-app approach', () => {
        beforeEach('create test data', () => {
          ...
          fileNames = BulkEditFiles.getAllDownloadedFileNames(instanceHRIDFileName);
        ...
        afterEach('delete test data', () => {
          ...
          FileManager.deleteFileFromDownloadsByMask(instanceHRIDFileName);
        ...
        it(
          ...
          () => {
            ...
            ExportFile.verifyFileIncludes(fileNames.matchedRecordsCSV, [item.holdingsHRID]);

            BulkEditLogs.downloadFileWithProposedChanges();
            ExportFile.verifyFileIncludes(fileNames.previewRecordsCSV, [item.holdingsHRID]);

            BulkEditLogs.downloadFileWithUpdatedRecords();
            ExportFile.verifyFileIncludes(fileNames.changedRecordsCSV, [item.holdingsHRID]);
