...
describe('Bulk Edit - Logs', () => {
  ...
  it('C368033 Filters section: Statuses (firebird) (TaaS)', { tags: ['extended', 'firebird'] }, () => {
  ...
  it('C368034 Filters section: Record types (firebird) (TaaS)', { tags: ['extended', 'firebird'] }, () => {
    BulkEditSearchPane.openLogsSearch();
    BulkEditSearchPane.verifySetCriteriaPaneExists();
  ...
  it('C368035 Filters section: Started, Ended (firebird) (TaaS)', { tags: ['extended', 'firebird'] }, () => {
  ...
  it('C368037 Verify that after clicking on "Reset all" button, all filters resets (firebird) (TaaS)', { tags: ['extended', 'firebird'] }, () => {
    BulkEditSearchPane.openLogsSearch();
    BulkEditSearchPane.verifySetCriteriaPaneExists();
