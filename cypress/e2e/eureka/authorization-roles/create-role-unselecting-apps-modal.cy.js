...
describe('Eureka', () => {
  describe('Settings', () => {
    describe('Authorization roles', () => {
      ...
      it(
        'C926156 [UISAUTHCOM-69] Display warning after unselecting application while creating a new role (eureka)',
        { tags: ['criticalPath', 'eureka', 'C926156'] },
        () => {
          AuthorizationRoles.clickSelectApplication();
          AuthorizationRoles.selectApplicationInModal(testData.originalApplications[0], true);
          AuthorizationRoles.selectApplicationInModal(testData.originalApplications[1], true);
