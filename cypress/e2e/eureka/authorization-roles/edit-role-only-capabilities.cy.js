...
describe('Eureka', () => {
  describe('Settings', () => {
    describe('Authorization roles', () => {
      ...
      const regExpBase = `\\?limit=\\d{1,}&query=applicationId=(${testData.originalApplications[0]}|${testData.originalApplications[1]})-.{1,}or.{1,}applicationId=(${testData.originalApplications[0]}|${testData.originalApplications[1]})-.{1,}`;
