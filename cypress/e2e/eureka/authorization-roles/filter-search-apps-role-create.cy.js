      ...
      describe('Authorization roles', () => {
        ...
        it(
          ...
          () => {
            ...
            testData.roleCapabilities.forEach((capab) => {
              capab.table = capab.type;
              AuthorizationRoles.verifyCapabilityCheckboxChecked(capab, true, true);
            });
