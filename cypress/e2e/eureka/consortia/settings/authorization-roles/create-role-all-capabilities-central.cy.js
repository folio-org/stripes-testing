...
describe('Eureka', () => {
  describe('Settings', () => {
    describe('Authorization roles', () => {
      const testData = {
        roleName: `AT_C965843_UserRole_${getRandomPostfix()}`,
        capabilityColumns: [
          {
      ...
      it(
        'C965843 Eureka | User can create role with all capabs/sets on Central tenant (eureka)',
        { tags: ['criticalPathECS', 'eureka', 'C965843'] },
        () => {
