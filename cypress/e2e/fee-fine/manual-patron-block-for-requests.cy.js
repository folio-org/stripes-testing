...
describe('Fees & Fines : Manual Patron Blocks', () => {
  ...
  after('Delete test data', () => {
    cy.getAdminToken();
    UserEdit.changeServicePointPreferenceViaApi(userData.user1.userId, [testData.servicePoint.id]);
    UserEdit.changeServicePointPreferenceViaApi(userData.user2.userId, [testData.servicePoint.id]);
    UserEdit.changeServicePointPreferenceViaApi(userData.user3.userId, [testData.servicePoint.id]);
  ...
  it(
    'C481: Verify that manual patron block for "Requests" blocks requests by patron',
