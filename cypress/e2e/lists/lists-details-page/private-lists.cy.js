...
describe('Lists', () => {
  describe('Lists details page', () => {
    ...
    const listWithRecordsData = {
      name: `AT_C411842_WithRecords_${getTestEntityValue('list')}`,
      description: `AT_C411842_WithRecords_${getTestEntityValue('desc')}`,
      recordType: 'Users',
      fqlQuery: '',
      isActive: true,
      isPrivate: true,
    ...
    const listWithZeroRecordsData = {
      name: `AT_C411842_ZeroRecords_${getTestEntityValue('list')}`,
      description: `AT_C411842_ZeroRecords_${getTestEntityValue('desc')}`,
      recordType: 'Users',
      fqlQuery: '',
      isActive: true,
      isPrivate: true,
    ...
    const listWithoutQueryData = {
      name: `AT_C411842_NoQuery_${getTestEntityValue('list')}`,
      description: `AT_C411842_NoQuery_${getTestEntityValue('desc')}`,
      recordType: 'Users',
      fqlQuery: '',
      isActive: true,
      isPrivate: true,
