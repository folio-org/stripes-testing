  ...
  describe('Delete list', () => {
    ...
    it(
      ...
      () => {
        ...
        Lists.verifyCalloutMessage(
          `Error: ${listData.name} was not deleted. Lists can't be deleted while a refresh is in progress.`,
        );
      },
    );
    ...
    it(
      ...
      () => {
        ...
        Lists.confirmDelete();
        Lists.verifyCalloutMessage(
          `Error: ${listData.name} was not deleted because the list was not found. Verify the list location and try again.`,
        );
      },
    );
  });
