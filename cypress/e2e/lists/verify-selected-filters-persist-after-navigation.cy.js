...
describe('Lists', () => {
  describe('Lists landing page', () => {
    ...
    it(
      'C506687 Verify that the previously selected filters are still selected when we navigate to the other apps/lists details page and come back to the "Lists" (athena)',
