...
describe('Lists', () => {
  describe('Permissions', () => {
    ...
    before('Create test data', () => {
      ...
      cy.createTempUser([Permissions.listsAll.gui, Permissions.uiInventoryMarkAsMissing.gui]).then(
        (userProperties) => {
          userDataWithInventory = userProperties;
        },
      );
      cy.createTempUser([Permissions.listsAll.gui, Permissions.inventoryCRUDHoldings.gui]).then(
        (userProperties) => {
