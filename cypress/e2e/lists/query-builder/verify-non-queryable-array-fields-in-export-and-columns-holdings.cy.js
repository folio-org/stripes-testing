...
describe('Lists', () => {
  describe('Query Builder', () => {
    ...
    it(
      'C451502 [Holdings] Verify that Non-Queryable array type fields are part of exported .csv files and column selection (athena)',
      { tags: ['extendedPath', 'athena', 'C451502'] },
      () => {
