...
const testCaseId = 'C1453662';
const listName = `AT_${testCaseId}_List_${getRandomPostfix()}`;
const addrLine2Match = `Floor 15${randomFourDigitNumber()}`;
const testData = {
  orgWithAddress: {},
};
let user;
    ...
    describe('Organizations', () => {
      before('Create test data and login', () => {
        ...
        Organizations.createOrganizationViaApi({
          ...
          addresses: [{ addressLine2: addrLine2Match }],
        }).then((id) => {
      ...
      it(
        "C1453662 Search for 'Organizations' using Addresses - Address line 2 - operator: equals (athena)",
        { tags: ['extendedPath', 'athena', 'C1453662'] },
        () => {
          ...
          // Step 3: Select "Organizations - Addresses - Address line 2" field and verify operators
          QueryModal.selectField(ORGANIZATIONS_FIELDS.ORGANIZATION.ADDRESSES.ADDRESS_LINE_2);
          ...
          QueryModal.fillInValueTextfield(addrLine2Match);
          ...
          // Step 8: Verify preview - org with matching address IS shown
