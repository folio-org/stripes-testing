...
describe('Lists', () => {
  describe('SRS', () => {
    ...
    const expectedFields = [
      ...
      {
        labelAlias: 'SRS record — Generation',
        queryable: true,
        visibleByDefault: false,
        hidden: false,
        essential: true,
      ...
      {
        labelAlias: 'SRS record — Leader record status',
        queryable: true,
        visibleByDefault: false,
        hidden: false,
        essential: true,
      ...
      {
        labelAlias: 'SRS record — MARC jsonb',
        queryable: false,
        visibleByDefault: false,
        hidden: false,
        essential: true,
      ...
      {
        labelAlias: 'SRS record — Matched UUID',
        queryable: true,
        visibleByDefault: false,
        hidden: false,
        essential: true,
    ...
    it(
      ...
      () => {
        ...
        Lists.getAllEntityTypesIncludeAllViaApi().then((response) => {
          ...
          const srsBib = response.body.entityTypes.find((et) => et.id === srsBibEntityTypeId);
          ...
          Lists.getEntityTypeByIdIncludeAllViaApi(srsBibEntityTypeId).then((detailResponse) => {
