...
describe('Lists', () => {
  describe('Query Builder', () => {
    describe('Authority', () => {
      ...
      it(
        'C1405035 Verify the available queryable field labels for "Authority" record type and "Authority headings" in the "Build query" pane (promin)',
        { tags: ['extendedPath', 'promin', 'C1405035'] },
        () => {
