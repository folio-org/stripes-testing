...
describe('Lists', () => {
  describe('Query Builder', () => {
    describe('Custom fields', () => {
      ...
      describe('Text area custom field queryable, updatable, and deletable', () => {
        ...
        it(
          ...
          () => {
            ...
            // Use current label (after the update performed in the previous test)
            ...
            // #1-#2 Go to "Settings" → "Users" → "Custom fields" → "Edit", remove the text area field
            ...
            // #3 Go to the "Lists" app and open the list that contained the text area custom field
            cy.visit(TopMenu.listsPath);
            Lists.waitLoading();
            Lists.openList(listName);
