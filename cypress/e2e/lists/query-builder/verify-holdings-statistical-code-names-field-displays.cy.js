...
const listName = `AT_C451495_List_${getRandomPostfix()}`;
const testData = {
  statisticalCodes: [],
};
let user;
  ...
  describe('Query Builder', () => {
    ...
    it(
      ...
      () => {
        ...
        Lists.verifySelectedOptionsInRecordTypeDropdown(Lists.recordTypes.holdings);
        Lists.verifySaveButtonIsActive();
        Lists.verifyCancelButtonIsActive();
        Lists.buildQuery();
        QueryModal.verify();

        // Step 2: Click "Select field" dropdown in the "Field" column => search for the field 'Holdings — Statistical code names'
        QueryModal.selectField(holdingsFieldValues.statisticalCodeNames);
        QueryModal.verifySelectedField(holdingsFieldValues.statisticalCodeNames);
        ...
        QueryModal.verifyQueryAreaContent(
          `(holdings.statistical_code_names in [${testData.statisticalCodes[0].fullName}, ${testData.statisticalCodes[1].fullName}])`,
        );
      },
    );
  });
