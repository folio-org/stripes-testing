...
const authorityUUIDsFileName = `AT_C558404_authority_uuids_${getRandomPostfix()}.csv`;
const title = `AT_C558404_MarcAuthority_${getRandomPostfix()}`;
const fields = [
  {
    tag: '100',
    content: `$a ${title}`,
...
const authFile = {
  sourceName: `AT_C558404_AuthoritySourceFile_${getRandomPostfix()}`,
...
describe('Data Export', () => {
  describe('Consortia', () => {
    ...
    it(
      'C558404 ECS | Export deleted and not deleted Authority records from Central tenant with Default authority export job profile (consortia) (firebird)',
      { tags: ['extendedPathECS', 'firebird', 'C558404'] },
      () => {
