...
const titlePrefix = `AT_C411288_Shared_${randomFourDigitNumber()}`;
...
const instances = [
  {
    title: `${titlePrefix}_FolioInstance_${getRandomPostfix()}`,
    affiliation: Affiliations.Consortia,
    type: 'folio',
  },
  {
    title: `${titlePrefix}_MarcInstance_${getRandomPostfix()}`,
    affiliation: Affiliations.Consortia,
    type: 'marc',
  },
];
  ...
  describe('Consortia', () => {
    ...
    it(
      ...
      () => {
        ...
        // Step 2-3: Click on the "Action" menu, Click "Export instances (MARC)" option
        cy.intercept('/data-export/quick-export').as('getIds');
        InventorySearchAndFilter.exportInstanceAsMarc();

        // Step 4: Verify that exported .csv file is successfully downloaded
        ...
        // Step 6: Verify log entry and download .mrc file
        ...
        cy.wait('@getInfo', getLongDelay()).then(({ response }) => {
          ...
          // Step 7: Verify export log entry
