...
let sharedMarcAuthId;
const marcFile = {
  fileName: 'marcAuthFileC410766.mrc',
  fileNameImported: `testMarcFileC410766.${getRandomPostfix()}.mrc`,
...
describe('Data Export', () => {
  describe('Consortia', () => {
    before('Create test data', () => {
      ...
      MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C410766*');
      ...
      cy.createTempUser([
        ...
        DataImport.uploadFileViaApi(
          ...
          response.forEach((record) => {
            sharedMarcAuthId = record.authority.id;
          });
        });
        ...
        MarcAuthorities.searchBeats('AT_C410766');
      });
    });
    ...
    after('Delete test data', () => {
      ...
      MarcAuthority.deleteViaAPI(sharedMarcAuthId, true);
      ...
      () => {
        ...
        cy.wait('@getHrid', getLongDelay()).then((resp) => {
          ...
          const assertionsOnMarcFileContent = [
            {
              uuid: sharedMarcAuthId,
              assertions: [
                (record) => {
                  expect(record.leader).to.eq('00633cz  a2200157n  4500');
                },
                (record) => {
                ...
                (record) => expect(record.get('999')[0].subf[1][1]).to.eq(sharedMarcAuthId),
              ],
            },
          ];
