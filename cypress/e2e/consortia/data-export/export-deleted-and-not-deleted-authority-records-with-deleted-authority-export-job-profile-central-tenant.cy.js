...
describe('Data Export', () => {
  describe('Consortia', () => {
    ...
    it(
      'C554642 ECS | Export deleted and not deleted Authority records from Central tenant with Deleted authority export job profile (consortia) (athena)',
      { tags: ['criticalPathECS', 'athena', 'C554642'] },
      () => {
