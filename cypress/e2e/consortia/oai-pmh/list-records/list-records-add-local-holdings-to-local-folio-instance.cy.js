...
const testData = {
  user: {},
  folioInstance: {
    title: `AT_C409492_LocalFolioInstance_${getRandomPostfix()}`,
    id: null,
    instanceTypeId: null,
  },
  holdingsData: {
  ...
  describe('ListRecords', () => {
    describe('Consortia', () => {
      ...
      before('Create test data', function () {
        ...
        // Get instance type ID dynamically
        cy.getInstanceTypes({ limit: 1 }).then((instanceTypes) => {
          testData.folioInstance.instanceTypeId = instanceTypes[0].id;

          // Create local FOLIO instance in College tenant (simulating "created in past")
      ...
      it(
        'C409492 Consortia | Inventory | ListRecords |ListIdentifiers: Add local FOLIO Holdings to local FOLIO instance in Member tenant is retrieved in the responses of single tenant and cross-tenant harvests (consortia) (firebird)',
        { tags: ['extendedPathECS', 'firebird', 'C409492', 'nonParallel'] },
        () => {
          ...
          OaiPmhEdge.listRecordsRequest(
            ...
            OaiPmh.verifyMarcFieldAbsent(response, testData.folioInstance.id, '952');
          });
