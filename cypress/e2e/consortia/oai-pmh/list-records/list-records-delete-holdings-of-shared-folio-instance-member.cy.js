...
const testData = {
  user: {},
  folioInstance: {
    title: `AT_C422195_SharedFolioInstance_${getRandomPostfix()}`,
    id: null,
  },
  locationName: null,
  locationId: null,
  ...
  describe('ListRecords', () => {
    describe('Consortia', () => {
      ...
      before('Create test data', function () {
        ...
        cy.getInstanceTypes({ limit: 1 }).then((instanceTypes) => {
          InventoryInstances.createFolioInstanceViaApi({
            ...
            // Create holdings in College tenant (Member-1)
            cy.setTenant(Affiliations.College);
      ...
      after('Delete test data', () => {
        ...
        // Reset OAI-PMH settings for College tenant
        cy.setTenant(Affiliations.College);
        Behavior.updateBehaviorConfigViaApi();
      ...
      it(
        'C422195 Consortium| ListRecords: Shared FOLIO instances with deleted Holdings are harvested with start and end date from Member (firebird)',
        { tags: ['extendedPathECS', 'firebird', 'C422195', 'nonParallel'] },
        () => {
          const fromDate = DateTools.getCurrentDateForOaiPmh();

          // Step 1-2: Go to Inventory app, select Holdings tab, and apply filters
