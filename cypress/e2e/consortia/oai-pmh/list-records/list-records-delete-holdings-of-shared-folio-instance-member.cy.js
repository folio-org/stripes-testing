...
describe('OAI-PMH', () => {
  describe('ListRecords', () => {
    describe('Consortia', () => {
      ...
      it(
        'C422195 Consortium| ListRecords: Shared FOLIO instances with deleted Holdings are harvested with start and end date from Member (athena)',
        { tags: ['extendedPathECS', 'athena', 'C422195', 'nonParallel'] },
        () => {
