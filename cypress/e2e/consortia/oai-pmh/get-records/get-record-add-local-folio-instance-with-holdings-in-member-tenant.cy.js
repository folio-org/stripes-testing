...
describe('OAI-PMH', () => {
  describe('Consortia', () => {
    describe('GetRecord', () => {
      ...
      it(
        'C407761 Consortia | Inventory | GetRecord: Add local FOLIO instance to Member tenant and enrich it with local FOLIO Holdings in Member tenant is retrieved in the response of single tenant harvest (consortia) (athena)',
        { tags: ['extendedPathECS', 'athena', 'C407761', 'nonParallel'] },
        () => {
