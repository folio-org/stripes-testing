...
const testData = {
  user: {},
  marcInstance: {
    title: `AT_C422176_SharedMarcInstance_${getRandomPostfix()}`,
  },
  folioInstance: {
    title: `AT_C422176_SharedFolioInstance_${getRandomPostfix()}`,
  },
  college: {
    locationId: null,
    sourceId: null,
...
describe('OAI-PMH', () => {
  describe('Consortia', () => {
    describe('GetRecord', () => {
      ...
      it(
        'C422176 Consortia | SRS+Inventory | GetRecord | Suppressed with flag | Skip suppressed: Edit shared MARC and shared FOLIO Instances (with associated Holdings in Member tenant) from Central tenant is retrieved in the response of single tenant harvest (consortia) (firebird)',
        { tags: ['extendedPathECS', 'firebird', 'C422176', 'nonParallel'] },
        () => {
          // Step 1-3: Suppress shared MARC instance
          ...
          // Step 4-6: Suppress shared FOLIO instance
          ...
          // Step 7-9: Verify MARC instance in College (t=1)
          cy.resetTenant();
          cy.getAdminToken();
          cy.setTenant(Affiliations.College);
          ...
          // Step 10-12: Verify MARC instance in University (idDoesNotExist)
          cy.setTenant(Affiliations.University);
          ...
          // Step 13-15: Verify FOLIO instance in College (t=1)
          cy.setTenant(Affiliations.College);
          ...
          // Step 16-18: Verify FOLIO instance in University (idDoesNotExist)
          cy.setTenant(Affiliations.University);
