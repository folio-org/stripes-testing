  ...
  describe('plug-in MARC authority', () => {
    describe('Consortia', () => {
      ...
      const testData = {
        ...
        tag400: '400',
        tag800: '800',
        authorityHeadingPrefix: `AT_C404428_MarcAuthority_${randomPostfix}`,
        bibTitle: `AT_C404428_MarcBibInstance_${randomPostfix}`,
        bibTag800Value: `AT_C404428_Field800_${randomPostfix}`,
        user: {},
        heldByAccordionName: 'Held by',
        naturalIdPrefix: `404428${randomDigits}${randomDigits}`,
      ...
      before('Create test data and login', () => {
        cy.resetTenant();
        cy.getAdminToken();
        MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C404428_MarcAuthority');
      ...
      it(
        'C404428 Search for "MARC authority" records in "Select MARC authority" plug-in on Member tenant (from Local "MARC bib") (consortia) (spitfire)',
        { tags: ['extendedPathECS', 'spitfire', 'C404428'] },
        () => {
          cy.setTenant(Affiliations.College);
