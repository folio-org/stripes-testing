...
describe('MARC', () => {
  describe('MARC Holdings', () => {
    describe('Edit MARC holdings', () => {
      describe('Consortia', () => {
        const testData = {
          marcBibTitle: `AT_C788748_MarcBibInstance_${getRandomPostfix()}`,
        };
        ...
        after('Delete test data', () => {
          ...
          // Delete user, holdings from Member 1 tenant (where created)
          cy.setTenant(Affiliations.College);
        ...
        it(
          'C788748 Delete MARC holdings record attached to Shared MARC bib (consortia) (spitfire)',
          { tags: ['criticalPathECS', 'spitfire', 'C788748'] },
          () => {
