  ...
  describe('MARC Bibliographic', () => {
    describe('Create new MARC bib', () => {
      describe('Consortia', () => {
        ...
        const instanceTitle = `AT_C552463_MarcBibInstance_${randomPostfix}`;
        ...
        const testData = {
          ...
          field980Content: '$a Required field',
        ...
        after('Delete test data', () => {
          ...
          if (centralField700Id && centralField700OriginalData) {
            cy.updateSpecificationField(centralField700Id, centralField700OriginalData, false);
          }
          ...
          cy.withinTenant(Affiliations.College, () => {
            if (memberField700Id && memberField700OriginalData) {
              cy.updateSpecificationField(memberField700Id, memberField700OriginalData, false);
            }
            if (memberField980Id) {
          ...
          () => {
            cy.then(() => {
                ...
                cy.getSpecificationFields(memberSpecId).then((response) => {
                  ...
                  if (existingField980) {
                    ...
                    cy.createSpecificationField(
                      ...
                      {
                        tag: testData.tag980,
                        label: `AT_C552463_Custom Field ${randomPostfix}`,
                        url: 'http://www.example.org/C552463field980.html',
                        repeatable: true,
                        required: true,
                        deprecated: false,
                      },
              ...
              .then(() => {
                ...
                // Step 5: Click "Save & close" - should show error for missing field 980
                QuickMarcEditor.pressSaveAndCloseButton();
                QuickMarcEditor.checkCallout(testData.errorMessageField980Required);
                QuickMarcEditor.checkButtonsEnabled();

                // Step 6: Add required field 980
                QuickMarcEditor.addNewField(testData.tag980, testData.field980Content, 4);
