  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Consortia', () => {
        ...
        const testData = {
          instanceTitleOriginal: `AT_C410827_MarcBibInstance_${randomPostfix}`,
          instanceTitleUpdatedByA: `AT_C410827_MarcBibInstance_${randomPostfix} Updated by A`,
          instanceTitleUpdatedByB: `AT_C410827_MarcBibInstance_${randomPostfix} Updated by B`,
        };
        ...
        before('Create users, data', () => {
          cy.resetTenant();
          cy.getAdminToken();
          InventoryInstances.deleteInstanceByTitleViaApi('C410827_');
        ...
        it(
          'C410827 Optimistic locking in Central tenant when shared "MARC Bib" record updated by another user in Central tenant (consortia) (spitfire)',
          { tags: ['extendedPathECS', 'spitfire', 'C410827'] },
          () => {
