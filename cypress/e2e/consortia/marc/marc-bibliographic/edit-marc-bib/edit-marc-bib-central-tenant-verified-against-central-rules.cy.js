  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Consortia', () => {
        ...
        const instanceTitle = `AT_C552464_MarcBibInstance_${randomPostfix}`;
        ...
        it(
          'C552464 Edited MARC bib record on Central tenant is verified against Central tenant rules (consortia) (spitfire)',
          { tags: ['criticalPathECS', 'spitfire', 'C552464', 'nonParallel'] },
          () => {
            cy.then(() => {
              cy.resetTenant();
              cy.getAdminToken();
                ...
                cy.getSpecificationFields(memberSpecId).then((response) => {
                  ...
                  if (existingField980) {
                    ...
                    cy.createSpecificationField(
                      ...
                      {
                        tag: testData.tag980,
                        label: `AT_C552464_Custom Field ${randomPostfix}`,
                        url: 'http://www.example.org/C552464field980.html',
                        repeatable: true,
                        required: true,
                        deprecated: false,
                      },
