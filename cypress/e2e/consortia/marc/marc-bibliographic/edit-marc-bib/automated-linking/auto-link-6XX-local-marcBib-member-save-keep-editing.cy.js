  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Automated linking', () => {
        ...
        const testData = {
          instanceTitle: `AT_C770444_MarcBibInstance_${randomPostfix}`,
          naturalId600: `ATC770444600${randomLetters}${randomDigits}`,
          naturalId610: `ATC770444610${randomLetters}${randomDigits}`,
          naturalId611: `ATC770444611${randomLetters}${randomDigits}`,
          naturalId630: `ATC770444630${randomLetters}${randomDigits}`,
          naturalId650: `ATC770444650${randomLetters}${randomDigits}`,
          naturalId651: `ATC770444651${randomLetters}${randomDigits}`,
          naturalId655: `ATC770444655${randomLetters}${randomDigits}`,
          heading100: `AT_C770444_PersonalName_${randomPostfix}`,
          heading110: `AT_C770444_CorporateName_${randomPostfix}.`,
          heading111: `AT_C770444_MeetingName_${randomPostfix}`,
          heading130: `AT_C770444_UniformTitle_${randomPostfix}`,
          heading150: `AT_C770444_TopicalTerm_${randomPostfix}`,
          heading151: `AT_C770444_GeographicName_${randomPostfix}`,
          heading155: `AT_C770444_GenreForm_${randomPostfix}`,
          ...
          fields: {
            tag600: {
              ...
              ind1: '0',
              ind2: '0',
              controlled: `$a AT_C770444_PersonalName_${randomPostfix} $b Numeration $c (Fictitious character) $d Dates associated with a name $c second title $f Date of a work $g Miscellaneous information $h Medium $j Attribution qualifier $k Form subheading $l Language of a work $m Medium of performance for music $n Number of part/section of a work $o Arranged statement for music $p Name of part/section of a work $q Fuller form of name $r Key for music $s Version $t Wakanda Forever`,
              eSubfield:
                '$e Relator term $v Form subdivision $x General subdivision $y Chronological subdivision $z Geographic subdivision',
              zeroSubfield: `$0 ATC770444600${randomLetters}${randomDigits}`,
            ...
            tag610: {
              ...
              ind1: '\\',
              ind2: '\\',
              controlled: `$a AT_C770444_CorporateName_${randomPostfix}. $b Hrvatski program $c Location of meeting $d Date of meeting or treaty signing $f Date of a work $g Miscellaneous information $h Medium $k Form subheading $l Language of a work $m Medium of performance for music $n Number of part/section/meeting $o Arranged statement for music $p Name of part/section of a work $r Key for music $s Version $t Title of a work`,
              eSubfield:
                '$e Relator term $u Affiliation $v Form subdivision $x General subdivision $y Chronological subdivision $z Geographic subdivision',
              zeroSubfield: `$0 ATC770444610${randomLetters}${randomDigits}`,
              seventhBox: '',
            },
            tag611: {
              tag: '611',
              ...
              ind1: '\\',
              ind2: '\\',
              controlled: `$a AT_C770444_MeetingName_${randomPostfix} $c Location of meeting $d Date of meeting or treaty signing $e Subordinate unit $f Date of a work $g Miscellaneous information $h Medium $k Form subheading $l Language of a work $n Number of part/section/meeting $p Name of part/section of a work $q Name of meeting following jurisdiction name entry element $s Version $t Title of a work $v Form subdivision $x General subdivision $y Chronological subdivision $z Geographic subdivision`,
              eSubfield:
                '$b Subordinate unit $m Moo $o Opps $r right $u Date of meeting or treaty signing',
              zeroSubfield: `$0 ATC770444611${randomLetters}${randomDigits}`,
              seventhBox: '',
            },
            tag630: {
              tag: '630',
              ...
              ind1: '\\',
              ind2: '\\',
              controlled: `$a AT_C770444_UniformTitle_${randomPostfix}`,
              eSubfield:
                '$d Date of treaty signing $e Term $f Date of a work $g Miscellaneous information $h Medium $k Form subheading $l Language of a work $m Medium of performance for music $n Number of part/section of a work $o Arranged statement for music $p Name of part/section of a work $r Key for music $s Version $t Title of a work $v Form subdivision $x General subdivision $y Chronological subdivision $z Geographic subdivision',
              zeroSubfield: `$0 ATC770444630${randomLetters}${randomDigits}`,
              seventhBox: '',
            },
            tag650: {
              tag: '650',
              ...
              ind1: '\\',
              ind2: '\\',
              controlled: `$a AT_C770444_TopicalTerm_${randomPostfix} $b debating $g Miscellaneous information $v Form subdivision $x General subdivision $y Chronological subdivision $z Geographic subdivision`,
              eSubfield: '$c Location $d Date $e Term',
              zeroSubfield: `$0 ATC770444650${randomLetters}${randomDigits}`,
              seventhBox: '',
            },
            tag651: {
              tag: '651',
              ...
              ind1: '\\',
              ind2: '\\',
              controlled: `$a AT_C770444_GeographicName_${randomPostfix} $g Place in Texas $v Form subdivision $x General subdivision $y Chronological subdivision $z Geographic subdivision`,
              eSubfield: '$e Term',
              zeroSubfield: `$0 ATC770444651${randomLetters}${randomDigits}`,
              seventhBox: '$4 Test',
            },
            tag655: {
              tag: '655',
              ...
              ind1: '\\',
              ind2: '\\',
              controlled: `$a AT_C770444_GenreForm_${randomPostfix}`,
              eSubfield:
                '$b Bowl $c Chicken $v Form subdivision $x General subdivision $y Chronological subdivision $z Geographic subdivision',
              zeroSubfield: `$0 ATC770444655${randomLetters}${randomDigits}`,
              seventhBox: '$7 Luck',
            },
          },
        };
        ...
        before('Create user, set linking rules, create data via API', () => {
          ...
          MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C770444_');
          InventoryInstances.deleteInstanceByTitleViaApi('AT_C770444_');
          ...
          // Create local bib record on Member (College)
          cy.setTenant(Affiliations.College);
