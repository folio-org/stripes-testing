  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Consortia', () => {
        ...
        it(
          'C589506 Cannot save existing MARC bib record with value in "010 $a" subfield which matches to "Suppressed from discovery" record "LCCN" field when duplicate LCCN check is enabled (consortia) (promin)',
          { tags: ['criticalPathECS', 'promin', 'nonParallel', 'C589506'] },
          () => {
