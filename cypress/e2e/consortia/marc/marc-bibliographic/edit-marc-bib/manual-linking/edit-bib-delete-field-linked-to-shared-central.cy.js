    ...
    describe('Edit MARC bib', () => {
      describe('Manual linking', () => {
        describe('Consortia', () => {
          ...
          it(
            'C407684 Delete linked field from Shared MARC bib linked with Shared MARC authority in Central tenant (consortia) (promin)',
            { tags: ['extendedPathECS', 'promin', 'C407684'] },
            () => {
