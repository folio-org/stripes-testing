    ...
    describe('Edit MARC bib', () => {
      describe('Manual linking', () => {
        describe('Consortia', () => {
          ...
          const bibTitle = `AT_C407666_MarcBibInstance_${randomPostfix}`;
          const authorityHeading = `AT_C407666_MarcAuthority_${randomPostfix}`;
          ...
          const unlinkedFieldData = {
            ...
            ind1: bibFields[2].indicators[0],
            ind2: bibFields[2].indicators[1],
            content: `${authorityFields[0].content} $0 ${authData.prefix}${authData.startWithNumber}`,
          };
          ...
          before('Create test data', () => {
            cy.resetTenant();
            cy.getAdminToken();
            MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C407666');
            InventoryInstances.deleteInstanceByTitleViaApi('AT_C407666');
          ...
          it(
            ...
            () => {
              ...
              InventoryInstances.selectInstanceById(createdInstanceId);
              InventoryInstance.waitLoading();
              InventoryInstance.verifySubjectHeading(subjectValue);
              InventoryInstance.editMarcBibliographicRecord();
              QuickMarcEditor.verifyTagFieldAfterUnlinkingByTag(
                ...Object.values(unlinkedFieldData),
              );
