    ...
    describe('Edit MARC bib', () => {
      describe('Manual linking', () => {
        describe('Consortia', () => {
          ...
          const bibTitle = `AT_C407627_MarcBibInstance_${randomPostfix}`;
          const authorityHeadingShared = `AT_C407627_MarcAuthority_${randomPostfix}_Shared`;
          const authorityHeadingLocal = `AT_C407627_MarcAuthority_${randomPostfix}_Local`;
          ...
          const unlinkedFieldData100 = {
            tag: bibFields[2].tag,
            ind1: bibFields[2].indicators[0],
            ind2: bibFields[2].indicators[1],
            content: `${authorityFieldsShared[0].content} $0 ${authData.prefix}${authData.startWithNumber}`,
          };
          const unlinkedFieldData600 = {
            tag: bibFields[3].tag,
            ind1: bibFields[3].indicators[0],
            ind2: bibFields[3].indicators[1],
            content: `${authorityFieldsLocal[0].content} $0 ${authData.prefix}${authData.startWithNumber + 1}`,
          };
          ...
          before('Create test data', () => {
            cy.then(() => {
              cy.resetTenant();
              cy.getAdminToken();
              MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C407627');
              InventoryInstances.deleteInstanceByTitleViaApi('AT_C407627');
          ...
          it(
            ...
            () => {
              ...
              QuickMarcEditor.clickUnlinkIconInFieldByTag(linkedFieldData100.tag);
              QuickMarcEditor.confirmUnlinkingField();
              QuickMarcEditor.verifyTagFieldAfterUnlinkingByTag(
                ...Object.values(unlinkedFieldData100),
              );

              QuickMarcEditor.clickUnlinkIconInFieldByTag(linkedFieldData600.tag);
              QuickMarcEditor.confirmUnlinkingField();
              QuickMarcEditor.verifyTagFieldAfterUnlinkingByTag(
                ...Object.values(unlinkedFieldData600),
              );
