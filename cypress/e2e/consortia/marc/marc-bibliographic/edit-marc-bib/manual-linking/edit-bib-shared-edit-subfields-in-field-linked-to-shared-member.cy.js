    ...
    describe('Edit MARC bib', () => {
      describe('Manual linking', () => {
        describe('Consortia', () => {
          ...
          const bibTitle = `AT_C407691_MarcBibInstance_${randomPostfix}`;
          const authorityHeadingPrefix = `AT_C407691_MarcAuthority_${randomPostfix}`;
          ...
          const authData = { prefix: randomLetters, startWithNumber: 407691000 };
          ...
          const fieldEditData = [
            ...
            { row: bibField650Index, boxNumber: 7, value: '$7 first $7 second' },
            { row: bibField650Index + 1, boxNumber: 5, value: '' },
            { row: bibField650Index + 1, boxNumber: 7, value: '$4 new' },
          ];
          const lastEditData = { row: bibField650Index, boxNumber: 5, value: '' };
          const linkedFieldData650Updated = {
            ...
            uncontrolledDigitSubfields: fieldEditData[1].value,
          };
          ...
          before('Create test data', () => {
            cy.resetTenant();
            cy.getAdminToken();
            MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C407691');
            InventoryInstances.deleteInstanceByTitleViaApi('AT_C407691');
          ...
          it(
            ...
            () => {
              ...
              QuickMarcEditor.checkErrorMessage(
                bibField650Index,
                errorTexts.nonRepeatableSubfieldsErrorTxt,
              );

              QuickMarcEditor.fillLinkedFieldBox(...Object.values(lastEditData));
              ...
              InventoryViewSource.checkRowExistsWithTagAndValue(
                tags.tag650,
                `${linkedFieldData650.controlledLetterSubfields} $0 ${authData.prefix}${authData.startWithNumber} $9 ${createdAuthorityIds[0]} ${fieldEditData[1].value}`,
              );
              InventoryViewSource.checkRowExistsWithTagAndValue(
                tags.tag711,
