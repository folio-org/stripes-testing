  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Consortia', () => {
        ...
        const testData = {
          instanceTitleOriginal: `AT_C410823_MarcBibInstance_${randomPostfix}`,
          instanceTitleUpdatedByA: `AT_C410823_MarcBibInstance_${randomPostfix} Updated by A`,
          instanceTitleUpdatedByB: `AT_C410823_MarcBibInstance_${randomPostfix} Updated by B`,
        };
        ...
        before('Create users, data', () => {
          cy.resetTenant();
          cy.getAdminToken();
          InventoryInstances.deleteInstanceByTitleViaApi('C410823_');
          ...
          cy.createMarcBibliographicViaAPI(QuickMarcEditor.defaultValidLdr, marcBibFields).then(
            (instanceId) => {
              ...
              // Create Holdings in Member (College)
          ...
          // Create User B in Central tenant only (primary affiliation = Central)
          cy.resetTenant();
          cy.createTempUser([
            Permissions.inventoryAll.gui,
            Permissions.uiQuickMarcQuickMarcBibliographicEditorAll.gui,
        ...
        it(
          'C410823 Optimistic locking in Member tenant when shared "MARC Bib" record (shadow MARC Instance in Member tenant) updated by another user in Central tenant (consortia) (spitfire)',
          { tags: ['extendedPathECS', 'spitfire', 'C410823'] },
          () => {
