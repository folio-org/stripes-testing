  ...
  describe('MARC Bibliographic', () => {
    describe('Derive MARC bib', () => {
      describe('Consortia', () => {
        ...
        const instanceTitle = `AT_C552471_MarcBibInstance_${randomPostfix}`;
        ...
        after('Delete test data', () => {
          ...
          cy.withinTenant(Affiliations.College, () => {
            ...
            InventoryInstances.deleteInstanceByTitleViaApi(instanceTitleDerived);
          });
                ...
                cy.getSpecificationFields(memberSpecId).then((response) => {
                  ...
                  if (existingField980) {
                    ...
                    cy.createSpecificationField(
                      ...
                      {
                        tag: testData.tag980,
                        label: `AT_C552471_Custom Field ${randomPostfix}`,
                        url: 'http://www.example.org/C552471field980.html',
                        repeatable: true,
                        required: true,
                        deprecated: false,
                      },
