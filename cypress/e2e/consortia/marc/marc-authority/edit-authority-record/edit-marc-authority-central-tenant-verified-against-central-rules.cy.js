  ...
  describe('MARC authority', () => {
    describe('Edit', () => {
      describe('Consortia', () => {
        ...
        it(
          'C552477 Edited MARC authority record on Central tenant is verified against Central tenant rules (consortia) (promin)',
          { tags: ['criticalPathECS', 'promin', 'C552477', 'nonParallel'] },
          () => {
            cy.then(() => {
              cy.resetTenant();
              cy.getAdminToken();
