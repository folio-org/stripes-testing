  ...
  describe('MARC Authority', () => {
    describe('Edit MARC Authority', () => {
      describe('Consortia', () => {
        ...
        it(
          'C514882 Cannot save existing Shared MARC authority record with value in "010 $a" subfield which matches to other Shared, Local record "010 $a", "010 $z" fields when duplicate LCCN check is enabled (consortia) (promin)',
          { tags: ['extendedPathECS', 'promin', 'nonParallel', 'C514882'] },
          () => {
