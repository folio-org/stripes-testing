    ...
    describe('Edit', () => {
      describe('Consortia', () => {
        ...
        const testData = {
          ...
          tag500: '500',
          tag980: '980',
          authorityNaturalId: `n552478${randomPostfix}`,
          authorityHeadingPrefix: `AT_C552478_MarcAuthority_${randomPostfix}`,
        ...
        before('Create test data', () => {
          ...
          // Get specification IDs for both tenants, and reset specs
        ...
        it(
          ...
          () => {
            cy.then(() => {
              cy.resetTenant();
              cy.getAdminToken();
              MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C552478_');
                  ...
                  cy.getSpecificationFields(memberSpecId).then((response) => {
                    ...
                    if (existingField980) {
                      ...
                      cy.createSpecificationField(
                        ...
                        {
                          tag: testData.tag980,
                          label: `AT_C552478_Custom_Field_${randomPostfix}`,
                          url: 'http://www.example.org/C552478field980.html',
                          repeatable: false,
                          required: true,
                          deprecated: false,
                        },
              ...
              .then(() => {
                ...
                MarcAuthority.verifySharedAuthorityDetailsHeading(testData.authorityHeadingPrefix);
                ...
                // Step 7: Repeat steps 1, 5, 6 — edit again, trigger error, fix, save
                MarcAuthority.edit();
                QuickMarcEditor.waitLoading();
