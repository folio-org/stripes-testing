  ...
  describe('MARC Authority', () => {
    describe('Edit MARC Authority', () => {
      describe('Consortia', () => {
        ...
        it(
          'C514874 Cannot save existing MARC authority record with value in "010 $a" subfield which matches to Multiple records "010 $a" when duplicate LCCN check is enabled (consortia) (promin)',
          { tags: ['extendedPathECS', 'promin', 'nonParallel', 'C514874'] },
          () => {
