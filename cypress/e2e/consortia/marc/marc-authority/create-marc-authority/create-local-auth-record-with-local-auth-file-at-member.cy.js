  ...
  describe('MARC Authority', () => {
    describe('Create', () => {
      describe('Consortia', () => {
        ...
        it(
          'C423583 Create a new local MARC authority record with "Local" authority file selected at Member tenant (consortia) (promin)',
          { tags: ['criticalPathECS', 'promin', 'C423583'] },
          () => {
