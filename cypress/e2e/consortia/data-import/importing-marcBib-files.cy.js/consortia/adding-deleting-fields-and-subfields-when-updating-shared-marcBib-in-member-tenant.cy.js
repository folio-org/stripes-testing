    ...
    describe('Consortia', () => {
      ...
      before('Create test data', () => {
        ...
        cy.createTempUser([
          ...
          .then(() => {
            cy.assignAffiliationToUser(testData.memberTenant1, testData.user.userId);
            cy.assignAffiliationToUser(testData.memberTenant2, testData.user.userId);
            cy.setTenant(testData.memberTenant1);
            cy.assignPermissionsToExistingUser(testData.user, [
              Permissions.moduleDataImportEnabled.gui,
              Permissions.inventoryAll.gui,
              Permissions.uiQuickMarcQuickMarcBibliographicEditorAll.gui,
              Permissions.dataExportEnableApp.gui,
            ...
            cy.setTenant(testData.memberTenant2);
            cy.assignPermissionsToExistingUser(testData.user, [
              Permissions.moduleDataImportEnabled.gui,
              Permissions.inventoryAll.gui,
              Permissions.uiQuickMarcQuickMarcBibliographicEditorAll.gui,
      ...
      it(
        ...
        () => {
          ...
          ConsortiumManager.switchActiveAffiliation(testData.memberTenant1);
          ...
          ConsortiumManager.switchActiveAffiliation(testData.memberTenant2);
          cy.visit(TopMenu.inventoryPath);
          InventorySearchAndFilter.verifyPanesExist();
          InventoryInstance.searchByTitle(testData.sharedInstanceId[0]);
          // InventoryInstance.waitInstanceRecordViewOpened(testData.instanceTitle);
