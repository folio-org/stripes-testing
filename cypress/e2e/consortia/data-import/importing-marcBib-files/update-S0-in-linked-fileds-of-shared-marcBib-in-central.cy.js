...
describe('Data Import', () => {
  describe('Importing MARC Bib files', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411802 Updating "$0" in linked fields of shared "MARC Bib" which has "Shadow" copy in member tenant via Data Import from Central tenant (consortia) (promin)',
        { tags: ['criticalPathECS', 'promin', 'C411802'] },
        () => {
          InventoryInstances.searchByTitle(createdAuthorityIDs[0]);
          InventoryInstances.selectInstance();
          // download .csv file
          ...
          InventoryViewSource.contains(
            '\t630\t   \t$a C411802 Marvel comics $t Comiket $v Periodicals. $z United States $w 830 $0 800269554076962001 $2 fast',
          );
          InventoryViewSource.contains(
            '\t650\t   \t$a C411802 Speaking Oratory $b debating $2 fast',
          );
          InventoryViewSource.contains(
            `${testData.marcAuthIcon}\n\t710\t   \t$a C411802 Radio "Vaticana". $b Hrvatski program $0 http://id.loc.gov/authorities/names/n93094742407696 $9`,
          );
