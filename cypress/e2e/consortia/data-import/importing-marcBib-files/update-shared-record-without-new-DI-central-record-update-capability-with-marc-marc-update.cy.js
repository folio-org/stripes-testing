    ...
    describe('Consortia', () => {
      const testData = {
        ...
        marcFile: {
          ...
          fileName: `C805768 testMarcFile${getRandomPostfix()}.mrc`,
          exportedFileName: `C805768 exportedTestMarcFile${getRandomPostfix()}.mrc`,
          modifiedMarcFile: `C805768 modifiedTestMarcFile${getRandomPostfix()}.mrc`,
          updatedFileName: `C805768 updatedTestMarcFile${getRandomPostfix()}.mrc`,
        },
      ...
      const mappingProfile = {
        name: `C805768 Update instance for SRS MARC${getRandomPostfix()}`,
      ...
      const matchProfile = {
        profileName: `C805768 001-to-001 match${getRandomPostfix()}`,
      ...
      const jobProfile = {
        profileName: `C805768 001 to 001 match for update${getRandomPostfix()}`,
      ...
      it(
        'C805768 Update shared record without new "Data-Import Central-Record-Update" capability with MARC-MARC update (consortia) (folijet)',
        { tags: ['criticalPathECS', 'folijet', 'C805768'] },
        () => {
