...
describe('Data Import', () => {
  describe('Importing MARC Holdings files', () => {
    describe('Consortia', () => {
      ...
      const bibTitle = `AT_C788745_MarcBibInstance_${randomPostfix}`;
      const holdingsFileName = 'marcHoldingsFileForC788745.mrc';
      const editedMarcFileName = `AT_C788745_MarcHoldingsFile_${randomPostfix}.mrc`;
      const tag868UpdatedContent = `AT_C788745_868_${randomPostfix}`;
      ...
      before('Create test data', () => {
        ...
        InventoryInstances.deleteFullInstancesByTitleViaApi('C788745_');

        cy.then(() => {
          // Create a Local "MARC bibliographic" record directly in Member 1 (College) tenant
      ...
      it(
        'C788745 Import MARC holdings for Local Instance from Member tenant (promin)',
        { tags: ['criticalPathECS', 'promin', 'C788745'] },
        () => {
