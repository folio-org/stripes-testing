...
describe('Consortia Vega', () => {
  Cypress.env('TestCase', 'C624274');
  const testData = {
    instanceTitle: `AT_C624274_Instance_${getRandomPostfix()}`,
    itemBarcode: uuid(),
  };
  ...
  it(
    'C624274 Check that user can cancel ECS Title level Page request (consortia) (vega)',
    { tags: ['smokeECS', 'vega', 'C624274'] },
    () => {
