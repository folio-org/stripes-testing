...
describe('Consortia Vega', () => {
  const testData = {
    instanceTitle: `C624260 Instance ${getRandomPostfix()}`,
    itemBarcode: uuid(),
  };
  ...
  it(
    'C624260 Check that user can create ECS Item level Page request (consortia) (vega)',
    { tags: ['smokeECS', 'vega', 'C624260'] },
    () => {
