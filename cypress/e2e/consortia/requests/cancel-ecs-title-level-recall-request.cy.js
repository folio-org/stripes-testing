...
describe('Consortia Vega', () => {
  const testData = {
    instanceTitle: `AT_C624276_Instance_${getRandomPostfix()}`,
    itemBarcode: uuid(),
  };
  ...
  it(
    'C624276 Check that user can cancel ECS Title level Recall request (consortia) (vega)',
    { tags: ['criticalPathECS', 'vega', 'C624276'] },
    () => {
