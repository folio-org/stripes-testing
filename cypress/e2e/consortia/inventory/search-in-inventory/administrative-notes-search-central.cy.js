...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411631 Search for Shared/Local records by "Instance administrative notes" search option from "Central" tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411631'] },
        () => {
