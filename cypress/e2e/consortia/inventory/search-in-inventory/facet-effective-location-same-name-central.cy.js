  ...
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      describe('Consortia', () => {
        ...
        const locationPrefix = `C491302${getRandomLetters(7)}`;
        const testData = {
          locations: {},
          instances: {},
          user: {},
        ...
        it(
          ...
          () => {
            ...
            // Verify locations with counters in dropdown
            ...
            InventoryInstances.checkSearchResultCount(1);
            ...
            // Select Member 1 location and verify result
            InventorySearchAndFilter.selectMultiSelectFilterOption(
              locationsAccordionName,
              `${testData.locations.testLocation_member1.name} (${tenantDisplayNames.member1})`,
            );
            ...
            // Switch to Item tab, verify cleared
