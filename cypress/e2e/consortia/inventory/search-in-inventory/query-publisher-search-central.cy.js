...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411669 Search for Shared/Local records by "Query search" search option from "Central" tenant (publisher field) (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411669'] },
        () => {
