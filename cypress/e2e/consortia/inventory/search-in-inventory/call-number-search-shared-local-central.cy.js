...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      const instancePrefix = `AT_C411713_Instance_${randomPostfix}`;
      const callNumberPrefix = `AT_C411713_CallNumber_${randomPostfix}`;
      const searchOptions = {
      ...
      before('Create user, data', () => {
        cy.resetTenant();
        cy.getAdminToken();
        InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C411713');
      ...
      it(
        'C411713 Search for Shared/Local records by "Call number, not normalized" and "Call number, normalized" search options from "Central" tenant (consortia) (spitfire)',
        { tags: ['extendedPathECS', 'spitfire', 'C411713'] },
        () => {
