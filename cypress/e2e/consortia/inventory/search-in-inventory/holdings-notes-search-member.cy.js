...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      const instancePrefix = `AT_C411727_Instance_${randomPostfix}`;
      const notePrefix = `AT_C411727_Note_${randomPostfix}`;
      const adminNotePrefix = `AT_C411727_AdminNote_${randomPostfix}`;
      ...
      before('Create user, data', () => {
        cy.resetTenant();
        cy.getAdminToken();
        InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C411727');
      ...
      it(
        'C411727 Search for Shared/Local records by "Holdings notes (all)" and "Holdings administrative notes" search options from "Member" tenant (consortia) (spitfire)',
        { tags: ['extendedPathECS', 'spitfire', 'C411727'] },
        () => {
