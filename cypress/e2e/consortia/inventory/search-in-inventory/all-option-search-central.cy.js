...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411646 Search for Shared/Local records by "All" search option from "Central" tenant (Instance, Holdings, Item tabs) (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411646'] },
        () => {
