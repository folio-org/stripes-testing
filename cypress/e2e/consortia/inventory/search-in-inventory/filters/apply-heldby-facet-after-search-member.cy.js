  ...
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      describe('Consortia', () => {
        ...
        const instancePrefix = `AT_C402350_Instance_${randomPostfix}`;
        ...
        before('Create user, data', () => {
          cy.resetTenant();
          cy.getAdminToken();
          InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C402350');
        ...
        it(
          'C402350 Use "Held by" facet when Search was executed in "Member" tenant ("Instance" tab) (consortia) (spitfire)',
          { tags: ['extendedPathECS', 'spitfire', 'C402350'] },
          () => {
            ...
            InventoryInstances.selectInstanceByTitle(
              instanceTitles[instanceIndexesAllVisibleInCollege[3]],
            );
            ...
            InventorySearchAndFilter.fillInSearchQuery(instanceTitles[0]);
            InventorySearchAndFilter.clickSearch();
            ...
            InventorySearchAndFilter.fillInSearchQuery(instanceTitles[2]);
            InventorySearchAndFilter.clickSearch();
            InventorySearchAndFilter.verifyResultPaneEmpty({
              noResultsFound: true,
              searchQuery: instanceTitles[2],
            });
            InventorySearchAndFilter.verifyMultiSelectFilterOptionSelected(
              heldbyAccordionName,
              tenantNames.college,
