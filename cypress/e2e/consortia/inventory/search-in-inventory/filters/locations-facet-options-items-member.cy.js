  ...
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      describe('Consortia', () => {
        ...
        const instancePrefix = `AT_C471485_Instance_${randomPostfix}`;
        ...
        before('Create user, data', () => {
          ...
          cy.createTempUser([Permissions.uiInventoryViewInstances.gui])
            .then((userProperties) => {
              ...
              InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C471485');
              cy.getLocations({
                limit: 3,
        ...
        it(
          ...
          () => {
            ...
            cy.log(locations[Affiliations.University][2].name);
