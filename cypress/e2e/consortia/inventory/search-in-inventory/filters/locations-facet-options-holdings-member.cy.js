  ...
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      describe('Consortia', () => {
        ...
        const instancePrefix = `AT_C471484_Instance_${randomPostfix}`;
        ...
        before('Create user, data', () => {
          ...
          cy.createTempUser([Permissions.uiInventoryViewInstances.gui])
            .then((userProperties) => {
              ...
              InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C471484');
              cy.getLocations({
                limit: 3,
        ...
        it(
          'C471484 Locations from all existing tenants displays in "Effective location (item)" facet of search Holdings pane in "Inventory" app opened from "Member" tenant (consortia) (spitfire)',
          { tags: ['extendedPathECS', 'spitfire', 'C471484'] },
          () => {
            const usedLocations = [
