  ...
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      describe('Consortia', () => {
        ...
        const instancePrefix = `AT_C423640_Instance_${randomPostfix}`;
        ...
        before('Create user, data', () => {
          ...
          cy.createTempUser([Permissions.uiInventoryViewInstances.gui])
            .then((userProperties) => {
              ...
              InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C423640');
              cy.getLocations({
                limit: 3,
        ...
        it(
          'C423640 Locations from all existing tenants displays in "Holdings permanent location" facet of search Holdings pane in "Inventory" app opened from "Member" tenant (consortia) (spitfire)',
          { tags: ['extendedPathECS', 'spitfire', 'C423640'] },
          () => {
            const usedLocations = [
