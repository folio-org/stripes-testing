  ...
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      describe('Consortia', () => {
        ...
        it(
          'C471483 Locations from all existing tenants displays in "Effective location (item)" facet of search Instance pane in "Inventory" app opened from "Member" tenant (consortia) (promin)',
          { tags: ['extendedPathECS', 'promin', 'C471483'] },
          () => {
            const usedLocations = [
