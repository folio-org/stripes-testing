...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      const instancePrefix = `AT_C411729_Instance_${randomPostfix}`;
      ...
      before('Create user, data', () => {
        cy.resetTenant();
        cy.getAdminToken();
        InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C411729');
      ...
      it(
        'C411729 Search for Shared/Local records by "Holdings HRID" search options from "Member" tenant (consortia) (spitfire)',
        { tags: ['extendedPathECS', 'spitfire', 'C411729'] },
        () => {
          ...
          instancesData.forEach((instanceData, index) => {
            instanceData.holdingsHrids.forEach((holdingsHrid) => {
              ...
              if (instanceData.affiliation !== Affiliations.University) {
