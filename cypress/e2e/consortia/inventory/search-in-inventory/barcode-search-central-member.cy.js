...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      const instancePrefix = `AT_C411750_Instance_${randomPostfix}`;
      const barcodePrefix = `AT_C411750_Barcode_${randomPostfix}`;
      const searchOptions = {
      ...
      before('Create user, data', () => {
        cy.resetTenant();
        cy.getAdminToken();
        InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C411750');
              ...
              instanceData.holdingsAffiliations.forEach((holdingsAffiliation, holdingsIndex) => {
                ...
                InventoryHoldings.createHoldingRecordViaApi({
                  ...
                  InventoryItems.createItemViaApi({
                    barcode: `${barcodePrefix}_${instanceIndex}-${holdingsIndex}`,
      ...
      it(
        ...
        () => {
          ...
          InventorySearchAndFilter.selectSearchOption(searchOptions.keyword);
