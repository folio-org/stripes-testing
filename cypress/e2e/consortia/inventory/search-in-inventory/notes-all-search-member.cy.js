...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      const instancePrefix = `AT_C411628_Instance_${randomPostfix}`;
      const notePrefix = `AT_C411628_Note_${randomPostfix}`;
      ...
      before('Create user, data', () => {
        cy.resetTenant();
        cy.getAdminToken();
        InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C411628');
      ...
      it(
        'C411628 Search for Shared/Local records by "Instance notes (all)" search option from "Member" tenant (consortia) (spitfire)',
        { tags: ['extendedPathECS', 'spitfire', 'C411628'] },
        () => {
