...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Consortia', () => {
      ...
      it(
        'C410714 "Shared" records will be found from "Instance/Holdings/Item" tabs of "Inventory" app on Central tenant (consortia) (promin)',
        { tags: ['criticalPathECS', 'promin', 'C410714'] },
        () => {
