  ...
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      describe('Consortia', () => {
        ...
        const instancePrefix = `AT_C436892_Instance_${randomPostfix}`;
        const locationPrefix = `AT_C436892_Location_${randomPostfix}`;
        const organization = NewOrganization.getDefaultOrganization();
        organization.name = `AT_C436892_Org_${randomPostfix}`;
        ...
        const allVisibleIndexes = instancesData
        ...
        before('Create user, data', () => {
          ...
          cy.createTempUser(userPermissions)
            .then((userProperties) => {
              ...
              cy.setTenant(Affiliations.College);
              InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C436892');
        ...
        it(
          'C436892 Select instance plugin | Verify Tenant name displays next to location in "Effective location" facet during searching in Member tenant (consortia) (spitfire)',
          { tags: ['extendedPathECS', 'spitfire', 'C436892'] },
          () => {
            ...
            allVisibleIndexes.forEach((instanceIndex) => {
            ...
            InventorySearchAndFilter.verifySearchResult(instanceTitles[6]);
