...
describe('Inventory', () => {
  describe('Contributors Browse', () => {
    describe('Consortia', () => {
      ...
      it(
        'C422237 Verify that contributors from Shared Instance is not displayed in browse result list when "No" is selected in "Shared" facet (current tenant doesn\'t have this local contributor, but another tenant has) (consortia) (promin)',
        { tags: ['criticalPathECS', 'promin', 'C422237'] },
        () => {
