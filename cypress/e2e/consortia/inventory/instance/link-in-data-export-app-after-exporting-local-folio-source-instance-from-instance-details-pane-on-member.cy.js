...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C422079 (CONSORTIA) Verify the link in Data export app after exporting local FOLIO Source Instance from Instance details pane on Member tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C422079'] },
        () => {
