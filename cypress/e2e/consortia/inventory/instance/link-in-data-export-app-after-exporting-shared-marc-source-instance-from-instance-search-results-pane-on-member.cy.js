...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C422078 (CONSORTIA) Verify the link in Data export app after exporting shared MARC Source Instance from Instance search results pane on Member tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C422078'] },
        () => {
