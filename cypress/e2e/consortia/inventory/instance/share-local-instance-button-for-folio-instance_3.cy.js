...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411329 (CONSORTIA) Check the "Share local instance" button on a shared Source = FOLIO Instance on Member tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411329'] },
        () => {
