...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411619 (CONSORTIA) Verify the Consortial holdings accordion details on shared Instance in Member Tenant without permissions (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411619'] },
        () => {
