...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      const testData = {
        shadowInstance: {
          instanceTitle: `C411659 Autotest Instance ${getRandomPostfix()}`,
          instanceTypeId: '',
        },
        holdings: {},
        item: { barcode: uuid() },
      ...
      it(
        'C411659 (CONSORTIA) Verify Add holdings action on Consortial holdings accordion details on shared Instance on Member Tenant (consortia) (folijet)',
        { tags: ['extendedPathECS', 'folijet', 'C411659'] },
        () => {
