...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411620 (CONSORTIA) Verify the Consortial holdings accordion details on local Instance on Member Tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411620'] },
        () => {
