...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C446124 (CONSORTIA) Verify the Consortial holdings accordion details on shared Instance in Member Tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C446124'] },
        () => {
