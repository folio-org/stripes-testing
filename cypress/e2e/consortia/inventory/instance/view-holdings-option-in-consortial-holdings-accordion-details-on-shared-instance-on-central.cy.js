...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411637 (CONSORTIA) Verify View holdings option in Consortial holdings accordion details on shared Instance on Central Tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411637'] },
        () => {
