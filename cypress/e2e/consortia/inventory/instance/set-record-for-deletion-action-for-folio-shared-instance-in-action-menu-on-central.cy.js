...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C445999 (CONSORTIA) Check "Set record for deletion" action for FOLIO Shared Instance in Actions menu on Central tenant (promin)',
        { tags: ['extendedPathECS', 'promin', 'C445999'] },
        () => {
