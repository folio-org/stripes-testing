...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C409467 (CONSORTIA) Verify the " Overlay source bibliographic record" button on Central tenant Instance page (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C409467'] },
        () => {
