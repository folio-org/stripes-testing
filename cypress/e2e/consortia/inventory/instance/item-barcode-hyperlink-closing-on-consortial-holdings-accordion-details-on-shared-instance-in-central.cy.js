...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411670 (CONSORTIA) Verify Item barcode hyperlink closing on Consortial holdings accordion details on shared Instance in Central Tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411670'] },
        () => {
