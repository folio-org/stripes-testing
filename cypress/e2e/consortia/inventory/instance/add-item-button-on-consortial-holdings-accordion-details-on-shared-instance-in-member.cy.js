...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411654 (CONSORTIA) Verify Add item button on Consortial holdings accordion details on shared Instance in Member Tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411654'] },
        () => {
