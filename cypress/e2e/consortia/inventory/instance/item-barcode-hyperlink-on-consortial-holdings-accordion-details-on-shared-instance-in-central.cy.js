...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411656 (CONSORTIA) Verify Item barcode hyperlink on Consortial holdings accordion details on shared Instance in Central Tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411656'] },
        () => {
