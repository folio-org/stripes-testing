...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C422086 (CONSORTIA) Verify the link in Data export app after exporting shared MARC Source Instance from Instance details pane on Central tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C422086'] },
        () => {
