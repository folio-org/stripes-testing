...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C409466 (CONSORTIA) Verify the "Move holdings/items to another instance" button on Central tenant Instance page (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C409466'] },
        () => {
