...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C446003 (CONSORTIA) Check "Set record for deletion" action for FOLIO Local Instance in Actions menu on Member tenant (promin)',
        { tags: ['extendedPathECS', 'promin', 'C446003'] },
        () => {
