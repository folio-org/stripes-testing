...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C411658 (CONSORTIA) Verify Item barcode hyperlink on Consortial holdings accordion details on shared Instance in Member Tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C411658'] },
        () => {
