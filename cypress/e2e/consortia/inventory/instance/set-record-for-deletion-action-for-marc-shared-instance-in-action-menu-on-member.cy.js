...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C446002 (CONSORTIA) Check "Set record for deletion" action for MARC Shared Instance in Actions menu on Member tenant (promin)',
        { tags: ['extendedPathECS', 'promin', 'C446002'] },
        () => {
