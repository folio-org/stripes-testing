...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C409475 (CONSORTIA) Verify the "Derive new MARC bibliographic record" button on Central tenant Instance page (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C409475'] },
        () => {
