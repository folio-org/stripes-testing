...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C436848 (CONSORTIA) Check "Set record for deletion" option in Actions menu for Local instance on Member tenant without permissions (promin)',
        { tags: ['extendedPathECS', 'promin', 'C436848'] },
        () => {
