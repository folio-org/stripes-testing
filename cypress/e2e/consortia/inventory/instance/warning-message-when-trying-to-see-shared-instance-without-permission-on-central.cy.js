...
describe('Inventory', () => {
  describe('Instance', () => {
    describe('Consortia', () => {
      ...
      it(
        'C422045 (CONSORTIA) Verify the warning message when trying to see shared instance without permission on Central tenant (consortia) (promin)',
        { tags: ['extendedPathECS', 'promin', 'C422045'] },
        () => {
