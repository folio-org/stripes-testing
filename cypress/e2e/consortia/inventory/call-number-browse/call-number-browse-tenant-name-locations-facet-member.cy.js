...
describe('Inventory', () => {
  describe('Call Number Browse', () => {
    describe('Consortia', () => {
      ...
      const instancePrefix = `AT_C784504_Instance_${randomPostfix}`;
      const callNumberPrefix = `AT_C784504_CallNumber_${randomPostfix}`;
      const locationPrefix = `AT_C784504_Location_${randomPostfix}`;
      ...
      before('Create user, data', () => {
        ...
        cy.createTempUser([Permissions.inventoryAll.gui])
          .then((userProperties) => {
            ...
            InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C784504');
      ...
      it(
        ...
        () => {
          ...
          function browseAndCheckLocations() {
            ...
            [...allVisibleCallNumbers.slice(0, 2), ...allVisibleCallNumbers.slice(3, 5)].forEach(
              (callNumberValue) => {
                BrowseCallNumber.checkValuePresentInResults(callNumberValue, false);
              },
            );
            BrowseCallNumber.checkValuePresentInResults(allVisibleCallNumbers[2]);
            BrowseCallNumber.checkValuePresentInResults(allVisibleCallNumbers[5]);
            ...
            [...allVisibleCallNumbers.slice(0, 3), ...allVisibleCallNumbers.slice(4)].forEach(
              (callNumberValue) => {
                BrowseCallNumber.checkValuePresentInResults(callNumberValue, false);
              },
            );
            ...
            [...allVisibleCallNumbers.slice(1, 4), allVisibleCallNumbers[5]].forEach(
              (callNumberValue) => {
                BrowseCallNumber.checkValuePresentInResults(callNumberValue, false);
              },
            );
            BrowseCallNumber.checkValuePresentInResults(allVisibleCallNumbers[0]);
            BrowseCallNumber.checkValuePresentInResults(allVisibleCallNumbers[4]);
