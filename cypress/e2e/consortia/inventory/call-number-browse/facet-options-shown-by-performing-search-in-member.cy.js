...
describe('Inventory', () => {
  describe('Call Number Browse', () => {
    ...
    it(
      'C414981 Facet options shown after clicking "Reset all" in Browse and performing search in Member tenant (consortia) (promin)',
      { tags: ['criticalPathECS', 'promin', 'C414981'] },
      () => {
