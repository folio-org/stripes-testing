...
describe('Inventory', () => {
  describe('Call Number Browse', () => {
    describe('Consortia', () => {
      ...
      const instancePrefix = `AT_C423631_Instance_${randomPostfix}`;
      const callNumberValue = `AT_C423631_CallNumber_${randomPostfix}`;
      ...
      before('Create user, data', () => {
        ...
        cy.createTempUser([Permissions.uiInventoryViewInstances.gui])
          .then((userProperties) => {
            ...
            InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C423631');
      ...
      it(
        'C423631 Locations from all existing tenants displays in "Effective location (item)" facet of browse pane in "Inventory" app opened from "Central" tenant (consortia) (spitfire)',
        { tags: ['extendedPathECS', 'spitfire', 'C423631'] },
        () => {
          const usedLocations = [
