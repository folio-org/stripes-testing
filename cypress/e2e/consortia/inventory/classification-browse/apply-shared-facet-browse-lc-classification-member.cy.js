...
describe('Inventory', () => {
  describe('Instance classification browse', () => {
    describe('Consortia', () => {
      ...
      const instancePrefix = `AT_C471472_MarcBibInstance_${randomPostfix}`;
      const classificationPrefix = `AT_C471472_Classification_${randomPostfix}`;
      ...
      before('Create user, data', () => {
        ...
        cy.createTempUser([Permissions.uiInventoryViewInstances.gui])
          .then((userProperties) => {
            user = userProperties;
            InventoryInstances.deleteInstanceByTitleViaApi('AT_C471472');
          })
          .then(() => {
            cy.resetTenant();
      ...
      it(
        ...
        () => {
          ...
          // Step 1: Select "Library of Congress classification", browse for shared classification
