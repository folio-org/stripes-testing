...
const instanceTitlePrefix = 'AT_C468272_Instance';
const classificationPrefix = 'C468272';
...
const localSharedTypeName = `AT_C468272_ClassifType_${randomPostfix}`;
...
const marcFiles = [
  {
    marc: 'marcBibFileC468272.mrc',
    fileNameImported: `testMarcFileC468272.${getRandomPostfix()}.mrc`,
...
describe('Inventory', () => {
  describe('Instance classification browse', () => {
    describe('Consortia', () => {
      ...
      it(
        'C468272 Classifications of each identifier type from Shared Instances could be found in the browse result list by "Classification (all)" option when settings are empty, from Central tenant (consortia) (spitfire)',
        { tags: ['criticalPathECS', 'spitfire', 'C468272'] },
        () => {
