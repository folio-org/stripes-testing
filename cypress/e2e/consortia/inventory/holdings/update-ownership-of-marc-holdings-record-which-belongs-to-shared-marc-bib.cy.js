  ...
  describe('Holdings', () => {
    describe('Consortia', () => {
      const testData = {
        ...
        fileNameForCreateInstance: `C1434623 autotestFile${getRandomPostfix()}.mrc`,
      };
      ...
      it(
        'C1434623 Update ownership of MARC holdings record which belongs to Shared MARC bib (consortia) (folijet)',
        { tags: ['criticalPathECS', 'folijet', 'C1434623'] },
        () => {
