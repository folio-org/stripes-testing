...
describe('Orders', () => {
  describe('Consortium (Orders)', () => {
    ...
    const testData = {
      ...
      order: { ...NewOrder.defaultOngoingTimeOrder },
      user: {},
    };
    let location;
    let servicePointId;
    ...
    it(
      'C423420: ECS | Receipt ongoing PO line status remains “Ongoing” after receiving in member tenant (consortia) (thunderjet)',
