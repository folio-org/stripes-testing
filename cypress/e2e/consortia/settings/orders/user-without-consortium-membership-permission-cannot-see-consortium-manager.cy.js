...
describe('Consortia', () => {
  describe('Settings', () => {
    ...
    it(
      'C380516 Users without "Settings (Consortia): Can manage consortium membership" permission can not see "Consortium manager" option in settings menu (ECS)',
      { tags: ['criticalPathECS', 'consortia', 'thunderjet', 'C380516'] },
      () => {
