  ...
  describe('MARC Authority', () => {
    describe('Settings', () => {
      describe('Consortia', () => {
        ...
        it(
          'C436922 Delete Local "Authority file" which doesn\'t have assigned "MARC authority" records from Central tenant (consortia) (promin)',
          { tags: ['extendedPathECS', 'promin', 'C436922'] },
          () => {
