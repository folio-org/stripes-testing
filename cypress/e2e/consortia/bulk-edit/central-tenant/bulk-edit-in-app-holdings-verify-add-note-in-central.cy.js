...
let centralSharedHoldingNoteType;
let localHoldingNoteType;
let localHoldingNoteTypeNameWithAffiliation;
let instances;
    ...
    describe(
      ...
      () => {
        beforeEach('create test data', () => {
          // Recreate dynamic values for each retry
          callNumberStarts = `${randomFourDigitNumber()}`;
          folioInstance = {
          ...
          localHoldingNoteType = {
            name: `C477646 college NoteType ${randomFourDigitNumber()}`,
          };
          localHoldingNoteTypeNameWithAffiliation = `${localHoldingNoteType.name} (${Affiliations.College})`;
