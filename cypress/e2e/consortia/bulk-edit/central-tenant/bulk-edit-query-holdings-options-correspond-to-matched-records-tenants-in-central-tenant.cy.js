    ...
    describe('Consortia', () => {
        ...
        cy.createTempUser(userPermissions).then((userProperties) => {
          ...
          HoldingsNoteTypesConsortiumManager.createViaApi(centralSharedHoldingNoteType)
            ...
            .then(() => {
              ...
              QueryModal.chooseFromValueMultiselect(Affiliations.College);
              QueryModal.chooseFromValueMultiselect(Affiliations.University);
      ...
      it(
        ...
        () => {
          ...
          QueryModal.chooseValueSelect(Affiliations.College);
