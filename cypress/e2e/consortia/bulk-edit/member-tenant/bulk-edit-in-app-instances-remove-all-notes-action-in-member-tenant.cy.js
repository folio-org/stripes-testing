...
let noteTypeId;
const folioInstance = {
  title: `AT_C566138_FolioInstance_${getRandomPostfix()}`,
};
const marcInstance = {
  title: `AT_C566138_MarcInstance_${getRandomPostfix()}`,
};
const notes = {
...
describe('Bulk-edit', () => {
  describe('Member tenant', () => {
    describe('Consortia', () => {
      ...
      it(
        'C566138 Verify "Remove all" action for Instances notes in Member tenant (consortia) (firebird)',
        { tags: ['criticalPathECS', 'firebird', 'C566138'] },
        () => {
