...
describe('Bulk-edit', () => {
  describe('Profiles', () => {
    describe('Consortia', () => {
      ...
      it(
        'C825312 Create Items bulk edit profile in Central tenant and use it to execute bulk edit job with errors (consortia) (athena)',
        { tags: ['extendedPathECS', 'athena', 'C825312'] },
        () => {
