  ...
  describe('Consortium manager', () => {
    describe('Manage local settings', () => {
      describe('Manage local Subject types', () => {
        ...
        let userB;
        const testData = {
          typeName: `AT_C594415_SubjectType_${getRandomPostfix()}`,
          editedTypeName: `AT_C594415_SubjectType_${getRandomPostfix()}_edited`,
        };
        ...
        after('Delete test data', () => {
          ...
          // Delete User A from College tenant where it was created (ECS rule)
          cy.setTenant(Affiliations.College);
        ...
        it(
          ...
          () => {
            ...
            // Step 3: Navigate to Subject types and verify permission error
            ...
            // Step 4: Create new subject type with permissions issue
            ...
            ConsortiaControlledVocabularyPaneset.verifyRecordIsNotInTheList(testData.typeName);
            ...
            // Step 12: Create new subject type successfully
            ConsortiaControlledVocabularyPaneset.clickNew();
            ConsortiaControlledVocabularyPaneset.verifyEditModeIsActive();
            ConsortiaControlledVocabularyPaneset.fillInTextField({ name: testData.typeName });
            ConsortiaControlledVocabularyPaneset.verifyShareCheckboxState({
            ...
            // Step 14: Edit central tenant subject type
            ...
            // Step 15: Clear name field
            ConsortiaControlledVocabularyPaneset.clearTextField(CONSTANTS.NAME_FIELD);

            // Step 16: Try to save with empty name
            ConsortiaControlledVocabularyPaneset.clickSave();
            ConsortiaControlledVocabularyPaneset.verifyFieldValidatorError({
            ...
            // Step 19: Delete subject type from University tenant
            ConsortiaControlledVocabularyPaneset.performActionFor(
              testData.typeName,
              tenantNames.university,
              actionIcons.trash,
            ...
            // Step 24: Switch to University tenant and verify deleted subject type NOT present
