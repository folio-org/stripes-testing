  ...
  describe('Consortium manager', () => {
    describe('Manage local settings', () => {
      describe('Manage local Subject types', () => {
        ...
        let userB;
        const testData = {
          typeName: `AT_C594414_SubjectType_${getRandomPostfix()}`,
        };
        ...
        after('Delete test data', () => {
          ...
          // Clean up any remaining subject types
        ...
        it(
          ...
          () => {
            ...
            // Step 11: Create new subject type successfully
            ConsortiaControlledVocabularyPaneset.clickNew();
            ConsortiaControlledVocabularyPaneset.verifyEditModeIsActive();
            ConsortiaControlledVocabularyPaneset.fillInTextField({ name: testData.typeName });
            ConsortiaControlledVocabularyPaneset.clickSave();
            ...
            // Step 15: Login as User B
            cy.login(userB.username, userB.password);

            // Step 16: Verify subject type in Central tenant Settings
            ...
            SubjectTypes.verifySubjectTypeExists({
              ...
              source: CONSTANTS.SOURCE_TYPE,
              user: userA.lastName,
              actions: [actionIcons.edit, actionIcons.trash],
            });

            // Step 17: Switch to College tenant and verify NOT present
            ...
            // Step 18: Switch to University tenant and verify present
