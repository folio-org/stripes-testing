  ...
  describe('Consortium manager', () => {
    describe('Manage local settings', () => {
      describe('Manage local Subject sources', () => {
        ...
        it(
          'C594436 User with "Consortium manager: Can share settings to all members" permission is able to manage local subject sources of selected affiliated tenants in "Consortium manager" app (consortia) (promin)',
          { tags: ['extendedPathECS', 'promin', 'C594436'] },
          () => {
