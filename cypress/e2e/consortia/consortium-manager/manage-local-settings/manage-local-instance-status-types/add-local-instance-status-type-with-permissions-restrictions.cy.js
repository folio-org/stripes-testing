  ...
  describe('Consortium manager', () => {
    describe('Manage local settings', () => {
      describe('Manage local Instance status types', () => {
        ...
        let userB;
        const testData = {
          statusTypeName: `AT_C411544_InstanceStatusType_${getRandomPostfix()}`,
          statusTypeCode: `AT_C411544_${getRandomPostfix()}`,
        };
        ...
        it(
          'C411544 Add local instance status type via "Consortium manager" app with permissions and affiliations restrictions (consortia) (thunderjet)',
          { tags: ['extendedPathECS', 'thunderjet', 'C411544'] },
          () => {
            ...
            // Step 12: Create new instance status type successfully
            ConsortiaControlledVocabularyPaneset.clickNew();
            ConsortiaControlledVocabularyPaneset.verifyEditModeIsActive();
            ConsortiaControlledVocabularyPaneset.fillInTextField({
              name: testData.statusTypeName,
            ...
            // Step 17: Verify instance status type in Central tenant Settings
