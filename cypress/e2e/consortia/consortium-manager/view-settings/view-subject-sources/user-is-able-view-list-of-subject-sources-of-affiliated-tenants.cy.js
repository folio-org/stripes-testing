    ...
    describe('Manage shared settings', () => {
      describe('Manage shared Subject types', () => {
        ...
        const sharedSubjectSource = {
          name: `C594423 autotestSubjectSourceName${getRandomPostfix()}`,
          source: 'consortium',
          memberLibraries: 'All',
          user: 'No set value-',
          id: uuid(),
        ...
        const localSubjectSourceOnCentral = {
          name: `C594423 autotestSubjectTypeName${getRandomPostfix()}`,
          source: 'local',
        ...
        it(
          'C594423 User with "Consortium manager: Can share settings to all members" permission is able to view the list of subject sources of affiliated tenants in "Consortium manager" app (consortia) (folijet)',
          { tags: ['criticalPathECS', 'folijet', 'C594423'] },
          () => {
