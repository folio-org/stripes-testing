...
describe('MARC -> MARC Authority -> Browse - Authority records', () => {
  ...
  it(
    ...
    () => {
      ...
      MarcAuthorityBrowse.searchBy(testData.personalNameSearchOption, 'Dugmore, Clifford William');
      MarcAuthorityBrowse.checkResultWithValue(testData.authorized, 'Dugmore, Clifford William');
