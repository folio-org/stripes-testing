    ...
    describe(
      ...
      () => {
        ...
        beforeEach('Creating data', () => {
          fileName = `C360521 testMarcFile.${getRandomPostfix()}.mrc`;
          cy.createTempUser([
        ...
        it(
          'C360521 Import of "MARC Authority" record with valid prefix in "010 $a" field only (promin)',
          { tags: ['smoke', 'authority', 'promin', 'shiftLeft', 'C360521'] },
          () => {
