...
describe('MARC', () => {
  describe('MARC Authority', () => {
    describe('Optimistic locking', () => {
      ...
      const naturalId = `353218${randomNDigitNumber(19)}`;

      const testData = {
        tag100: '100',
        authHeading: `AT_C353218_MarcAuthority_${randomPostfix}`,
        authHeadingUpdatedByA: `AT_C353218_MarcAuthority_${randomPostfix} Updated by A`,
        authHeadingUpdatedByB: `AT_C353218_MarcAuthority_${randomPostfix} Updated by B`,
      };
      ...
      before('Create test data via API', () => {
        cy.getAdminToken();
        MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C353218_');
      ...
      it(
        ...
        () => {
          ...
          cy.then(() => {
            ...
            // Step 12: User A clicks "Save & close" — triggers optimistic locking conflict
