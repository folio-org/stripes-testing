...
describe('MARC', () => {
  describe('MARC Authority', () => {
    describe('Edit linked Authority record', () => {
      ...
      it(
        'C422060 Q release | Add "010" field with valid prefix in "$a" subfield in linked "MARC authority" record when "001" field is controlling "$0" of MARC bib\'s field (promin) (TaaS)',
        { tags: ['extendedPath', 'promin', 'C422060'] },
        () => {
