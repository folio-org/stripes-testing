...
describe('MARC Authority -> Edit linked Authority record', () => {
  ...
  it(
    ...
    () => {
      ...
      QuickMarcEditor.updateExistingFieldContent(tag010.rowIndex, tag010.inputContent.field010_1);
      ...
      QuickMarcEditor.updateExistingFieldContent(tag010.rowIndex, tag010.inputContent.field010_2);
      QuickMarcEditor.checkButtonsEnabled();
      QuickMarcEditor.pressSaveAndKeepEditing(testData.calloutMessage);
      QuickMarcEditor.checkContent(tag010.expectedContent.field010_2, tag010.rowIndex);

      QuickMarcEditor.updateExistingFieldContent(tag010.rowIndex, tag010.inputContent.field010_3);
      ...
      QuickMarcEditor.updateExistingFieldContent(tag010.rowIndex, tag010.inputContent.field010_5);
      QuickMarcEditor.checkButtonsEnabled();
