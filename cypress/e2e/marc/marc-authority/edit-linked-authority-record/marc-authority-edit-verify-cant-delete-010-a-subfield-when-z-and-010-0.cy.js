...
describe('MARC', () => {
  describe('MARC Authority', () => {
    describe('Edit linked Authority record', () => {
      ...
      it(
        'C376600 Verify that user cant delete "$a" subfield from "010" field of linked "MARC Authority" record when "$z" is present and "010" = "$0" (promin) (TaaS)',
        { tags: ['extendedPath', 'promin', 'C376600'] },
        () => {
