...
describe('MARC', () => {
  describe('MARC Authority', () => {
    ...
    it(
      'C423379 Delete "Reference" "MARC authority" record that has one linked field in "MARC Bib" record from browse result list (promin) (TaaS)',
      { tags: ['extendedPathBroken', 'promin', 'C423379'] },
      () => {
