...
describe('MARC', () => {
  describe('MARC Authority', () => {
    ...
    it(
      'C365627 Search | Verify that the "Thesaurus" facet option will display the name of facet option when zero results are returned (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C365627'] },
      () => {
