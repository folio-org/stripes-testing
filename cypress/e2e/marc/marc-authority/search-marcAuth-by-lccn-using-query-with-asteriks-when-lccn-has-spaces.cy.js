...
describe('MARC', () => {
  describe('MARC Authority', () => {
    ...
    it(
      'C440112 Search for "MARC authority" by "LCCN" option using a query with asterisk when "LCCN" (010 $a) has (leading, internal, trailing) spaces". (promin)',
      { tags: ['criticalPath', 'promin', 'C440112'] },
      () => {
