...
describe('MARC', () => {
  describe('MARC Authority', () => {
    ...
    it(
      'C440101 Search for "MARC authority" by "LCCN" option using a query without spaces when "Canceled LCCN" (010 $z) has (leading, internal, trailing) spaces". (promin)',
      { tags: ['criticalPath', 'promin', 'C440101'] },
      () => {
