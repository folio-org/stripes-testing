  ...
  describe('MARC Authority', () => {
    describe('Create MARC Authority', () => {
      const testData = {
        ...
        marcValue: 'C692053 John Doe Sir, 1909-1965',
        tag010Value: 'n00692053',
        tag400Value: 'C692053 Huan Doe Senior, 1909-1965',
        tag500Value: 'C692053 La familia',
      ...
      const localAuthFile = {
        name: `C692053 auth source file active ${getRandomPostfix()}`,
      ...
      const newFields = [
        { previousFieldTag: '008', tag: '010', content: '$a n00692053' },
        {
          previousFieldTag: '010',
          tag: '100',
          content: '$a C692053 John Doe $c Sir, $d 1909-1965 $l eng',
        },
        {
          previousFieldTag: '100',
          tag: '400',
          content: '$a C692053 Huan Doe $c Senior, $d 1909-1965 $l eng',
        },
        { previousFieldTag: '400', tag: '500', content: '$a C692053 La familia' },
      ];
