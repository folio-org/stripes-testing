...
describe('MARC', () => {
  describe('MARC authority', () => {
    describe('Create', () => {
      ...
      it(
        'C423552 Change selection of authority file from "FOLIO" to "Local" and create a new MARC authority record (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'nonParallel', 'C423552'] },
        () => {
