...
describe('MARC', () => {
  describe('MARC authority', () => {
    describe('Create', () => {
      ...
      it(
        'C423542 Create a new MARC authority record with "FOLIO" authority file selected and without added "010" field (promin)',
        { tags: ['extendedPath', 'promin', 'nonParallel', 'C423542'] },
        () => {
