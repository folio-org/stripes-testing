...
describe('MARC', () => {
  describe('MARC authority', () => {
    describe('Create', () => {
      ...
      it(
        'C423551 Change selection of authority file from "FOLIO" to different "FOLIO" and create a new MARC authority record (promin)',
        { tags: ['extendedPath', 'promin', 'nonParallel', 'C423551'] },
        () => {
