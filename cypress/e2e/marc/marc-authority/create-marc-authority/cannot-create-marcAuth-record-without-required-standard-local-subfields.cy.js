...
describe('MARC', () => {
  describe('MARC authority', () => {
    describe('Create', () => {
      ...
      it(
        'C514935 Cannot create MARC authority record without required standard / local subfields in Standard and Local fields (spitfire)',
        { tags: ['criticalPath', 'spitfire', 'nonParallel', 'C514935'] },
        () => {
          cy.then(() => {
