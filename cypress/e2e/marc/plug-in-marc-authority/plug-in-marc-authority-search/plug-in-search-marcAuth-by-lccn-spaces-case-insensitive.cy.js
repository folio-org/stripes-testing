...
describe('MARC', () => {
  describe('plug-in MARC authority', () => {
    describe('plug-in MARC authority | Search', () => {
      const randomDigits = `440117${randomFourDigitNumber()}${randomFourDigitNumber()}`;
      ...
      const testData = {
        ...
        tag100: '100',
        tag245: '245',
        bibTitle: `AT_C440117_MarcBibInstance_${randomPostfix}`,
        bibTag100Content: `C440117 Contributor ${randomPostfix}`,
        user: {},
      ...
      const lccnTestData = [
        {
          heading: `AT_C440117_MarcAuthority 1 ${randomPostfix}`,
          lccn: `n ${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 2 ${randomPostfix}`,
          lccn: `n  ${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 3 ${randomPostfix}`,
          lccn: ` n${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 4 ${randomPostfix}`,
          lccn: `  n${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 5 ${randomPostfix}`,
          lccn: `  n  ${randomDigits}  `,
        },
        {
          heading: `AT_C440117_MarcAuthority 6 ${randomPostfix}`,
          lccn: `n${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 7 ${randomPostfix}`,
          lccn: `N ${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 8  ${randomPostfix}`,
          lccn: `N  ${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 9 ${randomPostfix}`,
          lccn: ` N${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 10 ${randomPostfix}`,
          lccn: `  N${randomDigits}`,
        },
        {
          heading: `AT_C440117_MarcAuthority 11 ${randomPostfix}`,
          lccn: `  N  ${randomDigits}  `,
        },
        {
          heading: `AT_C440117_MarcAuthority 12 ${randomPostfix}`,
          lccn: `N${randomDigits}`,
        },
      ];
      ...
      before('Create test data and login', () => {
        cy.getAdminToken();
        MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C440117_MarcAuthority');
      ...
      it(
        'C440117 MARC Authority plug-in | Search by "LCCN" option using a query with lower, UPPER case when "LCCN" (010 $a) has (leading, internal, trailing) spaces. (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C440117'] },
        () => {
