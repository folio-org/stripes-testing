...
describe('MARC', () => {
  describe('plug-in MARC authority', () => {
    describe('plug-in MARC authority | Search', () => {
      ...
      it(
        'C440116 MARC Authority plug-in | Search by "LCCN" option using a query with asterisk when "LCCN" (010 $a) has (leading, internal, trailing) spaces. (promin)',
        { tags: ['criticalPath', 'promin', 'C440116'] },
        () => {
