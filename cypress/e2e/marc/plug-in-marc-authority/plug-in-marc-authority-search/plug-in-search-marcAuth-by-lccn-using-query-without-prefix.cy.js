...
describe('MARC', () => {
  describe('plug-in MARC authority', () => {
    describe('plug-in MARC authority | Search', () => {
      ...
      it(
        'C440115 MARC Authority plug-in | Search by "LCCN" option using a query without prefix (numbers only) when "LCCN" (010 $a) has (leading, internal, trailing) spaces. (promin)',
        { tags: ['criticalPath', 'promin', 'C440115'] },
        () => {
