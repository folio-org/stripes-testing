...
describe('MARC', () => {
  describe('plug-in MARC authority', () => {
    describe('plug-in MARC authority | Browse', () => {
      ...
      it(
        'C385657 "$a", "$d", "$t" subfield values are shown in correct order in pre-populated browse query when linking "MARC bib" record (promin) (TaaS)',
        { tags: ['extendedPath', 'promin', 'C385657'] },
        () => {
