    ...
    describe('Edit MARC bib', () => {
      describe('Manual linking', () => {
        ...
        before('Creating user and data', () => {
          ...
          MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('C380457*');
        ...
        it(
          'C380457 Verify that user cant link "630" MARC Bib field with wrong record (promin) (TaaS)',
          { tags: ['extendedPath', 'promin', 'C380457'] },
          () => {
