...
describe('MARC -> MARC Bibliographic -> Edit MARC bib -> Manual linking', () => {
  ...
  const testData = {
    ...
    instanceTitle:
      'C365599 Crossfire : a litany for survival : poems 1998-2019 / Staceyann Chin ; foreword by Jacqueline Woodson.',
    linked100Field: [
      11,
      '100',
      '1',
    ...
    bib100AfterUnlinking: [
      ...
      '1',
      '\\',
      '$a C365599 Chin, Staceyann, $d 1972- $e Author $e Narrator $0 id.loc.gov/authorities/names/n2008052404 $1 http://viaf.org/viaf/24074052',
    ],
