  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Manual linking', () => {
        ...
        const instanceTitle = `AT_C380399_MarcBibInstance_${randomPostfix}`;
        const updatedInstanceTitle = `${instanceTitle} upd`;
        const authorityHeadingSubA = `AT_C380399_MarcAuthority_${randomPostfix},`;
        ...
        const marcBibFields = [
          ...
          {
            tag: testData.tag600,
            content: `$a ${authorityHeadingSubA} $d ${authorityHeadingSubD}. $i 600 field $e Author $v Form Sub $x general $y 1923 $z Berlin $1 not valid URI $2 fast $4 with 600 field $5 1924 $6 linkage test + hotkey $0 http://id.worldcat.org/fast/fst00073986222`,
            indicators: ['1', '7'],
          },
        ];
        ...
        it(
          ...
          () => {
            function verifyShortcuts() {
              ...
              QuickMarcEditor.verifyCursorPositionInBoxOfLinkedField(
                testData.tag600RowIndex,
                5,
                16,
              );

              InventoryKeyboardShortcuts.pressHotKey(
                InventoryHotkeys.hotKeys.moveToPreviousSubfield,
              );
