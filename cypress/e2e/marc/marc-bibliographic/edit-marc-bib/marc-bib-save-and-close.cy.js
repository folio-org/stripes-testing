  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      const testData = {
        ...
        instanceTitle1: 'nstance • Edited [Sound Recording] / Cypress Automation',
        tag245value2: '$a Edited Twice $h [Sound Recording] / $c Cypress Automation',
        instanceTitle2: 'nstance • Edited Twice [Sound Recording] / Cypress Automation',
      ...
      it(
        'C360097 Verify updates are saved after clicking "Save & keep editing" button in "MARC Bibliographic" edit mode (Promin) (TaaS)',
        { tags: ['criticalPathFlaky', 'promin', 'C360097'] },
        () => {
