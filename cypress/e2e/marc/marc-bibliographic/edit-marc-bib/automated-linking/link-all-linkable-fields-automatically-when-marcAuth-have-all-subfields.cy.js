  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Automated linking', () => {
        ...
        it(
          'C740247 Link all linkable fields automatically when MARC authority 1XXs have all subfields and different subfields selected as linkable in config (spitfire)',
