  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Automated linking', () => {
        ...
        it(
          'C388515 Click on "Link headings" button when edit "MARC bib" >> unlink some fields >> click on "Link headings" button again (promin) (TaaS)',
          { tags: ['extendedPath', 'promin', 'C388515'] },
          () => {
