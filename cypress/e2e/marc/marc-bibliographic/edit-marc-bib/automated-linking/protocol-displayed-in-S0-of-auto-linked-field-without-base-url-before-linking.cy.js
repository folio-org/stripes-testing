  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Automated linking', () => {
        ...
        it(
          'C436814 Protocol is displayed in subfield "$0" of automatically linked field when field has no base URL before linking (promin)',
          { tags: ['criticalPath', 'promin', 'C436814'] },
          () => {
