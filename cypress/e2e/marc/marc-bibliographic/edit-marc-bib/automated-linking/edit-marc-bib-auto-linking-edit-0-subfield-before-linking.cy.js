  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Automated linking', () => {
        ...
        it(
          'C388537 Edit subfield "$0" in the unlinked fields before clicking on "Link headings" button when edit "MARC bib" (promin) (TaaS)',
          { tags: ['criticalPathFlaky', 'promin', 'C388537'] },
          () => {
