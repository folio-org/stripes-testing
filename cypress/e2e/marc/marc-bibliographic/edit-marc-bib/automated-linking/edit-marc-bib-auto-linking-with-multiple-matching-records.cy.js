  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      describe('Automated linking', () => {
        ...
        it(
          'C389476 Auto-linking fields when multiple valid for linking "MARC authority" records match "$0" when editing "MARC Bib" record (promin) (TaaS)',
          { tags: ['extendedPath', 'promin', 'C389476'] },
          () => {
