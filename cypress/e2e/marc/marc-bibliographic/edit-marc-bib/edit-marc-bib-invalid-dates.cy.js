...
describe('MARC', () => {
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      ...
      const datesData = [
        { date1: '1999u', date2: '20b27', errors: [] },
        {
          date1: '1',
          date2: '9',
          errors: [testData.dateLengthError(1), testData.dateLengthError(2)],
        },
        { date1: '12', date2: '199u', errors: [testData.dateLengthError(1)] },
        { date1: '12b', date2: '199u', errors: [testData.dateLengthError(1)] },
        { date1: '12b6', date2: '19', errors: [testData.dateLengthError(2)] },
        { date1: '12b6', date2: '199', errors: [testData.dateLengthError(2)] },
        { date1: '12b6', date2: '199u', errors: [] },
      ];
      const createdRecordIDs = [];
      let user;

      function checkDateFields(date1, date2) {
        QuickMarcEditor.verify008TextFields(INVENTORY_008_FIELD_DROPDOWNS_BOXES_NAMES.DATE1, date1);
        QuickMarcEditor.verify008TextFields(INVENTORY_008_FIELD_DROPDOWNS_BOXES_NAMES.DATE2, date2);
      }

      function fillDateFields(date1, date2) {
        QuickMarcEditor.update008TextFields(INVENTORY_008_FIELD_DROPDOWNS_BOXES_NAMES.DATE1, date1);
        QuickMarcEditor.update008TextFields(INVENTORY_008_FIELD_DROPDOWNS_BOXES_NAMES.DATE2, date2);
