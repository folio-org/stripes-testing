  ...
  describe('MARC Bibliographic', () => {
    describe('Edit MARC bib', () => {
      ...
      const testData = {
        ...
        instanceTitlePrefix: `AT_C476807_MarcBibInstance_${randomPostfix}`,
        tag008: '008',
        tag010: '010',
        tag245: '245',
        lccnNumbers: [
      ...
      before(() => {
        cy.getAdminToken();
        InventoryInstances.deleteInstanceByTitleViaApi('AT_C476807_MarcBibInstance');
        cy.createTempUser([
      ...
      it(
        ...
        () => {
          ...
          searchData.forEach((search, index) => {
            goToEditBib(search.fieldContent);
          ...
          goToEditBib(searchData[1].fieldContent);
          QuickMarcEditor.updateLDR06And07Positions();
          QuickMarcEditor.pressSaveAndClose();
          QuickMarcEditor.checkAfterSaveAndClose();
          InventoryInstance.checkInstanceTitle(`${testData.instanceTitlePrefix} Test`);
        },
      );
    });
  });
