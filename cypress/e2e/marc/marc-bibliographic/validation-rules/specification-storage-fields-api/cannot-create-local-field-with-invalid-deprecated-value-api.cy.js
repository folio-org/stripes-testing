...
describe('MARC Bibliographic Validation Rules - Cannot Create Local Field with Invalid Deprecated Value API', () => {
  ...
  it(
    'C490934 Cannot create Local Field with invalid value in "deprecated" field for MARC bib spec (API) (spitfire)',
    { tags: ['C490934', 'extendedPath', 'spitfire'] },
    () => {
      // Ensure token is set for the user before API calls
      cy.getUserToken(user.username, user.password);

      // Test scenarios for deprecated field validation
      const deprecatedValidationScenarios = [
        {
          description: 'Deprecated field with unrecognized token "test" (should fail)',
          deprecated: 'test',
          expectedStatus: 400,
      ...
      // Test each deprecated field validation scenario
      deprecatedValidationScenarios.forEach((scenario) => {
        const payload = {
          ...baseFieldPayload,
