...
describe('MARC', () => {
  describe('MARC Bibliographic', () => {
    describe('Optimistic locking', () => {
      ...
      const testData = {
        instanceTitleOriginal: `AT_C353225_MarcBibInstance_${randomPostfix}`,
        instanceTitleUpdatedByA: `AT_C353225_MarcBibInstance_${randomPostfix} Updated by A`,
        instanceTitleUpdatedByB: `AT_C353225_MarcBibInstance_${randomPostfix} Updated by B`,
      };
      ...
      before('Create users, data', () => {
        cy.getAdminToken();
        InventoryInstances.deleteInstanceByTitleViaApi('C353225_');
      ...
      it(
        ...
        () => {
          ...
          // Steps 3-4: While User A has the record open, User B updates the record via API
