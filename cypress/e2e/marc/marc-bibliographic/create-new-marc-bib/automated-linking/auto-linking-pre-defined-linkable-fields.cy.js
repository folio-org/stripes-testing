...
describe('MARC -> MARC Bibliographic -> Create new MARC bib -> Automated linking', () => {
  ...
  const newFields = [
    { rowIndex: 6, tag: '100', content: '$a Coates, Ta-Nehisi,$e author. $0 n2008001084C389489' },
    { rowIndex: 7, tag: '110', content: '$aBlack Panther (MG) $0 no2006108277C389489' },
    { rowIndex: 8, tag: '111', content: '$aPimedate Ööde Filmifestival $0 no2009176429C389489' },
    { rowIndex: 9, tag: '130', content: '$a Marvel comics $0 n80026980C389489' },
    { rowIndex: 10, tag: '240', content: '$a Black Panther $0 no2020024230C389489' },
    { rowIndex: 11, tag: '610', content: '$a Black Panther $0 nb2009024488C389489' },
    { rowIndex: 12, tag: '611', content: '$aPanther Photographic $0n 82216757C389489' },
    {
      rowIndex: 13,
      tag: '630',
      content: '$a Black Panther (test: will not be linked) $0 no2023006999C389489',
    },
    { rowIndex: 14, tag: '650', content: '$aGood and evil.$2fast $0 sh2009125989C389489' },
    { rowIndex: 15, tag: '651', content: '$aAfrica.$2fast $0 sh 85001531C389489' },
    { rowIndex: 16, tag: '655', content: '$aComics (Graphic works)$2fast $0 gf2014026266C389489' },
    {
      rowIndex: 17,
      tag: '700',
      content:
    ...
    { rowIndex: 19, tag: '710', content: '$a Harry (test: will not be linked) $0 tst0014C389489' },
    { rowIndex: 20, tag: '710', content: '$aRobinson $0 no2008081921C389489' },
    { rowIndex: 21, tag: '711', content: '$a Delaware $0 n84745425C389489' },
    { rowIndex: 22, tag: '730', content: '$a Gone T $0 n79066095C389489' },
    { rowIndex: 23, tag: '800', content: '$a Neilson, Donald $0 n79023811C389489' },
    {
      rowIndex: 24,
      tag: '811',
      content: '$aStockholm International Film Festival $0 no2018125587C389489',
    },
    { rowIndex: 25, tag: '830', content: '$aBlack Panther $0 no2018018754C389489' },
    // { rowIndex: 26, tag: '810', content: ' $a Black Panther Party $0 n80095585C389489' },
  ];
  ...
  it(
    ...
    () => {
      ...
      // Add new eligible for linking fields, by clicking "+" icon next to any field and filling first and fourth box of appeared row with following values
      ...
      newFields.forEach((field) => {
        QuickMarcEditor.verifyUnlinkAndViewAuthorityButtons(field.rowIndex + 1);
      });
      QuickMarcEditor.checkCallout(
        'Field 100, 110, 111, 130, 240, 630, 700, 710, 711, 730, 800, 811, and 830 has been linked to MARC authority record(s).',
      );
      QuickMarcEditor.checkCallout(
      ...
      BrowseContributors.checkAuthorityIconAndValueDisplayed('Lee, Stan, 1922-2018');
