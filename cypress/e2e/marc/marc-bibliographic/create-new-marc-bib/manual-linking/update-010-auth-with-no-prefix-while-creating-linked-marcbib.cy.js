  ...
  describe('MARC Bibliographic', () => {
    describe('Create new MARC bib', () => {
      describe('Manual linking', () => {
        ...
        // Authority 001 uses a valid LC Names prefix so the base URL resolves correctly
        const authorityPrefix = 'n';
        const authorityNaturalId = `422136${randomDigits}`;
        ...
        const testData = {
          ...
          tag010: '010',
          tag245: '245',
          bibTitle: `AT_C422136_MarcBibInstance_${randomPostfix}`,
          authorityField100Content: `$a AT_C422136_MarcAuthority_${randomPostfix} $b II, $c Queen of Great Britain, $d 1926-`,
          // 010 $a without valid prefix (just digits) - this is what the test starts with
          ...
          // Expected $0 in bib after authority 010 $a is updated
        ...
        before('Create test data', () => {
          cy.getAdminToken();
          MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C422136');
        ...
        it(
          'C422136 Update "010" value without valid prefix in "MARC authority" record while "MARC Bib" record being created and linked (NOT saved link; "$0" = "001" with valid prefix) (spitfire)',
          { tags: ['extendedPath', 'spitfire', 'C422136'] },
          () => {
            ...
            // Step 5: Add 100 field with $0 = authority 001 value
            MarcAuthority.addNewField(4, testData.tag100, `$0 ${authority001Value}`);
            ...
            // Step 7: Verify linked 100 field - $0 contains the 001 value (with valid prefix)
            QuickMarcEditor.verifyTagFieldAfterLinkingByTag(
              ...
              '',
              `$0 ${sourceUrlPrefix}${authority001Value}`,
              '',
            );
            ...
            cy.getMarcRecordDataViaAPI(testData.authorityId).then((marcData) => {
              ...
              cy.updateMarcRecordDataViaAPI(marcData.parsedRecordId, marcData).then(
                ({ status }) => {
                  ...
                  // Step 13: View source and verify $0 updated to new 010 $a value
