  ...
  describe('MARC Bibliographic', () => {
    describe('Create new MARC bib', () => {
      describe('Manual linking', () => {
        ...
        const authorityNaturalId = `422137${randomDigits}`;
        ...
        const testData = {
          ...
          tag245: '245',
          tag600: '600',
          bibTitle: `AT_C422137_MarcBibInstance_${randomPostfix}`,
          authorityField100Content: `$a AT_C422137_MarcAuthority_${randomPostfix} $b II, $c Queen of Great Britain, $d 1926-`,
          // 010 $a without valid prefix (just digits)
          initial010Value: `$a ${randomDigits}`,
          // 010 $a with valid prefix added - this is what the authority gets updated to
          updated010Value: `$a n${randomDigits}`,
          // Expected $0 in bib after authority 010 $a is updated to include valid prefix
          expected$0AfterUpdate: `${sourceUrlPrefix}n${randomDigits}`,
        };
        ...
        before('Create test data', () => {
          cy.getAdminToken();
          MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('C422137');

          // Authority 001 has no valid prefix - pass empty string as prefix
        ...
        it(
          'C422137 Update "010" value without valid prefix in "MARC authority" record while "MARC Bib" record being created and linked (NOT saved link; "$0" = "001" without valid prefix) (spitfire)',
          { tags: ['extendedPath', 'spitfire', 'C422137'] },
          () => {
            ...
            // Step 5: Add 600 field with $0 = authority 001 value (no valid prefix, no URL)
            MarcAuthority.addNewField(4, testData.tag600, `$0 ${authority001Value}`);

            // Step 6: Click link icon on 600 field
            QuickMarcEditor.clickLinkIconInTagFieldByTag(testData.tag600);
            ...
            // Step 7: Verify linked 600 field - $0 contains the raw 001 value (no URL since no valid prefix)
            ...
            // Steps 8-11 (Authority tab - via API): update 010 $a to add valid prefix
            cy.getMarcRecordDataViaAPI(testData.authorityId).then((marcData) => {
              ...
              cy.updateMarcRecordDataViaAPI(marcData.parsedRecordId, marcData).then(
                ({ status }) => {
                  ...
                  // Step 13: View source and verify $0 updated to new 010 $a URL value
