  ...
  describe('MARC Bibliographic', () => {
    describe('Derive MARC bib', () => {
      ...
      const testData = {
        ...
        authorityHeading: `AT_C375117_MarcAuthority_${randomPostfix}`,
        bibTitle: `AT_C375117_MarcBibInstance_${randomPostfix}`,
        messages: {
      ...
      before('Create user and test data', () => {
        cy.getAdminToken();
        MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('AT_C375117_MarcAuthority');
