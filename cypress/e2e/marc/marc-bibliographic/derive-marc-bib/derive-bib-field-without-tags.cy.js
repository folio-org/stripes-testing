...
describe('MARC', () => {
  describe('MARC Bibliographic', () => {
    describe('Derive MARC bib', () => {
      const testData = {
        title: `AT_C423482_MarcBibInstance_${getRandomPostfix()}`,
        userProperties: {},
        tagLDR: 'LDR',
        tag001: '001',
        tag005: '005',
      ...
      // Expected field states after each edit operation based on TestRail C423482 steps
      ...
      after('Delete test data', () => {
        ...
        InventoryInstances.deleteInstanceByTitleViaApi('AT_C423482_MarcBibInstance');
      });
      ...
      it(
        ...
        () => {
          ...
          // Step 11: Open derived record for edit
