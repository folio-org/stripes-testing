  ...
  describe('MARC Bibliographic', () => {
    describe('Derive MARC bib', () => {
      describe('Manual linking', () => {
        ...
        it(
          'C417049 Derive | Verify that derived MARC bib with linked field by user without "Edit" permissions can be opened (promin)',
          { tags: ['criticalPathFlaky', 'promin', 'C417049'] },
          () => {
