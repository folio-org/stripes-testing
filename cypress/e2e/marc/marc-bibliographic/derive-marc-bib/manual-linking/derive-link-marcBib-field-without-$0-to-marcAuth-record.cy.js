...
describe('MARC -> MARC Bibliographic -> Derive MARC bib -> Manual linking', () => {
  ...
  it(
    ...
    () => {
      ...
      DataImport.verifyUploadState();
      DataImport.uploadFile(testData.marcAuthFile.editedFileName, testData.marcAuthFile.fileName);
      ...
      InventoryInstance.verifyContributor(1, 1, `${testData.marcAuthIcon}${testData.marcValue}`);
