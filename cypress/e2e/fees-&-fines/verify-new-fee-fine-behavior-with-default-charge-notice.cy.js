...
describe('Verify "New fee/fine" behavior when fee/fine owner has default charge notice set', () => {
  let userData = {};
  let servicePoint;
  let feeFineOwner;
  let ownerData;
  ...
  it(
    'C5561 Verify "New fee/fine" behavior when fee/fine owner has default charge notice set (vega)',
    { tags: ['extendedPath', 'vega', 'C5561'] },
    () => {
