...
describe('Fees&Fines', () => {
  describe('Refund fee/fine with default notice', () => {
    const testData = {
    ...
    before('Create test data', () => {
      ...
      const patronNoticeTemplate = {
        ...
        active: true,
        name: `DefaultActionNoticeTemplate_${getRandomPostfix()}`,
        description: 'Default action notice template for C15194',
        localizedTemplates: {
          en: {
      ...
      NoticeTemplates.createViaApi(patronNoticeTemplate).then(() => {
        ...
        const ownerBody = {
          ...
          defaultActionNoticeId: testData.patronNoticeTemplate.id,
        };
    ...
    it(
      'C15194 Verify "Refund fee/fine" behavior when fee/fine owner has default action notice set (vega)',
      { tags: ['extendedPath', 'vega', 'C15194'] },
      () => {
        ...
        // Open fees/fines and navigate to closed fees
        ...
        // Verify default action notice is present
        ...
        // Keep notification checked and add additional info
        ...
        // Submit refund and wait for API completion
