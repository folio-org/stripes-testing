...
describe('MARC -> MARC Authority', () => {
  ...
  it('C369084 Delete authorized "MARC Authority" record that has two linked field in different "MARC Bib" records (spitfire)', { tags: [TestTypes.criticalPath, DevTeams.spitfire] }, () => {
    ...
    MarcAuthoritiesDelete.checkDeleteModalMessage(`Are you sure you want to permanently delete the authority record:  ${testData.marcValue} ? If you proceed with deletion, then 2 linked bibliographic records will retain authorized value and will become uncontrolled.`)
