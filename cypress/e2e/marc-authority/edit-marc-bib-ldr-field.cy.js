...
describe('MARC -> MARC Bibliographic -> Edit MARC bib', () => {
  ...
  const changesForLDR = [
    ...
    {
      position6: ['c', 'c', 'c', 'c', 'c', 'c', 'c', 'd', 'd', 'd', 'd', 'd', 'd', 'd', 'i', 'i', 'i', 'i', 'i', 'i', 'i', 'j', 'j', 'j', 'j', 'j', 'j', 'j'],
      position7: ['a', 'b', 'c', 'd', 'i', 'm', 's', 'a', 'b', 'c', 'd', 'i', 'm', 's', 'a', 'b', 'c', 'd', 'i', 'm', 's', 'a', 'b', 'c', 'd', 'i', 'm', 's'],
    ...
    {
      position6: ['g', 'g', 'g', 'g', 'g', 'g', 'g', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'r', 'r', 'r', 'r', 'r', 'r', 'r'],
      position7: ['a', 'b', 'c', 'd', 'i', 'm', 's', 'a', 'b', 'c', 'd', 'i', 'm', 's', 'a', 'b', 'c', 'd', 'i', 'm', 's'],
