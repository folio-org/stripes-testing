...
describe('MARC Authority -> Reporting | MARC authority', () => {
  ...
  it('C375231 "MARC authority headings updates (CSV)" report includes correct number of linked "MARC bib" records (spitfire)', { tags: [TestTypes.smoke, DevTeams.spitfire] }, () => {
    const dataForC375231 = [
      {
          ...
          tagValue: '240',
          marcValue: 'Beethoven, Ludwig van, 1770-1827. Variations, piano, violin, cello, op. 44, E♭ major',
      },
      {
    ...
    cy.wait(2000)
    QuickMarcEditor.updateExistingField('100', '$a Beethoven, Ludwig Jr, $d 1770-1827. $t Variations, $m piano, violin, cello, $n op. 44, $r E♭ major');
