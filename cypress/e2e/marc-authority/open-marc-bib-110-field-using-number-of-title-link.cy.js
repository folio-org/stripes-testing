...
describe('MARC -> MARC Authority', () => {
  ...
  it('C375261 "Number of titles" link in "MARC authority" app opens linked "MARC bib" record with controlled "110" field (spitfire)', { tags: [TestTypes.criticalPath, DevTeams.spitfire] }, () => {
