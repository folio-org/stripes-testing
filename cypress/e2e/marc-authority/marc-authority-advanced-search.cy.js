...
describe('MARC Authority - Advanced Search', () => {
  ...
  it('C350607 Advanced search of MARC authority records (spitfire)', { tags: [TestTypes.criticalPath, DevTeams.spitfire] }, () => {
    MarcAuthorities.clickAdvancedSearchButton();
    MarcAuthorities.checkAdvancedSearchModalFields(0, testData.titles.titleDefault, testData.searchOptions.keyword);
    MarcAuthorities.fillAdvancedSearchField(0, testData.titles.titlePersonalName, testData.searchOptions.personalName);
    ...
    MarcAuthorities.clickSearchButton();
    MarcAuthorities.checkResultList([testData.titles.titleCorporateName, testData.titles.titlePersonalName, testData.titles.titleUniform]);
    MarcAuthorities.checkSearchInput(`personalNameTitle==${testData.titles.titlePersonalName} or corporateNameTitle==${testData.titles.titleCorporateName} or uniformTitle==${testData.titles.titleUniform}`);
    
    MarcAuthorities.clickAdvancedSearchButton();
    MarcAuthorities.checkAdvancedSearchModalFields(0, testData.titles.titlePersonalName, testData.searchOptions.personalName);
    MarcAuthorities.checkAdvancedSearchModalFields(1, testData.titles.titleCorporateName, testData.searchOptions.corporateName, testData.booleanOptions.or);
    MarcAuthorities.checkAdvancedSearchModalFields(2, testData.titles.titleUniform, testData.searchOptions.uniformTitle, testData.booleanOptions.or);
    MarcAuthorities.clickCancelButton();
    MarcAuthorities.checkAdvancedSearchModalAbsence();
    MarcAuthorities.checkResultList([testData.titles.titleCorporateName, testData.titles.titlePersonalName, testData.titles.titleUniform]);
    MarcAuthorities.checkSearchInput(`personalNameTitle==${testData.titles.titlePersonalName} or corporateNameTitle==${testData.titles.titleCorporateName} or uniformTitle==${testData.titles.titleUniform}`);
    
    MarcAuthorities.searchBy('Advanced search', `personalNameTitle==${testData.titles.titlePersonalName} or corporateNameTitle==${testData.titles.titleCorporateName}`);
    MarcAuthorities.clickAdvancedSearchButton();
    MarcAuthorities.checkAdvancedSearchModalFields(0, testData.titles.titlePersonalName, testData.searchOptions.personalName);
    MarcAuthorities.checkAdvancedSearchModalFields(1, testData.titles.titleCorporateName, testData.searchOptions.corporateName, testData.booleanOptions.or);
    MarcAuthorities.checkAdvancedSearchModalFields(2, testData.titles.titleDefault, testData.searchOptions.keyword, testData.booleanOptions.and);
    MarcAuthorities.fillAdvancedSearchField(2, testData.titles.titleUniform, testData.searchOptions.uniformTitle, testData.booleanOptions.or);
    MarcAuthorities.checkAdvancedSearchOption(2);
    MarcAuthorities.clickSearchButton();
    MarcAuthorities.checkSearchInput(`personalNameTitle==${testData.titles.titlePersonalName} or corporateNameTitle==${testData.titles.titleCorporateName} or uniformTitle==${testData.titles.titleUniform}`);
