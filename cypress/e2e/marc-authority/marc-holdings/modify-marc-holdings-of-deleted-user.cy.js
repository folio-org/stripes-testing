...
describe('MARC -> MARC Authority', () => {
  const testData = {
    calloutMessage: 'This record has successfully saved and is in process. Changes may not appear immediately.',
  }
  ...
  it('C358996 Verify that user has access to "quickMARC" when user who imported "MARC holdings" record has been deleted (spitfire)', { tags: [TestTypes.criticalPath, DevTeams.spitfire] }, () => {
    ...
    QuickMarcEditor.fillAllAvailableValues(undefined, undefined, HoldingsRecordView.newHolding.rowsCountInQuickMarcEditor);
