...
const holdingsData = {
  ...
  electronicAccess: {
    ...
    urlPublicNote: 'Public Note',
  },
};
const marcBibFile = {
  marc: 'marcBibFileForC375987.mrc',
  fileNameImported: `testMarcBibFileC375987.${getRandomPostfix()}.mrc`,
...
describe('OAI-PMH', () => {
  describe('List identifiers', () => {
    ...
    it(
      'C375987 ListIdentifiers: Verify MARC instances suppressed from discovery settings (marc21_withholdings) (firebird)',
      { tags: ['extendedPathFlaky', 'firebird', 'C375987', 'nonParallel'] },
      () => {
        ...
        // Step 8-9: Add holdings to the instance
        InstanceRecordView.addHoldings();
        InventoryNewHoldings.fillPermanentLocation(locationName);
        HoldingsRecordEdit.selectTemporaryLocation(locationName);
        InventoryNewHoldings.fillCallNumber(holdingsData.callNumber);
        ...
        HoldingsRecordEdit.addElectronicAccessFields({
          ...
          uri: holdingsData.electronicAccess.uri,
          linkText: holdingsData.electronicAccess.linkText,
          materialsSpecified: holdingsData.electronicAccess.materialsSpecified,
          urlPublicNote: holdingsData.electronicAccess.urlPublicNote,
        });
        ...
        // Step 13: Change setting to "Skip suppressed from discovery records"
