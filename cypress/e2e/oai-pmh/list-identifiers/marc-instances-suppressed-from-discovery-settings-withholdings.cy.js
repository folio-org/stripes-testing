...
describe('OAI-PMH', () => {
  describe('List identifiers', () => {
    ...
    it(
      'C375987 ListIdentifiers: Verify MARC instances suppressed from discovery settings (marc21_withholdings) (athena)',
      { tags: ['extendedPath', 'athena', 'C375987', 'nonParallel'] },
      () => {
