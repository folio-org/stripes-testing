...
const firstFolioInstance = { title: `AT_C411630_FirstFolioInstance_${getRandomPostfix()}` };
const secondFolioInstance = { title: `AT_C411630_SecondFolioInstance_${getRandomPostfix()}` };
const testData = {};
  ...
  describe('Get records', () => {
    ...
    it(
      ...
      () => {
        ...
        // Step 3-4: Send GetRecord request for second instance and verify
        OaiPmh.getRecordRequest(secondFolioInstance.id, 'marc21_withholdings').then((response) => {
