...
describe('OAI-PMH', () => {
  describe('Get records', () => {
    ...
    it(
      'C385658 GetRecord: Inventory - Verify that Item fields are properly included in "952" field of response (subfields "i", "j", "k", "l", "m", "n", "p") (athena)',
      { tags: ['extendedPath', 'athena', 'C385658', 'nonParallel'] },
      () => {
