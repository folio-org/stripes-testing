...
describe('OAI-PMH', () => {
  describe('Get records', () => {
    ...
    it(
      'C375186 GetRecord: Verify MARC instances suppressed from discovery in case Skip suppressed from discovery records (athena)',
      { tags: ['extendedPath', 'athena', 'C375186', 'nonParallel'] },
      () => {
