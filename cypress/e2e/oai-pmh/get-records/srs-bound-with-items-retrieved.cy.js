...
const firstMarcInstance = { title: `AT_C411640_FirstMarcInstance_${getRandomPostfix()}` };
const secondMarcInstance = { title: `AT_C411640_SecondMarcInstance_${getRandomPostfix()}` };
const testData = {};
  ...
  describe('Get records', () => {
    ...
    it(
      ...
      () => {
        ...
        OaiPmh.getRecordRequest(secondMarcInstance.id, 'marc21_withholdings').then((response) => {
