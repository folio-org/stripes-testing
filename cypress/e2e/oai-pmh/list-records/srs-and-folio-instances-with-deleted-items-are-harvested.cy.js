...
describe('OAI-PMH', () => {
  describe('List records', () => {
    ...
    it(
      'C375983 ListRecords: SRS & Inventory - Verify that deleted SRS and FOLIO Items are harvested (marc21_withholdings) (athena)',
      { tags: ['extendedPath', 'athena', 'C375983', 'nonParallel'] },
      () => {
