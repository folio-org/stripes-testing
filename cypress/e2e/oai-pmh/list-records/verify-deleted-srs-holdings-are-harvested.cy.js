  ...
  describe(
    ...
    () => {
      beforeEach('create test data', () => {
        marcInstance = { title: `AT_C375952_MarcInstance_${getRandomPostfix()}` };
        cy.getAdminToken();
      ...
      it(
        'C375952 ListRecords: Verify that deleted SRS HOLDINGS are harvested (athena)',
        { tags: ['extendedPath', 'athena', 'C375952'] },
        () => {
          ...
          InventoryInstance.waitLoading();
          cy.wait(2000); // Waiting to ensure that deletion is processed
          ...
          cy.getAdminToken();
          OaiPmh.listRecordsRequest('marc21_withholdings', dateAndTimeOfDeletion).then(
            (response) => {
