...
describe('Data Export', () => {
  describe('Authority records export', () => {
    const testData = {
      authorityUUIDsFileName: `AT_C1322631_authorityUUIDs_${getRandomPostfix()}.csv`,
    };
    ...
    it(
      'C1322631 Export failed when using ".csv" file with non-existent UUIDs (spitfire)',
      { tags: ['extendedPath', 'spitfire', 'C1322631'] },
      () => {
