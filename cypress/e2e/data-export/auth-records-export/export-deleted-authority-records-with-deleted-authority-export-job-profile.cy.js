...
const authorityUUIDsFileName = `AT_C446013_authorityUUIDs_${getRandomPostfix()}.csv`;
const recordsCount = 1;
const authFile = {
  sourceName: `AT_C446013_AuthoritySourceFile_${getRandomPostfix()}`,
  prefix: getRandomLetters(8),
  startWithNumber: '1',
  hridStartsWith: '',
};
const authorityInstance = {
  title: `AT_C446013_MarcAuthority_${getRandomPostfix()}`,
};
