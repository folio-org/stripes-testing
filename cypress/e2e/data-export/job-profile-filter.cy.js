  ...
  describe(
    ...
    () => {
      beforeEach('create test data', () => {
        ...
        mappingProfileName = `AT_C411724_MappingProfile_${randomPostfix}`;
        jobProfileName = `AT_C411724_JobProfile_${randomPostfix} export job profile`;
        folioInstanceTitle = `AT_C411724_FolioInstance_${randomPostfix}`;
        csvFileName = `AT_C411724_instance_${randomPostfix}.csv`;
      ...
      afterEach('delete test data', () => {
        cy.getAdminToken();
        ExportJobProfiles.getJobProfile({ query: `"name"=="${jobProfileName}"` }).then(
          (response) => {
