...
const csvFileName = `AT_C350412_instanceUUIDs_${getRandomPostfix()}.csv`;
const identifierConfig = [
  { name: 'DOI', value: 'DOI_10.1000/182', subfieldValue: 'doi' },
  { name: 'Handle', value: 'Handle_hdl:123456789/987', subfieldValue: 'hdl' },
  { name: 'URN', value: 'URN_urn:nbn:de:101:1-201604119876', subfieldValue: 'urn' },
];
const testData = {
  instanceTitle: `AT_C350412_FolioInstance_${getRandomPostfix()}`,
  instanceId: '',
...
describe('Data Export', () => {
  describe('Generating MARC records on the fly', () => {
    ...
    it(
      'C350412 Verify appending subfields to Identifiers (DOI, Handle, URN) (firebird)',
      { tags: ['extendedPath', 'firebird', 'C350412'] },
      () => {
          ...
          const assertionsOnMarcFileContent = [
            {
              ...
              assertions: [
                (record) => {
                  ...
                  expect(identifierFields.length).to.eq(3);
                  ...
                  identifierConfig.forEach(({ value, subfieldValue }) => {
                    verifyIdentifierMapping(subfieldValue, value, subfieldValue);
                  });
                },
              ],
            },
