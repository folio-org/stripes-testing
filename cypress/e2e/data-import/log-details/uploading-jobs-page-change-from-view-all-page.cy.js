...
describe('Data Import', () => {
  describe('Log details', () => {
    ...
    it(
      'C357019 Check that no error when going to the "Uploading jobs" and "Settings/Job profiles" pages from the "View All" page (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C357019'] },
      () => {
