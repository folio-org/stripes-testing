...
describe('Data Import', () => {
  describe('Log details', () => {
    ...
    const collectionOfMappingAndActionProfiles = [
      {
        mappingProfile: {
          ...
          name: `C389502 Test multiple holdings.${getRandomPostfix()}`,
      ...
      },
      {
        mappingProfile: {
          ...
          name: `C389502 Test multiple items.${getRandomPostfix()}`,
          materialType: '945$a',
    ...
    const jobProfile = {
      ...
      profileName: `C389502 Test multiple items.${getRandomPostfix()}`,
