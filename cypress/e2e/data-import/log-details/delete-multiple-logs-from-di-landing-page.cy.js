...
describe('Data Import', () => {
  describe('Log details', () => {
    ...
    it(
      'C356825 The "select all" button does not select all logs after deleting multiple logs from the DI landing page (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C356825'] },
      () => {
