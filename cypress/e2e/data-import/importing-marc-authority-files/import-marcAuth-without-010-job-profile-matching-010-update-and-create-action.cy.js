...
describe('Data Import', () => {
  describe('Importing MARC Authority files', () => {
    ...
    it(
      'C422067 Import "MARC authority" record without "010" field using job profile with MATCH by "010" field for update and with create action (promin)',
      { tags: ['smoke', 'promin', 'C422067'] },
      () => {
