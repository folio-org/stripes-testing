  ...
  describe('Importing MARC Authority files', () => {
    ...
    it(
      ...
      () => {
        ...
        const todayDate1 = moment(new Date()).format('YYYYMMDD');
        const todayDate2 = moment(new Date()).format('YYYYMMDD');
        const todayDate3 = moment(new Date()).format('YYYYMMDD');
        console.log(todayDate1);
        const changedDate1 = `${todayDate1}${randomTwoDigitNumber()}`;
        const changedDate2 = `${todayDate2}${randomTwoDigitNumber()}`;
        const changedDate3 = `${todayDate3}${randomTwoDigitNumber()}`;
        DataImport.editMarcFile(
          testData.marcFile.exportedFileName,
          testData.marcFile.modifiedFileName,
          [todayDate1, todayDate2, todayDate3],
          [changedDate1, changedDate2, changedDate3],
        );
        cy.pause();
        ...
        [
          ...
          [0, 1, 2, 3, 4, 5, 6].forEach((rowNumber) => {
            FileDetails.checkStatusInColumn(RECORD_STATUSES.NO_ACTION, columnName, rowNumber);
          });
          FileDetails.checkStatusInColumn(RECORD_STATUSES.UPDATED, columnName, 7);
        });
