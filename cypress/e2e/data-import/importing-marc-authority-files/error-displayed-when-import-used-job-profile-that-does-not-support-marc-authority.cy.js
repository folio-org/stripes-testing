...
describe('Data Import', () => {
  describe('Importing MARC Authority files', () => {
    ...
    it(
      'C359246 Checking the error displayed when the import used a "Job Profile" that does not support the "MARC Authority" record (promin)',
      { tags: ['extendedPath', 'promin', 'C359246'] },
      () => {
