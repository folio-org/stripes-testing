...
describe('data-import', () => {
  describe('Importing MARC Bib files', () => {
    ...
    const firstInstanceTitle = 'Competing with idiots : Herman and Joe Mankiewicz, a dual portrait / Nick Davis.';
    const secondInstaneTitle = 'Letters from a Stoic : The Ancient Classic  / Seneca, with a introduction of Donald Robertson.';
