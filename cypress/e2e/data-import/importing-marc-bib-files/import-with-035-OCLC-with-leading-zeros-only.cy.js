...
describe('Data Import', () => {
  describe('Importing MARC Bib files', () => {
    let userId;
    let instanceHrid;
    const field035a = '(OCoLC)501056183';
    const filePathForUpload = 'marcBibFileForC466254.mrc';
    const marcFileName = `C466254 autotestFile${getRandomPostfix()}.mrc`;
    ...
    it(
      'C466254 Import of file with 035 OCLC field with leading zeros only (folijet)',
      { tags: ['edgeCases', 'folijet', 'C466254'] },
      () => {
