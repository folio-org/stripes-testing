...
describe('Data Import', () => {
  describe('Importing MARC Bib files', () => {
    ...
    let instanceHrid;
    const testData = {
      filePath: 'marcBibFileForC844845.mrc',
      marcFileName: `C844845 marcFile${getRandomPostfix()}.mrc`,
    };
    ...
    it(
      ...
      () => {
        ...
        InstanceRecordView.verifyInstanceFormat('projected image', 'other', 'mz', 'rdacarrier');
      },
    );
  });
});
