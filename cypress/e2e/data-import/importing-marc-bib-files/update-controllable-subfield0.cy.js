...
describe('data-import', () => {
  describe('Importing MARC Bib files', () => {
    ...
    it('C385665 Update controllable subfield, "$0" in one of the linked repeatable fields (multiple repeatable fields with same indicators) (spitfire)',
      { tags: [TestTypes.criticalPath, DevTeams.spitfire] }, () => {
        ...
        InventoryInstances.selectInstance();
        InventoryInstance.editMarcBibliographicRecord();
        QuickMarcEditor.verifyTagFieldAfterLinking(75, '700', '1', '\\', '$a Chin, Staceyann C385665', '$e letterer.', '$0 id.loc.gov/authorities/names/n2008052404', '');
