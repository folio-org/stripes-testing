...
describe('ui-data-import', () => {
  ...
  it('C401727 Verify that 3 successive update actions for Holdings proceed without errors (folijet)',
    { tags: [TestTypes.criticalPath, DevTeams.folijet] }, () => {
      ...
      // HoldingsRecordView.checkCallNumberType(collectionOfMappingAndActionProfilesForUpdate[1].mappingProfile.callNumberType);
      // HoldingsRecordView.checkCallNumberPrefix(collectionOfMappingAndActionProfilesForUpdate[1].mappingProfile.callNumberPrefix);
      // HoldingsRecordView.checkCallNumber(collectionOfMappingAndActionProfilesForUpdate[1].mappingProfile.callNumber);
      // HoldingsRecordView.checkCallNumberSuffix(collectionOfMappingAndActionProfilesForUpdate[1].mappingProfile.callNumberSuffix);
