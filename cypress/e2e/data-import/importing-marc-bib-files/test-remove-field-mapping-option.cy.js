    ...
    const collectionOfMappingAndActionProfilesForCreate = [
      ...
      },
      {
        mappingProfile: {
          ...
          permanentLocationUI: LOCATION_NAMES.PRIMARY_FICTION_UI,
          permanentLocationInHoldingsAccordion: `${LOCATION_NAMES.PRIMARY_FICTION_UI} >`,
          temporaryLocation: `"${LOCATION_NAMES.SECONDARY_FICTION}"`,
          temporaryLocationUI: LOCATION_NAMES.SECONDARY_FICTION_UI,
