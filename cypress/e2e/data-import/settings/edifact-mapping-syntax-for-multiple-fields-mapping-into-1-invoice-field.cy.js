...
describe('data-import', () => {
  describe('Settings', () => {
    ...
    const collectionOfProfiles = [
      {
        mappingProfile: { incomingRecordType: NewFieldMappingProfile.incomingRecordType.edifact,
        ...
        actionProfile: { typeValue: FOLIO_RECORD_TYPE.INVOICE,
      ...
      },
      {
        ...
        actionProfile: { typeValue: FOLIO_RECORD_TYPE.INVOICE,
          name: `C345353 Test Harrassowitz invoice with hyphen.${getRandomPostfix()}` },
        jobProfile: { ...NewJobProfile.defaultJobProfile,
    ...
    it('C345353 Check EDIFACT mapping syntax for multiple fields mapping into 1 invoice field (folijet)',
      { tags: [TestTypes.criticalPath, DevTeams.folijet] }, () => {
        // create Field mapping profiles
        FieldMappingProfiles.waitLoading();
        FieldMappingProfiles.createInvoiceMappingProfile(collectionOfProfiles[0].mappingProfile, profileForDuplicate);
        FieldMappingProfiles.checkMappingProfilePresented(collectionOfProfiles[0].mappingProfile.name);

        FieldMappingProfiles.createInvoiceMappingProfile(collectionOfProfiles[1].mappingProfile, collectionOfProfiles[0].mappingProfile.name);
