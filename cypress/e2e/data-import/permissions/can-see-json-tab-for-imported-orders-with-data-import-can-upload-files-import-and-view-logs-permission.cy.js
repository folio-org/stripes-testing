...
describe('Data Import', () => {
  describe('Permissions', () => {
    ...
    it(
      'C377023 A user can see JSON tab for imported Orders with "Data import: Can upload files, import, and view logs" permission (promin)',
      { tags: ['extendedPath', 'promin', 'C377023'] },
      () => {
