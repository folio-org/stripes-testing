...
describe('Data Import', () => {
  describe('Permissions', () => {
    ...
    it(
      'C377031 A user can view Acquisition Methods in Order field mapping with "Settings (Data import): Can view, create, edit, and remove" (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C377031'] },
      () => {
