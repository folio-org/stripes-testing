...
describe('ui-orders: Orders', () => {
  ...
  it('C368478 Editing fund distribution in PO line when related Cancelled from approved invoice exists (thunderjet)', { tags: [testType.criticalPath, devTeams.thunderjet] }, () => {
