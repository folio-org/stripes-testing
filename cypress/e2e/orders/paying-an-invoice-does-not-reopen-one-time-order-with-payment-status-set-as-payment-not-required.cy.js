...
describe('Orders', () => {
  ...
  it(
    'C566491 Paying an invoice does not reopen one-time order with "Payment status" set as "Payment not required" (thunderjet)',
    { tags: ['extendedPath', 'thunderjet', 'C566491'] },
    () => {
