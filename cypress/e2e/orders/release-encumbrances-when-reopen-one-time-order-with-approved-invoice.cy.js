...
describe('Orders', () => {
                ...
                .then((acquisitionMethod) => {
                  return createOrderWithLine(
                    ...
                    return createInvoiceForOrder().then(() => {
                      return cancelOrder(testData.order);
                    });
                  });
                });
            });
  ...
  it(
    'C358538 Release encumbrances when reopen unreceived one-time order with related approved invoice (Release encumbrance = true) (thunderjet)',
    { tags: ['criticalPath', 'thunderjet', 'C358538'] },
    () => {
      ...
      OrderLines.checkPOLReceiptStatus('Awaiting Receipt');
