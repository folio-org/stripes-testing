...
describe('Orders', () => {
    ...
    return Orders.createOrderViaApi(order).then((orderResponse) => {
      ...
      const orderLine = {
        ...
        fundDistribution: [
          ...
          {
            code: testData.funds.second.code,
  ...
  it(
    'C357546 Encumbrance transaction updates when fund name is changing several times in Open ongoing order (thunderjet)',
    { tags: ['criticalPath', 'thunderjet', 'C357546', 'shiftLeft'] },
    () => {
      Orders.selectOrderByPONumber(testData.order.poNumber);
      OrderDetails.checkOrderStatus(ORDER_STATUSES.OPEN);
      OrderDetails.openPolDetails(testData.orderLine.titleOrPackage);
      OrderLineDetails.openOrderLineEditForm();
      orderLines.changeFundInPOLWithoutSaveInPercents(0, testData.funds.first, '50');
      orderLines.deleteFundInPOLwithoutSave(1);
      ...
      OrderLineDetails.openEncumbrancePane(testData.funds.first.name);
      TransactionDetails.checkTransactionDetails({
        information: [
          ...
          { key: 'From', value: `${testData.funds.first.name} (${testData.funds.first.code})` },
      ...
      Funds.waitLoading();
      FinanceHelp.searchByName(testData.funds.second.name);
      Funds.selectFund(testData.funds.second.name);
      ...
      OrderLineDetails.openOrderLineEditForm();
      orderLines.changeFundInPOLWithoutSaveInPercents(0, testData.funds.first, '45');
      orderLines.addFundToPOLWithoutSave(1, testData.funds.second, '10');
      orderLines.saveOrderLine();
      OrderLineDetails.checkFundDistibutionTableContent([
        {
          name: testData.funds.first.name,
          ...
          value: '45',
          amount: '$45.00',
          initialEncumbrance: '$45.00',
          currentEncumbrance: '$45.00',
        },
        {
      ...
      TransactionDetails.checkTransactionDetails({
        information: [
          { key: 'Fiscal year', value: testData.fiscalYear.code },
          { key: 'Amount', value: '($45.00)' },
          { key: 'Source', value: `${testData.order.poNumber}-1` },
          { key: 'Type', value: 'Encumbrance' },
          { key: 'From', value: `${testData.funds.first.name} (${testData.funds.first.code})` },
          { key: 'Expense class', value: testData.expenseClass.name },
          { key: 'Initial encumbrance', value: '$45.00' },
          { key: 'Status', value: 'Unreleased' },
        ],
      });
      TopMenuNavigation.navigateToApp(APPLICATION_NAMES.ORDERS);
      ...
      TransactionDetails.checkTransactionDetails({
        information: [
          ...
          { key: 'Initial encumbrance', value: '$5.00' },
          { key: 'Status', value: 'Unreleased' },
        ],
      });
    },
