...
describe('Orders', () => {
  describe('Order lines', () => {
        ...
        .then((order) => {
          ...
          return OrderLines.createOrderLineViaApi(
            BasicOrderLine.getDefaultOrderLine({
              ...
              title: `AT_C375102_OrderLine_${getRandomPostfix()}`,
    ...
    it(
      'C375102 Encumbrances are rolled over correctly when order fund distribution was changed and related paid invoice exists (based on Initial encumbrance) (thunderjet)',
      { tags: ['extendedPath', 'thunderjet', 'C375102', 'nonParallel'] },
      () => {
        ...
        // Steps 9-12: Check "<mm_dd_yyyy>-result.csv" file content for both funds
          ...
          funds: [
            {
              ...
              columns: {
                [EXPORT_BUDGET_FIELDS.BUDGET_ENCUMBERED]: 0,
                [EXPORT_BUDGET_FIELDS.UNAVAILABLE]: 0,
                [EXPORT_BUDGET_FIELDS.AVAILABLE]: 1000,
              },
            },
            {
              name: testData.fundB.name,
              columns: {
                [EXPORT_BUDGET_FIELDS.BUDGET_ENCUMBERED]: polTotalAmount,
                [EXPORT_BUDGET_FIELDS.UNAVAILABLE]: polTotalAmount,
                [EXPORT_BUDGET_FIELDS.AVAILABLE]: 1000 - polTotalAmount,
              },
            },
          ],
        });

        // Steps 13-14: Open rollover form and fill in the same rollover settings
        ...
        // Steps 20-21: Check "Fund B" planned budget
        FinanceHelper.selectLedgersNavigation();
        Ledgers.searchByName(testData.ledger.name);
