...
describe('Orders', () => {
              ...
              return cy
                ...
                .then((acquisitionMethod) => {
                  return createOrderWithLine(
                    ...
                    return receivePiece(testData.orderLine.id).then(() => {
  ...
  it(
    'C358537 Release encumbrances when reopen received one-time order with related paid invoice (Release encumbrance = true) (thunderjet)',
    { tags: ['criticalPath', 'thunderjet', 'C358537'] },
    () => {
