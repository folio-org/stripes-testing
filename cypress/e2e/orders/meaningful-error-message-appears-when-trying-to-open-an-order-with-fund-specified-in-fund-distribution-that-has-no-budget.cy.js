...
describe('Orders', () => {
  ...
  it(
    'C569590 Meaningful error message appears when trying to open an order with fund specified in "Fund distribution" that has NO budget (thunderjet)',
    { tags: ['criticalPath', 'thunderjet', 'C569590'] },
    () => {
