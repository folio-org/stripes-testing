...
describe('Orders', () => {
  ...
  it(
    'C402382 Holdings records creation when open order with "P/E mix" format PO line and Independent workflow, "Create inventory" in "E-resources details" = Instance, holdings, item (thunderjet) (TaaS)',
    { tags: ['criticalPath', 'thunderjet', 'C402382'] },
    () => {
      // Open Order
