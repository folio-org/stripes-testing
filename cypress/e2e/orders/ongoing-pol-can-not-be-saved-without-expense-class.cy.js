...
describe('Orders', () => {
  ...
  it(
    'C402774 PO line for "Ongoing" order can not be saved when "Expense class" field is empty (thunderjet)',
    ...
    () => {
      ...
      OrderLineEditForm.fillOrderLineFields({
        itemDetails: { title: `AT_C402774_Instance_${getRandomPostfix()}` },
        poLineDetails: {
      ...
      OrderLineEditForm.fillOrderLineFields({
        locationDetails: [{ quantityElectronic: '1' }],
      });
