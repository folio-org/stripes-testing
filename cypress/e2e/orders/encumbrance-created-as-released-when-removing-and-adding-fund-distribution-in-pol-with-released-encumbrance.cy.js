...
describe('Orders', () => {
  ...
  const createInvoiceForOrder = () => {
    return cy.getBatchGroups().then((batchGroup) => {
      return Invoices.createInvoiceWithInvoiceLineViaApi({
        ...
        fiscalYearId: testData.fiscalYears.fiscalYear1.id,
  ...
  it(
    'C594366 Encumbrance created as released when editing fund distribution (remove existing and add new) in POL with related released encumbrance (thunderjet)',
    { tags: ['criticalPath', 'thunderjet', 'C594366'] },
    () => {
      ...
      OrderLines.addFundToPOLWithoutSave(0, testData.funds.fundB, '100');
      ...
      TransactionDetails.checkTransactionDetails({
        information: [
          { key: 'Fiscal year', value: testData.fiscalYears.fiscalYear2.code },
