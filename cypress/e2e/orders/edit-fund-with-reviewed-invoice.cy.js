...
describe('ui-orders: Orders', () => {
  ...
  it('C374190 Editing fund distribution in PO line when related Open invoice exists (thunderjet)', { tags: [testType.criticalPath, devTeams.thunderjet] }, () => {
    ...
    Funds.selectBudgetDetails();
    Funds.viewTransactions();
    Funds.checkPaymentInTransactionDetails(1, defaultFiscalYear.code, invoice.invoiceNumber, `${secondFund.name} (${secondFund.code})`, '($70.00)');
    Funds.checkStatusInTransactionDetails('Unreleased');
  });
});
