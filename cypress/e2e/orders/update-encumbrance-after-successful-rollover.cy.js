...
describe('Orders', () => {
  ...
  it(
    'C409478 Update encumbrance after successful rollover (thunderjet)',
    { tags: ['extendedPath', 'thunderjet', 'C409478'] },
    () => {
      ...
      OrderLines.viewPO();
      cy.intercept('POST', `/orders/composite-orders/${testData.order.id}/re-encumber`).as(
        'reEncumber',
      );
