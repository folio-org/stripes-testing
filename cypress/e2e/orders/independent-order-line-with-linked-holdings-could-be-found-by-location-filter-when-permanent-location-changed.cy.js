...
describe('Orders', () => {
  ...
  before('Create test data', () => {
    ...
    // Precondition 1: Open Order with one independent PO Line linked to the Holdings
    cy.then(() => {
    ...
    // Precondition 1: Add one piece to POL title with the same location
    cy.then(() => {
  ...
  it(
    'C580280 Independent order line with linked Holdings could be found by "Location" filtering facet when permanent location was changed in "Inventory" app (thunderjet)',
    { tags: ['criticalPath', 'thunderjet', 'C580280'] },
    () => {
