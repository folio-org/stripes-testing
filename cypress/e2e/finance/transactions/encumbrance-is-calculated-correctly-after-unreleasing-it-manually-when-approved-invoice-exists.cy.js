...
describe('Finance', () => {
  describe('Transactions', () => {
    ...
    it(
      'C1045390 Encumbrance is calculated correctly after unreleasing it manually when an approved invoice exists (release encumbrance = true) (thunderjet)',
      { tags: ['criticalPath', 'thunderjet', 'C1045390'] },
      () => {
        ...
        TransactionDetails.checkTransactionDetails({
          information: [
            ...
            { key: TRANSACTION_DETAIL_FIELDS.AWAITING_PAYMENT, value: '$3.00' },
