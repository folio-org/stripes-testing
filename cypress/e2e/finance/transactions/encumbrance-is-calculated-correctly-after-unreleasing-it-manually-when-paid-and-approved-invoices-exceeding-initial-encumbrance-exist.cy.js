...
describe('Finance', () => {
  describe('Transactions', () => {
    ...
    it(
      'C1045395 Encumbrance is calculated correctly after unreleasing it manually when a paid and approved invoices exceeding initial encumbrance exist (release encumbrance = true) (thunderjet)',
      { tags: ['extendedPath', 'thunderjet', 'C1045395'] },
      () => {
        ...
        TransactionDetails.checkTransactionDetails({
          information: [
            ...
            { key: TRANSACTION_DETAIL_FIELDS.AWAITING_PAYMENT, value: '$7.00' },
            { key: TRANSACTION_DETAIL_FIELDS.EXPENDED, value: '$8.00' },
        ...
        InvoiceLineDetails.checkFundDistibutionTableContent([
          { name: testData.fund.name, currentEncumbrance: '$3.00' },
        ]);
        InvoiceLineDetails.openEncumbrancePane();
        TransactionDetails.checkTransactionDetails({
          information: [
            { key: TRANSACTION_DETAIL_FIELDS.FISCAL_YEAR, value: testData.fiscalYear.code },
            { key: TRANSACTION_DETAIL_FIELDS.AMOUNT, value: '($3.00)' },
            { key: TRANSACTION_DETAIL_FIELDS.SOURCE, value: testData.orderLine.poLineNumber },
            { key: TRANSACTION_DETAIL_FIELDS.TYPE, value: TRANSACTION_TYPES.ENCUMBRANCE },
            { key: TRANSACTION_DETAIL_FIELDS.FROM, value: testData.fund.name },
            { key: TRANSACTION_DETAIL_FIELDS.INITIAL_ENCUMBRANCE, value: '$10.00' },
