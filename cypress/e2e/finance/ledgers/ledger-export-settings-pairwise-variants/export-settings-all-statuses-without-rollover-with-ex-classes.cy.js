...
import { Budgets, Ledgers } from '../../../../support/fragments/finance';
...
describe('Finance: Ledgers', () => {
  ...
  it(
    ...
    () => {
      ...
      Ledgers.prepareExportSettings(testData.fiscalYear.code, 'All', testData.ledger);
