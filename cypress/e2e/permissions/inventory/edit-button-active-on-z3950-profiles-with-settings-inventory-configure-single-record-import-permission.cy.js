...
describe('Permissions', () => {
  describe('Permissions --> Inventory', () => {
    ...
    it(
      'C494347 Check that "Edit" button active on Z39.50 profiles with "Settings (Inventory): Configure single-record import" permission (promin)',
      { tags: ['criticalPath', 'promin', 'C494347'] },
      () => {
