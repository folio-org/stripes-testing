...
describe("servicepoints shift", () => {
  ...
  it("C590 Check in: multipiece items", () => {
    ...
    cy.visit(topMenu.checkInPath);
    cy.cancelCheckInMultipleItem(testData.itemB);
    cy.checkIn(testData.itemB);
    ...
    cy.visit(topMenu.checkInPath);
    cy.checkInMultipleItem(testData.itemB);
    cy.checkIn(testData.itemC);
    ...
    cy.visit(topMenu.checkInPath);
    cy.checkInMultipleItem(testData.itemC);
    cy.checkIn(testData.itemD);
    ...
    cy.visit(topMenu.checkInPath);
    cy.checkInMultipleItem(testData.itemD);
  });
});
