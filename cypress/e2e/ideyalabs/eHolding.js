...
import radioButton from '../../../interactors/radio-button';
...
export default {
  ...
  generateRandomDates() {
    const startDate = new Date(dateTools.getCurrentDate()); // Use your desired start date
    const endDate = new Date(dateTools.getWeekDate()); // Use your desired end date
