...
describe('Orders: Export in edifact format ', () => {
  ...
  it('C365619 Re-exported Order contains more than two PO lines is successfully exported in the next scheduled run (Thunderjet)', { tags: [testTypes.ideaLabsTests] }, () => {
