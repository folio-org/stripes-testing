...
describe('Users', () => {
  describe('Profile pictures', () => {
    ...
    it(
      'C442795 Verify that profile picture and associated update options display appropriately with Users: Can view, edit, and delete profile pictures (vega)',
      { tags: ['smoke', 'vega', 'C442795'] },
      () => {
