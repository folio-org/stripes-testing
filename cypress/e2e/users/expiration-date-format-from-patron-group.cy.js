...
describe('Users', () => {
  ...
  it(
    'C503010 C503011 Time format of "Expiration date" field in Users app is correct when derived from patron group expiration date (new user created) (vega)',
    { tags: ['extendedPath', 'vega', 'C503010', 'C503011'] },
    () => {
