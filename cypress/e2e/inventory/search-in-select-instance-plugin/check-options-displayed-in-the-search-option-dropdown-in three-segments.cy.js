...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    ...
    it(
      'C703362 Find Instance plugin | Check what options displayed in the search option dropdown in three segments: Instance, Holdings, Item (spitfire)',
      { tags: ['criticalPath', 'spitfire', 'C703362'] },
      () => {
