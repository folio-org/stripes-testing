...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C476834_FolioInstance_${randomPostfix}`;
      const statisticalCodeAccordionName = 'Statistical code';
      const organization = NewOrganization.getDefaultOrganization();
      organization.name = `AT_C476834_Org_${randomPostfix}`;
      ...
      before('Create users, data', () => {
        ...
        cy.then(() => {
          InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C476834');
