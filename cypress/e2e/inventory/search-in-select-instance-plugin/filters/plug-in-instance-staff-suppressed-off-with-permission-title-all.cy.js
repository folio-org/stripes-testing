...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C446103_Instance_${randomPostfix}`;
      const organization = NewOrganization.getDefaultOrganization();
      organization.name = `AT_C446103_Org_${randomPostfix}`;
      const titleAllSearchOption = 'Title (all)';
      ...
      before('Create users, data', () => {
        ...
        cy.then(() => {
          InventoryInstances.deleteInstanceByTitleViaApi('AT_C446103');
          ...
          .then(() => {
            cy.createTempUser([
              ...
              SelectInstanceModal.chooseSearchOption(titleAllSearchOption);
              SelectInstanceModal.checkSearchOptionSelected(titleAllSearchOption);
            });
          });
      });
      ...
      it(
        'C446103 Find Instance plugin | Staff suppress facet is off by default when user has permission to use facet (search by "Title (all)") (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C446103'] },
        () => {
