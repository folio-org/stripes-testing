...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C446106_Instance_${randomPostfix}`;
      const identifierValue = `AT_C446106_Identifier_${randomPostfix}`;
      const organization = NewOrganization.getDefaultOrganization();
      organization.name = `AT_C446106_Org_${randomPostfix}`;
      const identifierSearchOption = 'ISSN';
      ...
      before('Create users, data', () => {
        ...
        cy.then(() => {
          InventoryInstances.deleteInstanceByTitleViaApi('AT_C446106');
