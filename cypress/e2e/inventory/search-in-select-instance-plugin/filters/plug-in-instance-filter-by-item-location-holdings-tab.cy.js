...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C476776_Instance_${randomPostfix}`;
      ...
      before('Create users, data', () => {
        ...
        cy.then(() => {
          InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C476776');
      ...
      it(
        'C476776 "Select Instance" plugin | Filter "Instance" records by "Effective location (item)" facet in "Holdings" tab (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C476776'] },
        () => {
