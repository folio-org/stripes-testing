...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C476816_FolioInstance_${randomPostfix}`;
        ...
        () => {
          ...
          cy.then(() => {
            ...
            cy.wait('@getInstances1', { timeout: 10_000 }).then((instances1) => {
              ...
              // InventorySearchAndFilter.verifyNumberOfSearchResults(instances1.response.body.totalRecords);
            });
          })
            .then(() => {
              ...
              cy.wait('@getInstances2', { timeout: 10_000 }).then((instances2) => {
                ...
                // InventorySearchAndFilter.verifyNumberOfSearchResults(instances2.response.body.totalRecords);
              });
            })
            .then(() => {
              ...
              cy.wait('@getInstances3', { timeout: 10_000 }).then((instances3) => {
                ...
                // InventorySearchAndFilter.verifyNumberOfSearchResults(instances3.response.body.totalRecords);
              });
            })
            .then(() => {
