...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C446102_Instance_${randomPostfix}`;
      const contributorValue = `AT_C446102_Contributor_${randomPostfix}`;
      const organization = NewOrganization.getDefaultOrganization();
      organization.name = `AT_C446102_Org_${randomPostfix}`;
      ...
      before('Create users, data', () => {
        ...
        cy.then(() => {
          InventoryInstances.deleteInstanceByTitleViaApi('AT_C446102');
          ...
          .then(() => {
            cy.createTempUser([
              ...
              SelectInstanceModal.chooseSearchOption(contributorSearchOption);
              SelectInstanceModal.checkSearchOptionSelected(contributorSearchOption);
            });
          });
      });
      ...
      it(
        'C446102 Find Instance plugin | Staff suppress facet is off by default when user has permission to use facet (search by "Contributor") (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C446102'] },
        () => {
          ...
          SelectInstanceModal.searchByName(contributorValue);
