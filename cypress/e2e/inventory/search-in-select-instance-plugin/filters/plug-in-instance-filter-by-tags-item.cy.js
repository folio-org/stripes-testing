...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C476837_FolioInstance_${randomPostfix}`;
      const tagsAccordionName = 'Tags';
      const tagPrefix = `at_c476837_tag_${randomLetters}`;
      const organization = NewOrganization.getDefaultOrganization();
      organization.name = `AT_C476837_Org_${randomPostfix}`;
      ...
      before('Create users, data', () => {
        ...
        cy.then(() => {
          InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C476837');
