...
describe('Inventory', () => {
  describe('Search in "Select instance" plugin', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C476819_Instance_${randomPostfix}`;
      ...
      before('Create users, data', () => {
        ...
        cy.then(() => {
          InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C476819');
      ...
      it(
        'C476819 "Select Instance" plugin | Filter "Instance" records by "Holdings permanent location" facet in "Holdings" tab (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C476819'] },
        () => {
