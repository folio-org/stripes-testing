...
describe('Subject Browse', () => {
  ...
  it('C350392 Verify placeholder for the missing match in subject browse (firebird)', { tags: [testTypes.criticalPath, devTeams.firebird] }, () => {
  ...
  it('C350393 Verify selecting row from Browse Result list (firebird)', { tags: [testTypes.criticalPath, devTeams.firebird] }, () => {
