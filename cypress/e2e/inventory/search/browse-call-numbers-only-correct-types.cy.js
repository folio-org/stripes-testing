...
describe('inventory', () => {
  describe('Call Number Browse', () => {
    ...
    it(
      'C476856 Verify that call numbers of other types are not displayed in browse result list for certain call number type when user uses pagination buttons (spitfire)',
