...
describe('Inventory', () => {
  describe('Subject Browse', () => {
    ...
    it(
      'C422099 Subject/Contributor browse: verify that clicking on "Reset all" button will return focus and cursor to the Search box (promin)',
      { tags: ['extendedPath', 'promin', 'C422099', 'eurekaPhase1'] },
      () => {
