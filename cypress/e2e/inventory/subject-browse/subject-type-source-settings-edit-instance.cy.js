...
describe('Inventory', () => {
  describe('Subject Browse', () => {
    const testData = {
      instance: {},
      user: {},
      subjectHeadings: `AT_C552482_Subject_${getRandomPostfix()}`,
    };
    ...
    before('Create test data and login', () => {
      ...
      InventoryInstance.createInstanceViaApi({
        instanceTitle: `AT_C552482_FolioInstance_${getRandomPostfix()}`,
      }).then(({ instanceData }) => {
    ...
    it(
      ...
      () => {
        ...
        // Step 2: Click Actions > Edit instance; verify Edit instance page opened
