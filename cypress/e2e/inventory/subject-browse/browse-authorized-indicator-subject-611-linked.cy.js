...
describe('Inventory', () => {
  describe('Subject Browse', () => {
    ...
    it(
      'C375157 Browse | Authorized indicator is shown for "Subject" from "611" "MARC Bib" field controlled by "MARC authority" record (promin)',
      { tags: ['criticalPath', 'promin', 'C375157'] },
      () => {
