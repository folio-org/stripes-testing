...
describe('Inventory', () => {
  describe('Subject Browse', () => {
    ...
    it(
      'C375152 Browse | Authorized indicator is shown for "Subject" from "600" "MARC Bib" field controlled by "MARC authority" record (promin)',
      { tags: ['criticalPath', 'promin', 'C375152'] },
      () => {
