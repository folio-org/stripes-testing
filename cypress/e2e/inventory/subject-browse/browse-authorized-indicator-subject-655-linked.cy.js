...
describe('Inventory', () => {
  describe('Subject Browse', () => {
    ...
    it(
      'C375162 Browse | Authorized indicator is shown for "Subject" from "655" "MARC Bib" field controlled by "MARC authority" record (promin)',
      { tags: ['criticalPath', 'promin', 'C375162'] },
      () => {
