...
describe('Inventory', () => {
  describe('Subject Browse', () => {
    ...
    it(
      'C375160 Browse | Authorized indicator is shown for "Subject" from "651" "MARC Bib" field controlled by "MARC authority" record (promin)',
      { tags: ['criticalPath', 'promin', 'C375160'] },
      () => {
