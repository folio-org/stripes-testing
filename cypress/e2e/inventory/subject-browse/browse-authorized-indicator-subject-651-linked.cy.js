...
const marcBibFile = 'marcBibFileC375160.mrc';
const marcAuthFile = 'marcAuthFileC375160.mrc';
...
const authorityHeading = 'C375160 Auth151';
const bibTag = '651';
const authorityTag = '151';
...
describe('Inventory', () => {
  describe('Subject Browse', () => {
    before('Create user and import records', () => {
      cy.getAdminToken();
      InventoryInstances.deleteInstanceByTitleViaApi('C375160');
      MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('C375160');
    ...
    it(
      'C375160 Browse | Authorized indicator is shown for "Subject" from "651" "MARC Bib" field controlled by "MARC authority" record (spitfire)',
      { tags: ['criticalPath', 'spitfire', 'C375160'] },
      () => {
        // Step 1: Select "Subjects" in browse options dropdown
        BrowseSubjects.select();
        BrowseSubjects.waitForSubjectToAppear(authorityHeading, true, true);

        // Step 2: Input query in browse input field which matches "651" linked field value
        ...
        // Step 4a: Verify authority record detail view is opened and 151 field is highlighted
