...
describe('Inventory', () => {
  describe('Subject Browse', () => {
    ...
    it(
      'C375159 Browse | Authorized indicator is shown for "Subject" from "650" "MARC Bib" field controlled by "MARC authority" record (promin)',
      { tags: ['criticalPath', 'promin', 'C375159'] },
      () => {
