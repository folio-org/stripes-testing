...
describe('Inventory', () => {
  describe('Single record import', () => {
    ...
    it(
      'C375145 Verify the modal window for ISRI Import/Create in inventory main actions menu for single target profiles (promin)',
      { tags: ['criticalPath', 'promin', 'C375145'] },
      () => {
