...
describe('Inventory', () => {
  describe('Single record import', () => {
    ...
    it(
      'C490903 Generated "035" field displays in ascending fields order in overlaid via single record import "MARC bibliographic" record which doesn\'t have existing "035" field (promin)',
      { tags: ['criticalPath', 'promin', 'C490903'] },
      () => {
