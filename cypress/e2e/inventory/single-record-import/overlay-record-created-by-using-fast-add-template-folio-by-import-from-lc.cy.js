...
describe('Inventory', () => {
  describe('Single record import', () => {
    ...
    it(
      'C196838 Overlay record created by using Fast add template (instance source = FOLIO) by import of single MARC record from LC (promin)',
      { tags: ['extendedPath', 'promin', 'C196838'] },
      () => {
