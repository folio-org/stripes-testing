...
describe('Inventory', () => {
  describe('Single record import', () => {
    ...
    it(
      'C375122 Verify the modal window for ISRI Import/Create in inventory main actions menu for multiple target profiles (promin)',
      { tags: ['criticalPath', 'promin', 'C375122'] },
      () => {
