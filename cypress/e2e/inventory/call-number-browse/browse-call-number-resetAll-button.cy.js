...
describe('Inventory', () => {
  ...
  describe('Call Number Browse', () => {
    ...
    it(
      'C422098 Call number browse: verify that clicking on "Reset all" button will return focus and cursor to the Search box (promin)',
      { tags: ['extendedPath', 'promin', 'C422098', 'eurekaPhase1'] },
      () => {
