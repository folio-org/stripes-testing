...
describe('Inventory', () => {
  describe('Call Number Browse', () => {
    ...
    it(
      'C594363 Verify that "Call number" browse is case-insensitive when call numbers are in Upper case (promin)',
      { tags: ['extendedPathFlaky', 'promin', 'nonParallel', 'C594363'] },
      () => {
