...
describe('Inventory', () => {
  describe('Call Number Browse', () => {
    ...
    it(
      'C423492 Use pagination button browsing for call number which do not have the first 10 characters of the shelving order and 23 instances with call numbers "test + unique number" (promin)',
      { tags: ['criticalPath', 'promin', 'C423492', 'eurekaPhase1'] },
      () => {
