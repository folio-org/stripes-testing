...
describe('Inventory', () => {
  describe('Call Number Browse', () => {
    ...
    it(
      'C627505 Only Call number of selected in settings type could be found in the browse result list by "Dewey Decimal classification" browse option (promin)',
      { tags: ['criticalPathFlaky', 'promin', 'nonParallel', 'C627505'] },
      () => {
