...
describe('Inventory', () => {
  describe('Call Number Browse', () => {
    ...
    const localCallNumberTypeName = `AT_C594365_Local_${randomPostfix}`;
    const nonExistentNumber = `${randomLetters}c594365y4`;

    const callNumbers = [
      {
        type: CALL_NUMBER_TYPE_NAMES.DEWAY_DECIMAL,
        value: `${randomLetters}305.20973 t39`,
        valueUpperCase: `${randomLetters.toUpperCase()}305.20973 T39`,
        instanceTitle: `AT_C594365_Dewey_${randomPostfix}`,
      },
      {
        type: CALL_NUMBER_TYPE_NAMES.LIBRARY_OF_CONGRESS,
        value: `${randomLetters}qc 981.8 .g56 g578`,
        valueUpperCase: `${randomLetters.toUpperCase()}QC 981.8 .G56 G578`,
        instanceTitle: `AT_C594365_LC_${randomPostfix}`,
      },
      {
        type: CALL_NUMBER_TYPE_NAMES.LIBRARY_OF_MEDICINE,
        value: `${randomLetters}w1 be 357 bd. 1 1973`,
        valueUpperCase: `${randomLetters.toUpperCase()}W1 BE 357 Bd. 1 1973`,
        instanceTitle: `AT_C594365_NLM_${randomPostfix}`,
      },
      {
        type: localCallNumberTypeName,
        value: `${randomLetters}local2`,
        valueUpperCase: `${randomLetters.toUpperCase()}LOCAL2`,
        instanceTitle: `AT_C594365_Local_${randomPostfix}`,
      },
      {
        type: CALL_NUMBER_TYPE_NAMES.OTHER_SCHEME,
        value: `${randomLetters}b obama`,
        valueUpperCase: `${randomLetters.toUpperCase()}B OBAMA`,
        instanceTitle: `AT_C594365_Other_${randomPostfix}`,
      },
      {
        type: CALL_NUMBER_TYPE_NAMES.SUDOC,
        value: `${randomLetters}y 4.j 89/2-10:985`,
        valueUpperCase: `${randomLetters.toUpperCase()}Y 4.J 89/2-10:985`,
        instanceTitle: `AT_C594365_SuDoc_${randomPostfix}`,
      },
      {
        type: null,
        value: `${randomLetters}test lower case`,
        valueUpperCase: `${randomLetters.toUpperCase()}TEST LOWER CASE`,
        instanceTitle: `AT_C594365_NoType_${randomPostfix}`,
      },
      {
        type: CALL_NUMBER_TYPE_NAMES.MOYS,
        value: `${randomLetters}mg 357 ts. 1 1955`,
        valueUpperCase: `${randomLetters.toUpperCase()}MG 357 Ts. 1 1955`,
        instanceTitle: `AT_C594365_MOYS_${randomPostfix}`,
      },
    ];
    ...
    before('Create test data', () => {
      cy.getAdminToken()
        .then(() => {
          ...
          CallNumberTypes.deleteCallNumberTypesLike('C594365');
          InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C594365');
        ...
        .then(() => {
          // Create instances with items containing lowercase call numbers
    ...
    it(
      'C594365 Verify that "Call number" browse is case-insensitive when call numbers are in lower case (promin)',
      { tags: ['extendedPathFlaky', 'promin', 'nonParallel', 'C594365'] },
      () => {
        ...
        InventorySearchAndFilter.fillInBrowseSearch(noTypeCallNumber.valueUpperCase);
        InventorySearchAndFilter.clickSearch();
        BrowseCallNumber.valueInResultTableIsHighlighted(noTypeCallNumber.value);
        ...
        typedCallNumbers.forEach((callNumber) => {
          ...
          InventorySearchAndFilter.fillInBrowseSearch(callNumber.valueUpperCase);
          InventorySearchAndFilter.clickSearch();
          BrowseCallNumber.valueInResultTableIsHighlighted(callNumber.value);
        });
        ...
        InventorySearchAndFilter.fillInBrowseSearch(deweyCallNumber.valueUpperCase);
        InventorySearchAndFilter.clickSearch();
        BrowseCallNumber.valueInResultTableIsHighlighted(deweyCallNumber.value);
        ...
        InventorySearchAndFilter.fillInBrowseSearch(lcCallNumber.valueUpperCase);
        InventorySearchAndFilter.clickSearch();
        BrowseCallNumber.valueInResultTableIsHighlighted(lcCallNumber.value);
        ...
        InventorySearchAndFilter.fillInBrowseSearch(nlmCallNumber.valueUpperCase);
        InventorySearchAndFilter.clickSearch();
        BrowseCallNumber.valueInResultTableIsHighlighted(nlmCallNumber.value);
        ...
        InventorySearchAndFilter.fillInBrowseSearch(otherCallNumber.valueUpperCase);
        InventorySearchAndFilter.clickSearch();
        BrowseCallNumber.valueInResultTableIsHighlighted(otherCallNumber.value);
        ...
        InventorySearchAndFilter.fillInBrowseSearch(sudocCallNumber.valueUpperCase);
        InventorySearchAndFilter.clickSearch();
        BrowseCallNumber.valueInResultTableIsHighlighted(sudocCallNumber.value);

        // Steps 27-28: Test non-existing call numbers to verify placeholder
        InventorySearchAndFilter.clickResetAllButton();
        InventorySearchAndFilter.selectBrowseOptionFromCallNumbersGroup(
          BROWSE_CALL_NUMBER_OPTIONS.SUPERINTENDENT_OF_DOCUMENTS,
        );
        ...
        InventorySearchAndFilter.fillInBrowseSearch(nonExistentNumber.toUpperCase());
        InventorySearchAndFilter.clickSearch();
        // Verify non-exact match result is returned
        BrowseCallNumber.checkNonExactSearchResult(nonExistentNumber.toUpperCase());
        ...
        InventorySearchAndFilter.fillInBrowseSearch(nonExistentNumber);
        InventorySearchAndFilter.clickSearch();
        // Verify non-exact match result is returned
        BrowseCallNumber.checkNonExactSearchResult(nonExistentNumber);
      },
    );
  });
});
