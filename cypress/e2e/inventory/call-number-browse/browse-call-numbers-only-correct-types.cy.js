...
describe('Inventory', () => {
  describe('Call Number Browse', () => {
    ...
    it(
      'C405530 Verify that call numbers of other types are not displayed in browse result list for certain call number type when user uses pagination buttons (promin)',
      { tags: ['criticalPathFlaky', 'promin', 'nonParallel', 'C405530', 'eurekaPhase1'] },
      () => {
