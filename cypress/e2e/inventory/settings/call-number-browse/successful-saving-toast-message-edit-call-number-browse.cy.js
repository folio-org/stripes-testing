...
describe('Inventory', () => {
  describe('Settings', () => {
    describe('Call number browse', () => {
      ...
      it(
        'C627459 Successful saving toast message is displayed after editing and saving "Call number browse" option (promin)',
        { tags: ['extendedPathFlaky', 'nonParallel', 'promin', 'C627459'] },
        () => {
