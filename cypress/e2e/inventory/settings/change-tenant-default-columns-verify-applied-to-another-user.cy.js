...
describe('Inventory', () => {
  describe('Settings', () => {
    ...
    it(
      'C813587 Change tenant preferences of Inventory "Default columns" setting by User A and verify that changes has been applied to User B (promin)',
      { tags: ['extendedPath', 'promin', 'C813587', 'nonParallel'] },
      () => {
