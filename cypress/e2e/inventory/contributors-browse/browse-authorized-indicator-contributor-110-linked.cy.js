...
describe('Inventory', () => {
  describe('Contributors Browse', () => {
    ...
    it(
      'C375250 Browse | Authorized indicator is shown for "Contributor" from "110" "MARC Bib" field controlled by "MARC authority" record (promin)',
      { tags: ['criticalPath', 'promin', 'C375250'] },
      () => {
