...
const marcBibFile = 'marcBibFileC375251.mrc';
const marcAuthFile = 'marcAuthFileC375251.mrc';
...
const authorityHeading = 'C375251 Mediterranean Conference on Medical and Biological Engineering';
const bibTag = '111';
...
describe('Inventory', () => {
  describe('Contributors Browse', () => {
    before('Create user and import records', () => {
      cy.getAdminToken();
      InventoryInstances.deleteInstanceByTitleViaApi('C375251');
      MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('C375251');
    ...
    it(
      'C375251 Browse | Authorized indicator is shown for "Contributor" from "111" "MARC Bib" field controlled by "MARC authority" record (spitfire)',
      { tags: ['criticalPath', 'spitfire', 'C375251'] },
      () => {
        ...
        // Step 2: Input query in browse input field which matches "111" linked field value
