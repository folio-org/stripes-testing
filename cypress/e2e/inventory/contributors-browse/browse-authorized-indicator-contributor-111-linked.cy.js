...
describe('Inventory', () => {
  describe('Contributors Browse', () => {
    ...
    it(
      'C375251 Browse | Authorized indicator is shown for "Contributor" from "111" "MARC Bib" field controlled by "MARC authority" record (promin)',
      { tags: ['criticalPath', 'promin', 'C375251'] },
      () => {
