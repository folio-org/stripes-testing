...
describe('Inventory', () => {
  describe('Contributors Browse', () => {
    ...
    it(
      'C375249 Browse | Authorized indicator is shown for "Contributor" from "100" "MARC Bib" field controlled by "MARC authority" record (promin)',
      { tags: ['criticalPath', 'promin', 'C375249'] },
      () => {
