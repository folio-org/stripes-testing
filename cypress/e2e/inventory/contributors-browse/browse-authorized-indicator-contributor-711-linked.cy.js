...
const marcBibFile = 'marcBibFileC375254.mrc';
const marcAuthFile = 'marcAuthFileC375254.mrc';
...
const authorityHeading = 'C375254 Mostly Mozart Festival. sonet';
const authorityHeadingParts = ['C375254 Mostly Mozart Festival.', 'sonet'];
const bibTag = '711';
...
describe('Inventory', () => {
  describe('Contributors Browse', () => {
    before('Create user and import records', () => {
      cy.getAdminToken();
      InventoryInstances.deleteInstanceByTitleViaApi('C375254');
      MarcAuthorities.deleteMarcAuthorityByTitleViaAPI('C375254');
    ...
    it(
      'C375254 Browse | Authorized indicator is shown for "Contributor" from "711" "MARC Bib" field controlled by "MARC authority" record (spitfire)',
      { tags: ['criticalPath', 'spitfire', 'C375254'] },
      () => {
        ...
        // Step 2: Input query in browse input field which matches "711" linked field value
