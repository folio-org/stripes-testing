...
describe('Inventory', () => {
  describe('Contributors Browse', () => {
    ...
    it(
      'C359596 Verify that contributors with the same "Name", "Name type" and different "authorityID" will display in different rows in the response (promin)',
      { tags: ['criticalPath', 'promin', 'C359596'] },
      () => {
