...
describe('Inventory', () => {
  describe('Optimistic locking', () => {
    ...
    it(
      'C466064 Verify that version of "Instance" record (source=MARC) was not updated after deleting of "Holdings" and "Item" record (promin)',
      { tags: ['extendedPath', 'promin', 'C466064'] },
      () => {
