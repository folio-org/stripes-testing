...
describe('Inventory', () => {
  describe('Instance', () => {
    const testData = {
      filePath: 'marcBibFileForC496129.mrc',
      marcFileName: `C496129 createAutotestFile${getRandomPostfix()}.mrc`,
      instanceTitle: 'C496129 Justus Liebigs Annalen der Chemie.',
      precedingTitle: 'C496129 Justus Liebigs Annalen der Chemie.',
    };
    ...
    it(
      ...
      () => {
        ...
        InventorySearchAndFilter.checkSearchQueryText(
          `title exactPhrase ${testData.precedingTitle} and issn containsAll precedingTitle`,
        );
