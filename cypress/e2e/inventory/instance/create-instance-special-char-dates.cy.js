...
describe('Inventory', () => {
  describe('Instance', () => {
    ...
    it(
      'C552516 Create Instance without selected "Date type" and fields "Date 1" and "Date 2" filled by values with special characters (promin)',
      { tags: ['extendedPath', 'promin', 'C552516'] },
      () => {
