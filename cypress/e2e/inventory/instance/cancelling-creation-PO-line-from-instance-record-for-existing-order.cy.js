...
describe('Inventory instance', () => {
  ...
  it(
    ...
    () => {
      ...
      OrderLineEditForm.verifyAreYouSureForm();

      // Click "Close without saving" button
      OrderLineEditForm.clickCloseWithoutSavingButton();
      OrderLineEditForm.checkAreYouSureModalIsClosed();
