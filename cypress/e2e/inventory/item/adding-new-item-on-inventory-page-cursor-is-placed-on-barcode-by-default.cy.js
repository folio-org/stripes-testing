...
describe('Inventory', () => {
  describe('Item', () => {
    const testData = {
      instanceTitle: `AT_C396377_FolioInstance_${getRandomPostfix()}`,
    ...
    it(
      ...
      () => {
        ...
        ItemRecordEdit.verifyBarcodeFieldFocusedByDefault();
        ItemRecordEdit.cancel();
        ItemRecordView.waitLoading();
        ItemRecordView.duplicateItem();
        ItemRecordNew.waitLoading(testData.instanceTitle);
        ItemRecordNew.verifyBarcodeFieldFocusedByDefault();
      },
    );
  });
});
