...
describe('Inventory', () => {
  describe('Item', () => {
    describe('Re-order item records', () => {
      ...
      const instanceTitlePrefix = `AT_C825239_FolioInstance_${randomPostfix}`;
      const testData = {
      ...
      before('Create test data', () => {
        cy.getAdminToken();
        InventoryInstances.deleteFullInstancesByTitleViaApi('AT_C825239_FolioInstance');
      ...
      it(
        'C825239 API | Update "order" of multiple "Item" records (specified "order" field) for different holdings of same Instance using batch endpoint (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C825239'] },
        () => {
