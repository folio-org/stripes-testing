...
describe('Inventory', () => {
  describe('Item', () => {
    ...
    it(
      'C405511 Verify that Item\'s "Shelving order" will be cleared if "Call number" fields are cleared in "Holdings" with source=FOLIO (promin)',
      { tags: ['extendedPath', 'promin', 'C405511'] },
      () => {
