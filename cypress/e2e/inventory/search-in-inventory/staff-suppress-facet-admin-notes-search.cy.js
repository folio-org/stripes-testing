...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      it(
        'C446031 Staff suppress facet is off by default when user has permission to use facet (search by "Instance administrative notes") (promin)',
        { tags: ['extendedPath', 'promin', 'C446031'] },
        () => {
