...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      it(
        'C446030 Staff suppress facet is off by default when user has permission to use facet (search by "Instance notes (all)") (promin)',
        { tags: ['extendedPath', 'promin', 'C446030'] },
        () => {
