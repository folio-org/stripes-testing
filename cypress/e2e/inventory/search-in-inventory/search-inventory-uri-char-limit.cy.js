  ...
  describe('Search in Inventory', () => {
    ...
    it(
      ...
      () => {
        ...
        InventorySearchAndFilter.verifyUriCharLimitMessageAndCallout();

        InventorySearchAndFilter.selectSearchOption(searchOptions.keyword);
        InventorySearchAndFilter.fillInSearchQuery(queries.validLength);
        InventorySearchAndFilter.clickSearch();
        InventorySearchAndFilter.verifyResultPaneEmpty({
          noResultsFound: true,
          searchQuery: queries.validLength,
        });
