...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C368048 Search for "Instance" by "Series statement" field without special characters using "Keyword" search option (promin) (TaaS)',
      { tags: ['extendedPath', 'promin', 'C368048', 'eurekaPhase1'] },
      () => {
