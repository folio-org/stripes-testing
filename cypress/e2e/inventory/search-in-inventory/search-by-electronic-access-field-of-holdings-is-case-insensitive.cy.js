  ...
  describe('Search in Inventory', () => {
    describe('Case-insensitive checks', () => {
        ...
        instances: [
          {
            ...
            uri: 'www.holdingscase.com/test/uric466080',
            linkText: 'holdings linkc466080 text case test',
            materialsSpecification: 'holdings materialsc466080 case test',
            urlPublicNote: 'holdings public notec466080 case test',
      ...
      it(
        ...
        { tags: ['criticalPath', 'spitfire', 'C466080'] },
        () => {
