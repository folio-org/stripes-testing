...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C368475 Search for "Instance" by "Contributor name" field without special characters using "Keyword" search option (promin) (TaaS)',
      { tags: ['criticalPathFlaky', 'promin', 'C368475'] },
      () => {
