...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C423693 Instance | Using Advanced search with search query with not supported search option "Advanced search" in Inventory (promin)',
      { tags: ['extendedPath', 'promin', 'C423693'] },
      () => {
