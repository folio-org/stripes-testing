...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C440128 Search for "MARC bibliographic" by "LCCN, normalized" option using a query with asterisk when "LCCN" (010 $a) has (leading, internal, trailing) spaces. (promin)',
      { tags: ['criticalPathFlaky', 'promin', 'C440128'] },
      () => {
