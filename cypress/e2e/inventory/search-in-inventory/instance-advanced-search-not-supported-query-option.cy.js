...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    const testData = {
      user: {},
      instanceTitle: `AT_C423707_FolioInstance_${getRandomPostfix()} The`,
      initialSearchQuery: 'title all The',
      newSearchQuery: 'The',
      generatedAdvancedSearchQuery: 'keyword containsAll The',
      advancedSearchOption: searchInstancesOptions.at(-1),
      querySearchOption: searchInstancesOptions.at(-2),
    ...
    it(
      'C423707 Instance | Using Advanced search with search query with not supported search option "Query search" in Inventory (spitfire)',
      { tags: ['extendedPath', 'spitfire', 'C423707'] },
      () => {
