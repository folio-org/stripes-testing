...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    const testData = {
      ...
      searchResults: [
        'C451461 (MSEARCH672 test ISSN upper case, record 1) Time.',
        'C451461 (MSEARCH672 test ISSN lower case, record 2) Time.',
        'C451461 (MSEARCH672 test invalid ISSN upper case, record 3) Time.',
        'C451461 (MSEARCH672 test invalid ISSN lower case, record 4) Time.',
        'C451461 (MSEARCH672 test linking ISSN upper case, record 5) Time.',
        'C451461 (MSEARCH672 test linking ISSN lower case, record 6) Time.',
      ],
    };
    ...
    const marcFile = {
      marc: 'marcBibFileForC451461.mrc',
      fileName: `testMarcFileC451461.${getRandomPostfix()}.mrc`,
    ...
    it(
      'C451461 Find Instance plugin | Search for "Instance" record by "ISSN" value with "X" at the end using "ISSN" search option (Holdings tab) (promin)',
      { tags: ['extendedPath', 'promin', 'C451461'] },
      () => {
