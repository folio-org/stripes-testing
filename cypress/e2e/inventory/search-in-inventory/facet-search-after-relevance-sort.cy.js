...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C422216 Verify that facets options are available after "Relevance" sort was applied to the result list (promin)',
      { tags: ['criticalPath', 'promin', 'C422216', 'eurekaPhase1'] },
      () => {
