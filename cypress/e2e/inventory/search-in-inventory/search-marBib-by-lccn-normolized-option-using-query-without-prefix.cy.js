...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C442818 Search for "MARC bibliographic" by "LCCN, normalized" option using a query without prefix (numbers only) when "LCCN" (010 $z) has (leading, internal, trailing) spaces. (promin)',
      { tags: ['criticalPath', 'promin', 'C442818'] },
      () => {
