...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C442820 Search for "MARC bibliographic" by "LCCN, normalized" option using a query with lower, UPPER case when "LCCN" (010 $z) has (leading, internal, trailing) spaces. (promin)',
      { tags: ['criticalPathFlaky', 'promin', 'C442820'] },
      () => {
