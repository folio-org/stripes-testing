...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C360548 Verify that operator "=" is used when user search for "Instance" by "Contributor" search option. (promin)',
      { tags: ['criticalPathFlaky', 'promin', 'C360548'] },
      () => {
        const searchQueries = [
          'Henri Sauguet',
    ...
    it(
      'C360555 Verify that search for "Instance" records by "Keyword" option with "<ISBN with dashes>" query will only return the records with matched identifier value. (promin)',
      { tags: ['criticalPathFlaky', 'promin', 'C360555'] },
      () => {
    ...
    it(
      'C358938 Verify that "Instance" record will close when user switches to browse (promin)',
      { tags: ['criticalPath', 'promin', 'C358938', 'eurekaPhase1'] },
      () => {
