...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    const testData = {
      callNumberOption: searchHoldingsOptions[4],
      ...
      searchQueries: {
        basic: `AT_C423411_BasicSearch_${randomPostfix}`,
        querySearch: `title="AT_C423411_QuerySearch_${randomPostfix}"`,
        callNumber: `AT_C423411_CallNumber_${randomPostfix}`,
        all: 'AT_C423411_FolioInstance',
      },
      sourceValue: 'FOLIO',
    };
    const advSearchGeneratedQuery = `holdingsNormalizedCallNumbers containsAll ${testData.searchQueries.callNumber}`;
    ...
    after('Delete test data', () => {
      ...
      InventoryInstance.deleteInstanceViaApi(testData.altInstance.instanceId);
    ...
    it(
      ...
      () => {
        ...
        InventoryInstances.fillAdvSearchRow(
          0,
          testData.searchQueries.callNumber,
          'Contains all',
          testData.callNumberOption,
        );
        ...
        cy.title().should('eq', getExpectedTitle({ query: testData.searchQueries.all }));
        ...
        cy.title().should('eq', getExpectedTitle({ title: instanceTitlePrefix }));
