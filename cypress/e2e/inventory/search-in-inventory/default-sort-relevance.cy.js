...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    const titlePrefix = `AT_C543871_Instance_${randomPostfix}`;
    const contributorPrefix = `C543871Contrib ${randomPostfix}`;
    const testData = {};
    const instancesData = [];
    ...
    before('Set display settings', () => {
      ...
      cy.setupInventoryDefaultSortViaAPI(INVENTORY_DEFAULT_SORT_OPTIONS.RELEVANCE.toLowerCase());
    });
    ...
    it(
      'C543871 Default sort is applied to search result list in "Inventory" app according to selected option in settings ("Relevance" case) (spitfire)',
      { tags: ['criticalPathFlaky', 'spitfire', 'nonParallel', 'C543871'] },
      () => {
        cy.login(testData.userProperties.username, testData.userProperties.password, {
          ...
          InventoryInstances.actionsSortBy(INVENTORY_DEFAULT_SORT_OPTIONS.CONTRIBUTORS);
