...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C543871 Default sort is applied to search result list in "Inventory" app according to selected option in settings ("Relevance" case) (promin)',
      { tags: ['criticalPathFlaky', 'promin', 'nonParallel', 'C543871'] },
      () => {
