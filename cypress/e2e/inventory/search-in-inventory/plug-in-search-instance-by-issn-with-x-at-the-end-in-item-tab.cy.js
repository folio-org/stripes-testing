...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C451462 Find Instance plugin | Search for "Instance" record by "ISSN" value with "X" at the end using "ISSN" search option (Item tab) (promin)',
      { tags: ['extendedPath', 'promin', 'C451462'] },
      () => {
