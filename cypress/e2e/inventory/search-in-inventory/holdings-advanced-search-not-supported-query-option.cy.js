...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C423708 Holdings | Using Advanced search with search query with not supported search option "Query search" in Inventory (promin)',
      { tags: ['extendedPath', 'promin', 'C423708'] },
      () => {
