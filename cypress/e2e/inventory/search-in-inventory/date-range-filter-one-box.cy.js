  ...
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      const testData = {
        ...
        allDates2Sorted: ['', '2021', '2022', '2022', ''],
        dateRangeAccordionName: 'Date range',
      };
      const filterData = [
        { range: ['1904', ''], dates: testData.allDates1Sorted.slice(2) },
        { range: ['', '1904'], dates: testData.allDates1Sorted.slice(0, 3) },
      ];
      ...
      before('Create test data, login', () => {
        ...
        cy.then(() => {
          cy.getInstanceDateTypesViaAPI().then((dateTypesResponse) => {
            testData.allDates1Sorted.forEach((date1, index) => {
              InventoryInstance.createInstanceViaApi({
                ...
                cy.getInstanceById(instanceData.instanceId).then((body) => {
                  ...
                  updatedBody.dates = {
                    ...
                    date1,
                    date2: testData.allDates2Sorted[index],
                  };
