  ...
  describe('Search in Inventory', () => {
    describe('Case-insensitive checks', () => {
        ...
        instances: [
          {
            ...
            linkText: 'item linkc466084 text case test',
            materialsSpecification: 'item materialsc466084 case test',
            publicNote: 'item public notec466084 case test',
            uri: 'www.itemcase.com/test/uric466084',
          },
          {
      ...
      it(
        ...
        { tags: ['criticalPath', 'spitfire', 'C466084'] },
        () => {
