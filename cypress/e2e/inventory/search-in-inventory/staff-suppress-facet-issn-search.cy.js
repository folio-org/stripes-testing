...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      const identifier = `AT_C446027_Identifier_${randomPostfix}`;
      const instanceTitlePrefix = `AT_C446027_Instance_${randomPostfix}`;
      const accordionName = 'Staff suppress';
      const searchOption = searchInstancesOptions[6]; // ISSN
      ...
      it(
        'C446027 Staff suppress facet is off by default when user has permission to use facet (search by "ISSN") (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C446027'] },
        () => {
