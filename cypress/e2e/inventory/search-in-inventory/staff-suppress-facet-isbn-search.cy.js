...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      const identifier = `AT_C446026_Identifier_${randomPostfix}`;
      const instanceTitlePrefix = `AT_C446026_Instance_${randomPostfix}`;
      const accordionName = 'Staff suppress';
      const searchOption = searchInstancesOptions[5]; // ISBN
      ...
      before('Create test data and login', () => {
        cy.getAdminToken();
        InventoryInstances.deleteInstanceByTitleViaApi('AT_C446026_Instance');
