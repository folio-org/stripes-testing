...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C446088_Instance_${randomPostfix}`;
      ...
      before('Create test data and login', () => {
        cy.getAdminToken();
        InventoryInstances.deleteInstanceByTitleViaApi('AT_C446088_Instance');
      ...
      it(
        ...
        () => {
          ...
          InventorySearchAndFilter.verifyResultPaneEmpty({
            noResultsFound: true,
            searchQuery: `${instanceTitlePrefix}_3`,
          });
          ...
          InventorySearchAndFilter.verifyResultPaneEmpty({
            noResultsFound: true,
            searchQuery: `${instanceTitlePrefix}_4`,
          });
