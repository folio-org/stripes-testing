...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      it(
        'C446028 Staff suppress facet is off by default when user has permission to use facet (search by "OCLC number, normalized") (promin)',
        { tags: ['extendedPath', 'promin', 'C446028'] },
        () => {
