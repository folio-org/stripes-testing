...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C446024_Instance_${randomPostfix}`;
      const accordionName = 'Staff suppress';
      const searchOption = searchInstancesOptions[2]; // Title (all)
      ...
      it(
        'C446024 Staff suppress facet is off by default when user has permission to use facet (search by "Title (all)") (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C446024'] },
        () => {
          ...
          InventorySearchAndFilter.searchByParameter(searchOption, instanceTitlePrefix);
