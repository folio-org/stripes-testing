...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      const instanceTitlePrefix = `AT_C446036_Instance_${randomPostfix}`;
      const accordionName = 'Staff suppress';
      const searchOption = searchInstancesOptions[17]; // Query search
      ...
      before('Create test data and login', () => {
        cy.getAdminToken();
        InventoryInstances.deleteInstanceByTitleViaApi('AT_C446036_Instance');
      ...
      it(
        'C446036 Staff suppress facet is off by default when user has permission to use facet (search by "Query search") (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C446036'] },
        () => {
          ...
          InventorySearchAndFilter.searchByParameter(searchOption, `title=${instanceTitlePrefix}`);
