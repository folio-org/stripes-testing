...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C442819 Search for "MARC bibliographic" by "LCCN, normalized" option using a query with asterisk when "LCCN" (010 $z) has (leading, internal, trailing) spaces. (promin)',
      { tags: ['criticalPath', 'promin', 'C442819'] },
      () => {
