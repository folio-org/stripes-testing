...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    const testData = {
      ...
      searchResults: [
        'C451460 (MSEARCH672 test ISSN upper case, record 1) Time.',
        'C451460 (MSEARCH672 test ISSN lower case, record 2) Time.',
        'C451460 (MSEARCH672 test invalid ISSN upper case, record 3) Time.',
        'C451460 (MSEARCH672 test invalid ISSN lower case, record 4) Time.',
        'C451460 (MSEARCH672 test linking ISSN upper case, record 5) Time.',
        'C451460 (MSEARCH672 test linking ISSN lower case, record 6) Time.',
      ],
    };
    ...
    const marcFile = {
      marc: 'marcBibFileForC451460.mrc',
      fileName: `testMarcFileC451460.${getRandomPostfix()}.mrc`,
    ...
    it(
      'C451460 Find Instance plugin | Search for "Instance" record by "ISSN" value with "X" at the end using "ISSN" search option (Instance tab) (spitfire)',
      { tags: ['extendedPath', 'spitfire', 'C451460'] },
      () => {
