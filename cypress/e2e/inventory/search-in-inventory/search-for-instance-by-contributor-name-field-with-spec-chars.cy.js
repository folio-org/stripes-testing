...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    ...
    it(
      'C368043 Search for "Instance" by "Contributor name" field with special characters using "Keyword" search option (promin) (TaaS)',
      { tags: ['criticalPath', 'promin', 'C368043', 'eurekaPhase1'] },
      () => {
