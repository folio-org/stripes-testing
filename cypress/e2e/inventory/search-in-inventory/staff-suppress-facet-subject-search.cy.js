...
describe('Inventory', () => {
  describe('Search in Inventory', () => {
    describe('Filters', () => {
      ...
      const subjectText = `AT_C446032_Subject_${randomPostfix}`;
      const instanceTitlePrefix = `AT_C446032_Instance_${randomPostfix}`;
      const accordionName = 'Staff suppress';
      const searchOption = searchInstancesOptions[12]; // Subject
      ...
      before('Create test data and login', () => {
        cy.getAdminToken();
        InventoryInstances.deleteInstanceByTitleViaApi('AT_C446032_Instance');
      ...
      it(
        'C446032 Staff suppress facet is off by default when user has permission to use facet (search by "Subject") (spitfire)',
        { tags: ['extendedPath', 'spitfire', 'C446032'] },
        () => {
          ...
          InventorySearchAndFilter.searchByParameter(searchOption, subjectText);
