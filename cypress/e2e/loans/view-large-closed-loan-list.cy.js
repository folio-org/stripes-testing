...
describe('Loans', () => {
  describe('Large Closed Loan Lists - Same Instance', () => {
    ...
    it(
      'C451620 Check that user with 200+ closed loans (Same instance, but different holdings) can see all Loan details (vega)',
      { tags: ['extendedPath', 'vega', 'C451620', 'long'] },
      () => {
