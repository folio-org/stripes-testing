...
describe('Prepare test data', () => {
  it('001 Assign service points to admin user',
    { tags: ['prepareTestData'] },
    () => {
      ...
      cy.getAdminToken().then(() => {
        ...
        ServicePoints.getViaApi()
          ...
          .then(() => {
            ...
            UserEdit.changeServicePointPreferenceViaApi(userId, servicePointIds, defaultServicePointId);
          });
      });
    });
});
