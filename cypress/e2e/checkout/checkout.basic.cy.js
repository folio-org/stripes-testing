...
describe('Check out', () => {
  ...
  before('Create test data', () => {
    cy.getAdminToken()
      .then(() => {
        ...
        OtherSettings.enablePrefPatronIdentifierIfNeeded(USER_NAME, (value) => {
          shouldRemoveUserNameAfterTest = value;
        });
      })
      .then(() => {
  ...
  after('Delete test data', () => {
    ...
    OtherSettings.disablePrefPatronIdentifierIfNeeded(USER_NAME, shouldRemoveUserNameAfterTest);
  });
