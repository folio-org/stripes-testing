...
describe('eHoldings', () => {
  describe('Package', () => {
    const testData = {
      ...
      fileName: `C1538645autoTestFile${getRandomPostfix()}.csv`,
      fileMask: '*_package.csv',
      packageData: `C1538645_package_data_${getRandomPostfix()}.csv`,
      titleData: `C1538645_title_data_${getRandomPostfix()}.csv`,
    ...
    it(
      'C1538645 Export all selected titles in a "Package". User chooses all "Package" and "Titles" fields to export (using multi-select option) (spitfire)',
      { tags: ['extendedPath', 'spitfire', 'C1538645'] },
      () => {
