...
describe('eHoldings', () => {
  describe('Package', () => {
    ...
    it(
      'C378887 Verify that in exported Package ".csv" "Managed Coverage; Embargo", "Custom Coverage; Embargo" fields are filled in same date format as displayed in "eHoldings" app (promin)',
      { tags: ['extendedPath', 'promin', 'C378887'] },
      () => {
