...
describe('eHoldings', () => {
  describe('Titles', () => {
    const testData = {
      titleName: 'C423478 Test Custom Title',
    };
    ...
    it(
      'C423478 Cancel changes made in not saved custom "Title" record using "X" icon (spitfire)',
      { tags: ['extendedPath', 'spitfire', 'C423478'] },
      () => {
