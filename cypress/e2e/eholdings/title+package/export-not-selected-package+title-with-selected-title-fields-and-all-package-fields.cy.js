...
describe('eHoldings', () => {
  describe('Title+Package', () => {
    const testData = {
      ...
      fileName: `C356776autoTestFile${getRandomPostfix()}.csv`,
      fileMask: '*_resource.csv',
      packageData: `C356776_package_data_${getRandomPostfix()}.csv`,
      titleData: `C356776_title_data_${getRandomPostfix()}.csv`,
    ...
    it(
      'C356776 Export of Not selected "Package+title" with user selected fields of "Title" and all fields of "Package" (promin)',
      { tags: ['extendedPath', 'promin', 'C356776'] },
      () => {
