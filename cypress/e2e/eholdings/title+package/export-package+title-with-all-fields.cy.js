...
describe('eHoldings', () => {
  describe('Title+Package', () => {
    const testData = {
      ...
      fileName: `C1538644autoTestFile${getRandomPostfix()}.csv`,
      fileMask: '*_resource.csv',
      packageData: `C1538644_package_data_${getRandomPostfix()}.csv`,
      titleData: `C1538644_title_data_${getRandomPostfix()}.csv`,
    };
    ...
    it(
      'C1538644 Export of selected "Package+Title" with all fields of "Package" and "Title" selected by multi-select option (promin)',
      { tags: ['extendedPath', 'promin', 'C1538644'] },
      () => {
