...
describe('eHoldings', () => {
  describe('Title+Package', () => {
    ...
    it(
      'C356764 Export of selected "Package+title" with user selected fields of "Package" and all fields of "Title" (spitfire)',
      { tags: ['extendedPath', 'spitfire', 'C356764'] },
      () => {
