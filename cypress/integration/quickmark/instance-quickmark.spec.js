...
describe('Manage inventory Bib records with quickMarc editor', () => {
  ...
  it('C10950 Edit and save a MARC record in quickMARC (spitfire)', { tags: [testTypes.smoke, features.quickMarcEditor, DevTeams.spitfire] }, () => {
  ...
  it('C10924 Add a field to a record using quickMARC (spitfire)', { tags: [testTypes.smoke, features.quickMarcEditor, DevTeams.spitfire] }, () => {
    InventoryInstance.goToEditMARCBiblRecord();
    QuickMarcEditor.waitLoading();
  ...
  it('C10928 Delete a field(s) from a record in quickMARC (spitfire)', { tags: [testTypes.smoke, features.quickMarcEditor, DevTeams.spitfire] }, () => {
    InventoryInstance.goToEditMARCBiblRecord();
    QuickMarcEditor.waitLoading();
    quickmarcEditor.deletePenaltField().then(deletedTag => {
      QuickMarcEditor.pressSaveAndClose();
  ...
  it('C10957 Attempt to delete a required field (spitfire)', { tags: [testTypes.smoke, features.quickMarcEditor, DevTeams.spitfire] }, () => {
    InventoryInstance.goToEditMARCBiblRecord();
    QuickMarcEditor.waitLoading();
    QuickMarcEditor.checkRequiredFields();
  });

  it('C10951 Add a 5XX field to a marc record in quickMARC (spitfire)', { tags: [testTypes.smoke, features.quickMarcEditor, DevTeams.spitfire] }, () => {
  ...
  it('C345388 Derive a MARC bib record (spitfire)', { tags: [testTypes.smoke, features.quickMarcEditor, DevTeams.spitfire] }, () => {
  ...
  it('C353612 Verify "LDR" validation rules with invalid data for editable and non-editable positions when editing/deriving record (spitfire)', { tags: [testTypes.smoke, features.quickMarcEditor, DevTeams.spitfire] }, () => {
  ...
  it('C353610 Verify "LDR" validation rules with valid data for positions 06 and 07 when editing record (spitfire)', { tags: [testTypes.smoke, features.quickMarcEditor, DevTeams.spitfire] }, () => {
    const initialLDRValue = InventoryInstance.validOCLC.ldrValue;
