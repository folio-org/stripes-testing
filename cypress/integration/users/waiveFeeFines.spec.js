...
describe('ui-users:', () => {
  ...
  describe('C465 Verify that library staff can fully and partially waive one or more fees/fines for a patron', () => {
    const amount = ManualCharges.defaultFeeFineType.defaultAmount;
    ...
    it('Scenario 2: When one row box checked on the Open Fees/Fines page open Waive Fee/Fine modal', () => {
      ...
      WaiveFeeFinesModal.checkWaiveMessage(1, amount);
    ...
    it('Scenario 5: When two row boxes checked on the Open Fees/Fines page open Waive Fee/Fine modal', () => {
      ...
      UserAllFeesFines.clickWaive();
      WaiveFeeFinesModal.waitLoading();
      WaiveFeeFinesModal.checkWaiveMessage(2, amount*2);
      WaiveFeeFinesModal.cancel();
    });
