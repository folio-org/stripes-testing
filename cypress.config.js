...
module.exports = defineConfig({
  ...
  env: {
    OKAPI_HOST: 'https://okapi-fse2.int.aws.folio.org',
    OKAPI_TENANT: 'fs09002000',
    diku_login: 'EBSCOSupport',
    diku_password: 'RqM7lc55C',
  ...
  e2e: {
    ...
    baseUrl: 'https://fse2.int.aws.folio.org',
    testIsolation: false,
  },
});
