...
export const quickMarcEditorRowSelector =
  'div[id=quick-marc-editor-rows]>div[class*=quickMarcEditorRow]';
...
export default HTML.extend('quickMarcEditorRow')
  ...
  .filters({
    ...
    error: (el) => (el.querySelector('[data-testid="error-messages-container"]') || {}).textContent,
  });
